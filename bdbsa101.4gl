  ...
  foreach cbdbsa101001 into m_bdbsa101.atdsrvorg,
     ...
     if m_bdbsa101.atdsrvorg = 8 then
         ...
         if m_bdbsa101.pgtdat is not null then
             let m_saida = "Serviço ", m_bdbsa101.atdsrvnum,"-",m_bdbsa101.atdsrvano, " tem data de pagamento, despresado."
         ...
         if m_bdbsa101.srvprlflg = "S" then
             let m_saida = "Serviço ", m_bdbsa101.atdsrvnum,"-",m_bdbsa101.atdsrvano, " e particular, despresado."
             display "m_saida: ",m_saida
             #output to report bdbsa101_resumo(m_saida clipped)
             initialize m_bdbsa101.* to null
             let m_ctt.srvdsp = m_ctt.srvdsp + 1
         ...
         if m_bdbsa101.atdprscod is null and m_bdbsa101.atdetpcod <> 5 then
             let m_saida = "Serviço ", m_bdbsa101.atdsrvnum,"-",m_bdbsa101.atdsrvano, " não tem prestador, despresado."
             display "m_saida: ",m_saida
             #output to report bdbsa101_resumo(m_saida clipped)
             initialize m_bdbsa101.* to null
             let m_ctt.srvdsp = m_ctt.srvdsp + 1
         ...
         if m_bdbsa101.pestip is null and m_bdbsa101.atdprscod is not null then
            let m_saida = "Serviço ", m_bdbsa101.atdsrvnum,"-",m_bdbsa101.atdsrvano, " com prestador sem tipo pessoa, despresado."
            display "m_saida: ",m_saida
            #output to report bdbsa101_resumo(m_saida clipped)
            initialize m_bdbsa101.* to null
            let m_ctt.srvdsp = m_ctt.srvdsp + 1
     ...
     display "Verifica se o serviço ja foi provisionado: ", lr_erro_prv.err
     # se ja existe, continua
     if lr_erro_prv.err = 0 then
         let m_saida = "Serviço ", m_bdbsa101.atdsrvnum,"-",m_bdbsa101.atdsrvano, " ja provisionado, despresado."
         display "m_saida: ",m_saida
     ...
     display "mr_retorno.modalidade         :", mr_retorno.modalidade
        ...
        if mr_retorno.msgerro is not null then
           ...
           if mr_retorno.srvvlr > 0 then
              ...
              let m_saida = "Serviço ", m_bdbsa101.atdsrvnum,"-",m_bdbsa101.atdsrvano, " com valor 0."
               display "m_saida: ",m_saida
               output to report bdbsa101_resumo(m_saida clipped)
               initialize m_bdbsa101.* to null
               let m_ctt.srvdsp = m_ctt.srvdsp + 1
     ...
     if ls_sqlcode = 0 then
         display "Serviço ", m_bdbsa101.atdsrvnum, " ja provisionado, despresado."
         initialize m_bdbsa101.* to null 
         initialize mr_retorno.* to null
         continue foreach
     end if
...
#----------------------------------------------------------------
  ...
  if m_bdbsa101.atdetpcod <> 4 and
     m_bdbsa101.atdetpcod <> 5 then
      let m_saida = "Serviço ", m_bdbsa101.atdsrvnum,"-",m_bdbsa101.atdsrvano, " etapa ",m_bdbsa101.atdetpcod,", despresado."
...
#--------------------------------------------------------------------------#
  ...
  if l_c24astcod_ret = "RET" then
     let m_saida = "Serviço ", m_bdbsa101.atdsrvnum,"-",m_bdbsa101.atdsrvano, " retorno, despresado."
     display "ERRO: ",m_saida clipped
     #output to report bdbsa101_resumo(m_saida clipped)
     initialize m_bdbsa101.* to null
     return
