...
# Modulo.........: bdata008                                                   #
# Objetivo.......: Batch de Geracao do Arquivo Itau Auto Para o Siebel        #
# Analista Resp. : Humberto Benedito                                          #
# PSI            :                                                            #
#.............................................................................#
# Desenvolvimento: R.Fornax                                                   #
# Liberacao      : 21/08/2015                                                 #
#-----------------------------------------------------------------------------#
...
define m_bdata008_prep   smallint
...
#========================================================================
   ...
   call bdata008_cria_log()

   call bdata008_exibe_inicio()
   ...
   display " PREPARANDO... "
   display "##################################"
   call bdata008_prepare()


   display "##################################"
   display " RECUPERANDO QUEBRA... "
   display "##################################"
   if not bdata008_recupera_quebra() then
      exit program
   end if  
   ...
   if bdata008_valida_carga() then
   
      if not bdata008_carga_full() then
         let m_mensagem = "Carga Full Abortada. Verificar os Dominios."
         call ERRORLOG(m_mensagem);
         display m_mensagem
      end if
      
      call bdata008_atualiza_full()      
   ...
   ### CARGA DIARIA ###
   ####################
   if not bdata008_carga_diaria() then
      exit program
   end if
  
   call bdata008_exibe_final()

   call bdata008_dispara_email()
...
define l_sql char(10000)
   ...
   prepare p_bdata008_001 from l_sql
   declare c_bdata008_001 cursor with hold for p_bdata008_001
   ...
   let l_sql = ' select plnclscod,         '
             ...
             , '  and   clsvigfimdat >=  ? '
             , '  and   regsitflg = "A"    '
   prepare p_bdata008_002 from l_sql
   declare c_bdata008_002 cursor for p_bdata008_002
   ...
   let l_sql = ' select a.srvcod                 ,   '
              ...
              ,' and   a.plnclscod  = ?              '
   prepare p_bdata008_003 from l_sql
   declare c_bdata008_003 cursor with hold for p_bdata008_003
   
   let l_sql = ' select empnom     '
              ,' from gabkemp      '
              ,' where empcod = ?   '
   prepare p_bdata008_004 from l_sql
   declare c_bdata008_004 cursor for p_bdata008_004
   ...
   let l_sql = ' select count(*)        '
              ...
              ,' where srvclscod   =  ? '
              ,' and   trfctgcod   =  ? '
   prepare p_bdata008_005 from l_sql
   declare c_bdata008_005 cursor for p_bdata008_005
   

   let l_sql =  ' update datkplncls     '
             ,  ' set irdclsflg = "S"   '
             ,  ' where plnclscod = ?   '
   prepare p_bdata008_006 from l_sql
   
   let l_sql = ' select cpodes        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
              ,' and   cpocod =  ?    '
   prepare p_bdata008_007 from l_sql
   declare c_bdata008_007 cursor for p_bdata008_007
   ...
   let l_sql =  ' update datkdominio    '
              ...
              , ' where cponom =  ?     '
              , ' and   cpocod =  ?     '
   prepare p_bdata008_008 from l_sql
   
 
   let l_sql = ' select cpodes        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
   prepare p_bdata008_009 from l_sql
   declare c_bdata008_009 cursor for p_bdata008_009
   ...
   let l_sql = ' insert into datmbnfcrgmov  '
             ...
             ,'  values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,? '
             ,'  ,?,?,?,?,?,?)                         '
   prepare p_bdata008_010 from l_sql   
    ...
    let l_sql = ' insert into datmbnfcrgico '
             ...
             ,'  ,?,?,?,?,?,?,?,?,?,?,?,?,?            '
             ,'  ,?,?,?,?,?,?,?  )                     '
  prepare p_bdata008_011 from l_sql
  ...
  let l_sql = 'select a.itaciacod  , ',
              ...
              ' and   a.aplseqnum     = ? ',
              ' and   b.itaaplitmnum  = ? '
   prepare p_bdata008_012 from l_sql                
   declare c_bdata008_012 cursor for p_bdata008_012
   ...
   let l_sql = ' select  itacbtcod,    ' ,
               ...
               ' and   itarsrcaosrvcod  = ?     ' ,
               ' and   ubbcod           = ?     '
   prepare p_bdata008_013 from l_sql               
   declare c_bdata008_013 cursor for p_bdata008_013
   ...
   let l_sql = ' select cpodes[8,12]     '  
              ...
              ,' and   cpodes[1,2] =  ?  '
              ,' and   cpodes[4,6] =  ?  '             
   prepare p_bdata008_014 from l_sql                
   declare c_bdata008_014 cursor for p_bdata008_014 
   	
   let l_sql = ' select count(*)      '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
              ,' and   cpodes =  ?    '
   prepare p_bdata008_015 from l_sql
   declare c_bdata008_015 cursor for p_bdata008_015	
   ...
   let l_sql = ' select cpodes                       '  
              ...
              ,' and   cpocod =  ?                   '            
   prepare p_bdata008_016 from l_sql                
   declare c_bdata008_016 cursor for p_bdata008_016 	
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctseqnum =  ? '
              ,' and   incvigdat =  ? '              
   prepare p_bdata008_017 from l_sql
   declare c_bdata008_017 cursor for p_bdata008_017
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctclscod =  ? ' 
              ,' and   pcmflg in ("S","N") '           
   prepare p_bdata008_018 from l_sql
   declare c_bdata008_018 cursor for p_bdata008_018
   ...
   let l_sql = ' select count(*)           '
             ...
             , '  and   plnclscod <>  ?    '     
             , '  and   clsvigfimdat <= ?  '           
   prepare p_bdata008_019 from l_sql
   declare c_bdata008_019 cursor for p_bdata008_019
   ...
   let l_sql = ' select plnclscod          '
             ...
             , '  and   plnclscod <>  ?    '     
             , '  and   clsvigfimdat <= ?  '           
   prepare p_bdata008_020 from l_sql
   declare c_bdata008_020 cursor for p_bdata008_020 
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctclscod =  ? ' 
              ,' and   pcmflg in ("R","E") '           
   prepare p_bdata008_021 from l_sql
   declare c_bdata008_021 cursor for p_bdata008_021	

   let m_bdata008_prep = true
...
#========================================================================
   ...
   let l_path = m_path_log clipped, "bdata008.log"
...
#========================================================================
function bdata008_carrega_beneficio()
#========================================================================
...
let mr_processo2.prpnumidv      = 0
    ...
    #--------------------------------------------------------
     ...
     open c_bdata008_004 using mr_processo2.empcod

     whenever error continue
     fetch c_bdata008_004 into mr_processo2.empnom
     whenever error stop
    ...
    #--------------------------------------------------------
    open c_bdata008_001 using mr_data.inicio
  
    foreach c_bdata008_001 into mr_processo2.itaciacod
                              , mr_processo2.succod
       ...
       #------------------------------------------------------ 
       call bdata008_grava_apolice_processada()
       ...
       #------------------------------------------------------
       call bdata008_rec_dados_itau(mr_processo2.itaciacod,
                                    mr_processo2.ramcod   ,
                                    mr_processo2.aplnumdig,
                                    mr_processo2.edsnumref,
                                    mr_processo2.itmnumdig)
       ...
       let mr_processo2.clscod = g_doc_itau[1].itaasiplncod  
			 ...
			 #------------------------------------------------------ 
			 if bdata008_verifica_empresarial(mr_processo2.clscod) then		 
			 ...
			 #------------------------------------------------------  
			 let mr_processo2.codprod = bdata008_recupera_produto(mr_processo2.ramcod,mr_processo2.empcod)
			 ...
			 let mr_processo2.perfil =  bdata008_recupera_grupo_produto()
       ...
       open c_bdata008_002 using   mr_processo2.empcod ,
                                   mr_processo2.ramcod ,
                                   mr_processo2.clscod ,
                                   mr_processo2.perfil ,
                                   mr_processo2.viginc ,
                                   mr_processo2.viginc  
       whenever error continue
       fetch c_bdata008_002 into   mr_processo2.plnclscod,
       ...
       if sqlca.sqlcode = notfound  then
            ...
            call bdata008_grava_inconsistencia()
       ...
       if bdata008_acessa_inativacao() then
          if bdata008_regra_anterior() then
             call bdata008_carrega_inativacao()
          end if
       end if
       ...
       open c_bdata008_003 using mr_processo2.plnclscod

       foreach c_bdata008_003 into mr_processo2.srvcod                 ,
             ...
             open c_bdata008_005 using mr_processo2.srvplnclscod ,
                                       mr_processo2.ctgtrfcod

             whenever error continue
             fetch c_bdata008_005 into lr_retorno.cont
             whenever error stop
             ...
             if bdata008_valida_beneficio_processado() then
       ...
       if lr_retorno.grava then
           call bdata008_atualiza_exportado()
           let lr_retorno.grava = false
       end if
    ...
    call bdata008_exibe_dados_parciais()
...
#========================================================================
function bdata008_exibe_inicio()
#========================================================================
define l_data  date,
...
let mr_param.hour_ini = current
   ...
   display " "
   display "-------------------------------------------------------------------------"
   display " INICIO bdata008 - CARGA DE APOLICES ITAU AUTO PARA BASE DE BENEFICIO"
   display "-------------------------------------------------------------------------"
   display " "
...
#========================================================================
function bdata008_atualiza_exportado()
#========================================================================

   whenever error continue
   execute p_bdata008_006 using mr_processo2.plnclscod
...
#========================================================================
function bdata008_valida_carga()
#========================================================================
...
let lr_retorno.cponom = "bdata008_full"
let lr_retorno.cpocod = 1


  open c_bdata008_007 using  lr_retorno.cponom ,
                             lr_retorno.cpocod
  whenever error continue
  fetch c_bdata008_007 into lr_retorno.cpodes
  whenever error stop
...
#========================================================================
function bdata008_carga_diaria()
#========================================================================
   ...
   call bdata008_recupera_data_diaria()
   ...
   call bdata008_monta_mensagem2(m_mensagem)
   ...
   while mr_data.inicio <= mr_data.fim
      ...
      call bdata008_atualiza_data_diaria()

      call bdata008_carrega_beneficio()
         
      let mr_data.inicio = mr_data.inicio + 1 units day
     
   end while
   
   call bdata008_exibe_dados_totais()
...
#========================================================================
function bdata008_recupera_data_inicio()
#========================================================================
...
let lr_retorno.cponom = "bdata008_inicio"
let lr_retorno.cpocod = 1
...
#========================================================================
function bdata008_recupera_data_diaria()
#========================================================================
...
let lr_retorno.cponom = "bdata008_diaria"
let lr_retorno.cpocod = 1
...
#========================================================================
function bdata008_recupera_data_fim()
#========================================================================
...
let lr_retorno.cponom = "bdata008_fim"
let lr_retorno.cpocod = 1
...
#========================================================================
   ...
   call bdata008_recupera_data_inicio()
   call bdata008_recupera_data_fim()
   ...
   while mr_data.inicio <= mr_data.fim
      ...
      call bdata008_atualiza_data_full()

      call bdata008_carrega_beneficio()
         
      let mr_data.inicio = mr_data.inicio + 1 units day
      
      if not bdata008_valida_dia_hora() then
         exit while
      end if
...
#========================================================================
function bdata008_atualiza_data_full()
#========================================================================
...
let lr_retorno.cpodes = mr_data.inicio
   ...
   whenever error continue
   execute p_bdata008_008 using lr_retorno.cpodes,
                                lr_retorno.cponom,
                                lr_retorno.cpocod
   whenever error continue
...
#========================================================================
function bdata008_atualiza_data_diaria()
#========================================================================
...
#========================================================================
function bdata008_atualiza_full()
#========================================================================
...
#========================================================================
function bdata008_exibe_dados_parciais()
#========================================================================
   ...
   display " DADOS DESPREZADOS MOTOR PANO.....: ", mr_count1.claus
...
#========================================================================
function bdata008_exibe_dados_totais()
#========================================================================
...
#========================================================================
function bdata008_recupera_quebra()
#========================================================================
...
let lr_retorno.cpocod = 1
  ...
  open c_bdata008_007 using  lr_retorno.cponom ,
                             lr_retorno.cpocod
  whenever error continue
  fetch c_bdata008_007 into m_quebra
  whenever error stop
...
#========================================================================
function bdata008_dispara_email()
#========================================================================
...
initialize lr_mail.* to null
    ...
    let lr_mail.para    = bdata008_recupera_email()
    let lr_mail.cc      = ""
    let lr_mail.cco     = ""

    let lr_mail.assunto = "Carga Base Beneficios - Itau Auto"

    let lr_mail.mensagem  = bdata008_monta_mensagem()
...
#========================================================================
function bdata008_recupera_email()
#========================================================================
...
let lr_retorno.cponom = "bdata008_email"
  ...
  open c_bdata008_009 using  lr_retorno.cponom
  foreach c_bdata008_009 into lr_retorno.cpodes
...
#========================================================================
function bdata008_monta_mensagem()
#========================================================================
...
#========================================================================
#========================================================================
function bdata008_grava_inconsistencia()
#========================================================================
...
initialize lr_retorno.* to null
   ...
   whenever error continue
   execute p_bdata008_011 using   mr_inconsistencia.empcod
...
#========================================================================
#========================================================================
function bdata008_grava_beneficio()
#========================================================================
...
initialize lr_retorno.* to null
  ...
  let mr_processo2.data_ger = today
   ...
   whenever error continue
   execute p_bdata008_010 using mr_processo2.empcod
...
#========================================================================
function bdata008_monta_mensagem2(l_param)
#========================================================================
...
#------------------------------------------------------------------------------
function bdata008_rec_dados_itau(lr_param)
#------------------------------------------------------------------------------
...
let lr_retorno.erro = 0
   ...
   open c_bdata008_012 using lr_param.itaciacod    ,
                             lr_param.itaramcod    ,
                             lr_param.itaaplnum    ,
                             lr_param.aplseqnum    ,
   ...
   whenever error continue
   fetch c_bdata008_012 into g_doc_itau[1].itaciacod          ,
   ...
   if sqlca.sqlcode <> 0  then
      if sqlca.sqlcode = notfound  then
         ...
         let lr_retorno.mensagem = "Erro ao selecionar o cursor c_bdata008_008 ", sqlca.sqlcode
         let lr_retorno.erro     = sqlca.sqlcode
      end if
   end if
   close c_bdata008_012

   if lr_retorno.erro = 0 then

       # Recupera Plano e Cobertura

       call bdata008_rec_cobertura_plano(g_doc_itau[1].itaasisrvcod     ,
                                         g_doc_itau[1].rsrcaogrtcod     ,
                                         g_doc_itau[1].itarsrcaosrvcod  ,
                                         g_doc_itau[1].ubbcod           )
...
#------------------------------------------------------------------------------
function bdata008_rec_cobertura_plano(lr_param)
#------------------------------------------------------------------------------
...
let lr_retorno.erro = 0
   ...
   open c_bdata008_013 using lr_param.itaasisrvcod    ,
                             lr_param.rsrcaogrtcod    ,
                             lr_param.itarsrcaosrvcod ,
                             lr_param.ubbcod

   whenever error continue
   fetch c_bdata008_013 into lr_retorno.itacbtcod     ,
   ...
   if sqlca.sqlcode <> 0  then
      if sqlca.sqlcode = notfound  then
         ...
         let lr_retorno.mensagem = "Erro ao selecionar o cursor c_bdata008_009 ", sqlca.sqlcode
         let lr_retorno.erro     = sqlca.sqlcode
      end if
   end if
   close c_bdata008_013
...
#-------------------------------------------------#                  
 function bdata008_verifica_empresarial(lr_param)                    
#-------------------------------------------------#                  
...
initialize lr_retorno.* to null                                      
    ...
    open c_bdata008_015  using  lr_retorno.chave  ,                  
                                lr_param.itaasiplncod                
    whenever error continue                                          
    fetch c_bdata008_015 into lr_retorno.cont                        
    whenever error stop                                              
...
#------------------------------------------------------------
 function bdata008_recupera_produto(lr_param)                
#------------------------------------------------------------
...
let lr_retorno.cponom = "ctc69m07_prod"                                     
  ...
  open c_bdata008_014 using  lr_retorno.cponom ,                            
                             lr_param.empcod   ,
                             lr_param.ramcod                            
  whenever error continue                                                   
  fetch c_bdata008_014 into lr_retorno.procod                               
  whenever error stop                                                       
...
#======================================================================== 
 function bdata008_valida_dia_hora()
#======================================================================== 
...
#========================================================================
 function bdata008_recupera_grupo_produto()                
#========================================================================
...
initialize lr_retorno.* to null                                             
  ...
  open c_bdata008_016 using  g_doc_itau[1].itaprdcod                             
                                      
  whenever error continue                                                   
  fetch c_bdata008_016 into lr_retorno.grpprdcod                              
  whenever error stop
...
#========================================================================
#========================================================================
function bdata008_grava_apolice_processada()
#========================================================================
...
initialize lr_retorno.* to null
   ...
   if bdata008_valida_processado() then
...
#========================================================================
 function bdata008_valida_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata008_017 using   mr_inconsistencia.empcod   
                            , lr_retorno.doctipcod
                            , mr_inconsistencia.succod
                            , mr_inconsistencia.ramcod
                            , mr_inconsistencia.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata008_017 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata008_valida_beneficio_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata008_018 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc
                            , mr_processo2.itaciacod
                            , mr_processo2.ramcod
                            , mr_processo2.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata008_018 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata008_valida_beneficio_inativado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata008_021 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc
                            , mr_processo2.itaciacod
                            , mr_processo2.ramcod
                            , mr_processo2.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata008_021 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
function bdata008_regra_anterior()
#========================================================================
...
let lr_retorno.cont = 0    
  ...
  open c_bdata008_019 using   mr_processo2.empcod      ,              
                              mr_processo2.ramcod      ,              
                              mr_processo2.clscod      ,              
                              mr_processo2.perfil      ,              
                              ...
                              mr_processo2.clsviginidat                    
  whenever error continue
  fetch c_bdata008_019 into   lr_retorno.cont                             
  whenever error stop
...
#========================================================================                                                                                                                      
function bdata008_carrega_inativacao()                                             
#========================================================================          
...
initialize lr_retorno.* to null   
     ...
     open c_bdata008_020 using   mr_processo2.empcod      ,          
                                 mr_processo2.ramcod      ,          
                                 mr_processo2.clscod      ,          
                                 mr_processo2.perfil      ,          
                                 mr_processo2.plnclscod   ,          
     ...
     foreach c_bdata008_020 into mr_processo3.plnclscod              

           #-------------------------------------------------------- 
           # Recupera os Servicos de Cada Regra                      
           #-------------------------------------------------------- 
           
           open c_bdata008_003 using mr_processo3.plnclscod
           
           foreach c_bdata008_003 into mr_processo3.srvcod                 ,
                 ...
                 open c_bdata008_005 using mr_processo3.srvplnclscod ,
                                           mr_processo2.ctgtrfcod
                 ...
                 if bdata008_valida_beneficio_inativado() then
                   	let mr_count1.proce = mr_count1.proce + 1
                 	  let mr_total.proce  = mr_total.proce + 1
							    	continue foreach
                 end if  
...
#========================================================================
function bdata008_grava_inativo()
#========================================================================
...
#========================================================================
function bdata008_acessa_inativacao()
#========================================================================
