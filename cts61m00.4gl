...
globals "/homedsa/projetos/geral/globals/glct.4gl"
 ...
 define a_cts61m00    array[2] of record
    operacao          char (01)                    ,
...
#-----------------------------------------------#
 ...
 prepare p_cts61m00_001 from l_sql_stmt
 declare c_cts61m00_001 cursor for p_cts61m00_001


 let l_sql_stmt = "select c24astcod from datmligacao ",
                  " where atdsrvnum = ? ",
                  " and  atdsrvano = ? "
  prepare p_cts61m00_002 from l_sql_stmt
  declare c_cts61m00_002 cursor for p_cts61m00_002
  ...
  prepare p_cts61m00_003 from l_sql_stmt
  declare c_cts61m00_003 cursor for p_cts61m00_003
  ...
  let l_sql_stmt = " select atdetpcod  from datmsrvacp ",
                   ...
                   "                    where atdsrvnum = ? ",
                   "                      and atdsrvano = ? )"
  prepare p_cts61m00_004 from l_sql_stmt
  declare c_cts61m00_004 cursor for p_cts61m00_004


 let l_sql_stmt = " update datmservico set c24opemat = null " ,
                  " where atdsrvnum = ? ",
                  "   and atdsrvano = ? "
 prepare p_cts61m00_005 from l_sql_stmt
 ...
 let l_sql_stmt = " select nom,cornom,corsus,atddfttxt,funmat,asitipcod,",
                  ...
                  " where atdsrvnum = ?  " ,
                  " and atdsrvano = ? "
 prepare p_cts61m00_006 from l_sql_stmt
 declare c_cts61m00_006 cursor for p_cts61m00_006
 ...
 prepare p_cts61m00_007 from l_sql_stmt
 declare c_cts61m00_007 cursor for p_cts61m00_007
 ...
 let l_sql_stmt = " select srvretexcdes ",
                  ...
                  " where atdsrvnum = ? ",
                  " and atdsrvano = ? "
 prepare p_cts61m00_008 from l_sql_stmt
 declare c_cts61m00_008 cursor for p_cts61m00_008

 let l_sql_stmt = " select srvretmtvdes ",
                  " from datksrvret ",
                  " where srvretmtvcod  = ? "
 prepare p_cts61m00_009 from l_sql_stmt
 declare c_cts61m00_009 cursor for p_cts61m00_009
 ...
 let l_sql_stmt = " select ofnnumdig ",
                  ...
                  "  and atdsrvnum = ? ",
                  "  and c24endtip = 1 "
 prepare p_cts61m00_010 from l_sql_stmt
 declare c_cts61m00_010 cursor for p_cts61m00_010

 let l_sql_stmt = " select socntzdes  ",
                  " from datksocntz ",
                  " where socntzcod = ? "
 prepare p_cts61m00_011 from l_sql_stmt
 declare c_cts61m00_011 cursor for p_cts61m00_011

 let l_sql_stmt = " select asitipabvdes ",
                  " from datkasitip ",
                  " where asitipcod = ? "
 prepare p_cts61m00_012 from l_sql_stmt
 declare c_cts61m00_012 cursor for p_cts61m00_012

 let l_sql_stmt =  " select c24solnom, ligcvntip, c24astcod ",
                   " from datmligacao ",
                   " where lignum = ? "
 prepare p_cts61m00_013 from l_sql_stmt
 declare c_cts61m00_013 cursor for p_cts61m00_013

 let l_sql_stmt = " select funnom, dptsgl ",
                  " from isskfunc ",
                  " where empcod = ? ",                               #Raul, Biz
                  "  and funmat = ? "
 prepare p_cts61m00_014 from l_sql_stmt
 declare c_cts61m00_014 cursor for p_cts61m00_014

let l_sql_stmt = "  select cpodes   ",
                 " from iddkdominio ",
                 " where cponom = 'atdprinvlcod' ",
                 "  and cpocod = ? "
prepare p_cts61m00_015 from l_sql_stmt
declare c_cts61m00_015 cursor for p_cts61m00_015
...
prepare p_cts61m00_016 from l_sql_stmt
declare c_cts61m00_016 cursor for p_cts61m00_016
...
prepare p_cts61m00_017 from l_sql_stmt
declare c_cts61m00_017 cursor for p_cts61m00_017

let l_sql_stmt = " select atdetpcod  from datmsrvacp ",
                 " where atdsrvnum = ? ",
                 " and atdsrvano = ? ",
                 " and atdsrvseq = ? "
prepare p_cts61m00_018 from l_sql_stmt
declare c_cts61m00_018 cursor for p_cts61m00_018
...
prepare p_cts61m00_019 from l_sql_stmt
...
let l_sql_stmt = "update datmsrvre set (lclrsccod,orrdat,socntzcod, ",
                 ...
                 " where atdsrvnum = ? ",
                 " and atdsrvano = ? "
prepare p_cts61m00_020 from l_sql_stmt

let l_sql_stmt = "delete from datmsrvretexc ",
                 " where atdsrvnum = ? ",
                 " and atdsrvano = ? "
prepare p_cts61m00_021 from l_sql_stmt

let l_sql_stmt = " insert into datmsrvretexc ( atdsrvnum,atdsrvano, ",
                 " srvretexcdes,caddat,cademp,cadmat,cadusrtip   ) ",
                 " values ( ? , ? ,? ,? ,? ,? ,? ) "
prepare p_cts61m00_022 from l_sql_stmt

let l_sql_stmt = " select asitipabvdes "
                   ,"  from datkasitip "
                   ,"  where asitipcod = ? "
                   ,"    and asitipstt = 'A' "
prepare p_cts61m00_023 from l_sql_stmt
declare c_cts61m00_023 cursor for p_cts61m00_023
...
prepare p_cts61m00_024 from l_sql_stmt
declare c_cts61m00_024 cursor for p_cts61m00_024
...
let l_sql_stmt = ' select lgdtip,lgdnom,lgdnum,   ',
                   ...
                   '    and atdsrvano = ?           ',
                   '    and c24endtip = 1           '
 prepare p_cts61m00_025 from l_sql_stmt
 declare c_cts61m00_025 cursor for p_cts61m00_025
 ...
 let l_sql_stmt = " select segnumdig  from abbmdoc ",
                  ...
                  " and itmnumdig = ? ",
                  " and dctnumseq = ? "
 prepare p_cts61m00_026 from l_sql_stmt
 declare c_cts61m00_026 cursor for p_cts61m00_026

let l_sql_stmt = " select cgccpfnum, cgccpfdig ",
                 " from gsakseg ",
                 " where gsakseg.segnumdig = ? "
prepare p_cts61m00_027 from l_sql_stmt
declare c_cts61m00_027 cursor for p_cts61m00_027
...
prepare p_cts61m00_028 from l_sql_stmt
declare c_cts61m00_028 cursor for p_cts61m00_028

let l_sql_stmt = " select cornom from gcaksusep, gcakcorr ",
                 " where gcaksusep.corsus = ? and ",
                 " gcakcorr.corsuspcp = gcaksusep.corsuspcp "
prepare p_cts61m00_029 from l_sql_stmt
declare c_cts61m00_029 cursor for p_cts61m00_029
...
let l_sql_stmt = " select max(a.atdsrvnum)  ",
                    ...
                    "  group by a.atdsrvano         ",
                    "  order by a.atdsrvano desc    "
prepare p_cts61m00_030 from l_sql_stmt
declare c_cts61m00_030 cursor for p_cts61m00_030

let l_sql_stmt = " select natagdflg ",
              " from datksocntz ",
              " where socntzcod = ? "
prepare p_cts61m00_031 from l_sql_stmt
declare c_cts61m00_031 cursor for p_cts61m00_031

let l_sql_stmt = " select c24astcod  "
                ,"  from datmligacao "
                ,"  where lignum = ? "
prepare p_cts61m00_032 from l_sql_stmt
declare c_cts61m00_032 cursor for p_cts61m00_032
...
prepare p_cts61m00_033 from l_sql_stmt
declare c_cts61m00_033 cursor for p_cts61m00_033

let l_sql_stmt = "select atdlibflg ",
                 " from datmservico ",
                 " where atdsrvnum = ? ",
                 " and   atdsrvano = ? "
prepare p_cts61m00_034 from l_sql_stmt
declare c_cts61m00_034 cursor for p_cts61m00_034

let l_sql_stmt = "select atddfttxt, asitipcod, nom, corsus, cornom ",
                 " from datmservico ",
                 " where atdsrvnum = ? ",
                 " and atdsrvano = ? "
prepare p_cts61m00_035 from l_sql_stmt
declare c_cts61m00_035 cursor for p_cts61m00_035
...
let l_sql_stmt = "select c24solnom, ligcvntip  ",
                  ...
                  " where atdsrvnum = ? ",
                  " and atdsrvano   = ? "
prepare p_cts61m00_036 from l_sql_stmt
declare c_cts61m00_036 cursor for p_cts61m00_036
...
let l_sql_stmt = " select lclrsccod   , atdorgsrvnum,atdorgsrvano, ",
                 ...
                 " where datmsrvre.atdsrvnum = ? ",
                 "  and datmsrvre.atdsrvano = ? "
prepare p_cts61m00_037 from l_sql_stmt
declare c_cts61m00_037 cursor for p_cts61m00_037
...
prepare p_cts61m00_038 from l_sql_stmt
declare c_cts61m00_038 cursor for p_cts61m00_038
...
let l_sql_stmt = " select pstcoddig,srrcoddig,socvclcod ",
                 ...
                 "     atdsrvano =   ? and ",
                 "     atdsrvseq =   ? "
prepare p_cts61m00_039 from l_sql_stmt
declare c_cts61m00_039 cursor for p_cts61m00_039

let l_sql_stmt = " select atdvclsgl from datkveiculo ",
                 " where socvclcod = ? "
prepare p_cts61m00_040 from l_sql_stmt
declare c_cts61m00_040 cursor for p_cts61m00_040
...
let l_sql_stmt = " select ofnnumdig  ",
                 ...
                 "  and atdsrvnum = ? ",
                 "  and c24endtip = 1 "
prepare p_cts61m00_041 from l_sql_stmt
declare c_cts61m00_041 cursor for p_cts61m00_041
...
let l_sql_stmt = " select c24pbmcod     ",
                 ...
                 " and c24pbminforg = 1 ",
                 " and c24pbmseq    = 1 "
prepare p_cts61m00_042 from l_sql_stmt
declare c_cts61m00_042 cursor for p_cts61m00_042

let l_sql_stmt = " select socntzdes     ",
                 " from datksocntz     ",
                 " where socntzcod = ? "
prepare p_cts61m00_043 from l_sql_stmt
declare c_cts61m00_043 cursor for p_cts61m00_043


let l_sql_stmt = " select asitipabvdes  ",
                 " from datkasitip      ",
                 " where asitipcod = ?  "
prepare p_cts61m00_044 from l_sql_stmt
declare c_cts61m00_044 cursor for p_cts61m00_044
 ...
 let l_sql_stmt = ' update datmservico set '
                   ...
                   ,'  where atdsrvnum = ? '
                   ,'    and atdsrvano = ? '
prepare p_cts61m00_045 from l_sql_stmt
...
let l_sql_stmt = ' select max(atdsrvseq) '
                   ...
                   ,'  where atdsrvnum = ? '
                   ,'    and atdsrvano = ? '
prepare p_cts61m00_046 from l_sql_stmt
declare c_cts61m00_046 cursor for p_cts61m00_046
...
let l_sql_stmt = ' insert into datmsrvre '
                   ...
                   ,'        lclnumseq   , rmerscseq) '
                  , ' values (?,?,?,?,"00:00",?,"N",?,?,?,?,?,?,?) '
prepare p_cts61m00_047 from l_sql_stmt
...
let l_sql_stmt = ' insert into datmsrvretexc '
                   ...
                   ,' values (?,?,?,?,?,?,?) '
prepare p_cts61m00_048 from l_sql_stmt
...
let l_sql_stmt = ' insert into datrservapol '
                   ...
                   ,'        itmnumdig, edsnumref ) '
                   ,' values (?,?,?,?,?,?,?) '
prepare p_cts61m00_049 from l_sql_stmt
...
let l_sql_stmt =  "Insert into dbscadtippgt (anosrv,",
                     ...
                     "pgtempcod) values  ",
                     "(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
prepare p_cts61m00_050 from l_sql_stmt

let l_sql_stmt = ' insert into datratdmltsrv '
                   ,'      ( atdsrvnum, atdsrvano, '
                   ,'        atdmltsrvnum, atdmltsrvano ) '
                   ,' values (?,?,?,?) '
prepare p_cts61m00_051 from l_sql_stmt
...
let l_sql_stmt = ' update datmservico '
                    ...
                    ,' where atdsrvnum = ? '
                      ,' and atdsrvano = ? '
prepare p_cts61m00_052 from l_sql_stmt
...
prepare p_cts61m00_053 from l_sql_stmt
declare c_cts61m00_053 cursor for p_cts61m00_053
...
prepare p_cts61m00_054 from l_sql_stmt
declare c_cts61m00_054 cursor for p_cts61m00_054
...
let l_sql_stmt = ' select srrltt, srrlgt ',
                ...
                ' where atdsrvnum = ? ',
                  ' and atdsrvano = ? '
prepare p_cts61m00_055 from l_sql_stmt
declare c_cts61m00_055 cursor for p_cts61m00_055

let l_sql_stmt = " select atdprscod, socvclcod, srrcoddig ",
                 " from datmservico ",
                 " where atdsrvnum = ? ",
                 " and atdsrvano = ? "
prepare p_cts61m00_056 from l_sql_stmt
declare c_cts61m00_056 cursor for p_cts61m00_056
...
let l_sql_stmt = " select atdsrvnum, atdsrvano, ",
                 ...
                 "  and  atdhorprg <  ? )",
                 "  and  atdprscod = ? "
prepare p_cts61m00_057 from l_sql_stmt
declare c_cts61m00_057 cursor for p_cts61m00_057
...
let l_sql_stmt = " select 1 ",
                 ...
                 " and atdsrvano    = ? ",
                 " and socvclcod    = ? "
prepare p_cts61m00_058 from l_sql_stmt
declare c_cts61m00_058 cursor for p_cts61m00_058
...
prepare p_cts61m00_059 from l_sql_stmt
declare c_cts61m00_059 cursor for p_cts61m00_059
...
let l_sql_stmt = "select 1 ",
                 ...
                 " and atdsrvano  = ? ",
                 " and socvclcod = ? "
prepare p_cts61m00_060 from l_sql_stmt
declare c_cts61m00_060 cursor for p_cts61m00_060

let l_sql_stmt = ' select atdmltsrvnum, atdmltsrvano '
                   ,'   from datratdmltsrv '
                   ,'  where atdsrvnum = ? '
                   ,'    and atdsrvano = ? '
prepare p_cts61m00_061 from l_sql_stmt
declare c_cts61m00_061 cursor for p_cts61m00_061
...
let l_sql_stmt = ' update datmservico '
                   ...
                   ,'  where atdsrvnum = ? '
                   ,'    and atdsrvano = ? '
prepare p_cts61m00_062 from l_sql_stmt
...
prepare p_cts61m00_063 from l_sql_stmt
declare c_cts61m00_063 cursor for p_cts61m00_063

let l_sql_stmt = " select c24atvcod ",
                 " from dattfrotalocal ",
                 " where socvclcod = ? "

prepare p_cts61m00_064 from l_sql_stmt
declare c_cts61m00_064 cursor for p_cts61m00_064
...
prepare p_cts61m00_065 from l_sql_stmt
declare c_cts61m00_065 cursor for p_cts61m00_065

let l_sql_stmt = " select grlinf ",
                 " from datkgeral ",
                 " where grlchv = 'PSOAGENDAWATIVA' "
prepare p_cts61m00_066 from l_sql_stmt
declare c_cts61m00_066 cursor for p_cts61m00_066
...
#--------------------------------------------------------------------
 ...
 initialize a_cts61m00    to null
 initialize d_cts61m00.*  to null
 initialize w_cts61m00.*  to null
 ...
 let w_cts61m00.atddat = m_data
 let w_cts61m00.atdhor = m_hora
 let flgcpl            = 0
 ...
 open c_cts61m00_066
 fetch c_cts61m00_066 into m_agendaw
 ...
 if ws_acao is  null  or
    ...
    whenever error continue
    open c_cts61m00_001 using g_documento.atdsrvnum,
                              g_documento.atdsrvano

    whenever error stop

    foreach c_cts61m00_001 into ws.c24astcod_ret
       if ws.c24astcod_ret = "RET"  then
          let ws_acao = "RET"
       end if
       exit foreach
    end foreach
    close c_cts61m00_001

 end if

  #display "Teste"
  whenever error continue
   open c_cts61m00_002  using g_documento.atdsrvnum,g_documento.atdsrvano
   fetch c_cts61m00_002 into m_c24astcodflag
  whenever error stop

  close c_cts61m00_002
 ...
 if ws_acao is not null    and ws_acao      = "RET"   then
    ...
    open window cts61m00r at 04,02 with form "cts61m00"
    ...
    if ws.flag_acesso = 0 then
       ...
       if m_obter_mult = 1 then
          let ws_tela = "SRV"
          open window cts61m00s at 04,02 with form "cts61m00"
                                attribute(form line 1)
          ...
          open window cts61m00m at 04,02 with form "cts61m00"
                                attribute(form line 1)
...
let w_cts61m00.ligcvntip  =  g_documento.ligcvntip
 ...
 if g_documento.atdsrvnum is not null  and
    ...
    call consulta_cts61m00()

    display by name d_cts61m00.srvnum thru d_cts61m00.atdtxt
    display by name d_cts61m00.c24solnom attribute (reverse)

    display by name d_cts61m00.espdes
    display by name a_cts61m00[1].lgdtxt,
                    a_cts61m00[1].lclbrrnom,
                    a_cts61m00[1].cidnom,
                    a_cts61m00[1].ufdcod,
                    a_cts61m00[1].lclrefptotxt,
                    a_cts61m00[1].endzon,
                    a_cts61m00[1].dddcod,
                    a_cts61m00[1].lcltelnum,
                    a_cts61m00[1].lclcttnom,
                    a_cts61m00[1].celteldddcod,
                    a_cts61m00[1].celtelnum,
                    a_cts61m00[1].endcmp


    if w_cts61m00.atdfnlflg = "S"  then
    ...
    if d_cts61m00.srvretmtvcod is not null then
       display d_cts61m00.srvretmtvcod to srvretmtvcod
       display d_cts61m00.srvretmtvdes to srvretmtvdes
    end if

    call modifica_cts61m00() returning ws.grvflg
...
#--------------------------------------------------------------------
       ...
       if g_documento.ramcod = 31   or
          ...
          call cty22g00_busca_nome_corretor()
               returning d_cts61m00.cornom

          let l_chassi = g_doc_itau[1].autplcnum

          let d_cts61m00.nom    = g_doc_itau[1].segnom  clipped
          let d_cts61m00.corsus = g_doc_itau[1].corsus clipped
          let ws.vclcoddig      = g_doc_itau[1].porvclcod clipped
          let ws.vcldes         = g_doc_itau[1].autmodnom clipped
          let ws.vclanomdl      = g_doc_itau[1].autmodano clipped
          let ws.vcllicnum      = g_doc_itau[1].autplcnum clipped
          let ws.vclchsinc      = l_chassi[1,8]
          let ws.vclchsfnl      = l_chassi[9,15]
          let ws.vclcordes      = g_doc_itau[1].autcornom clipped

    end if

    let d_cts61m00.c24solnom = g_documento.solnom
    let d_cts61m00.prslocflg = "N"
    ...
    open c_cts61m00_003
    whenever error continue
    fetch c_cts61m00_003 into l_grlinf
    whenever error stop
    ...
    if sqlca.sqlcode <> 0 then
       ...
       if sqlca.sqlcode = notfound then
          ...
          clear form
          if ws_tela = "RET" then
             close window cts61m00r
          else
             if ws_tela = "SRV" then
                close window cts61m00s
             else
                close window cts61m00m
             end if
          end if
    ...
    call inclui_cts61m00() returning ws.grvflg
    ...
    if ws.grvflg = true  then
       ...
       call cts10n00(w_cts61m00.atdsrvnum, w_cts61m00.atdsrvano,
                     w_cts61m00.funmat   , w_cts61m00.atddat   ,
                     w_cts61m00.atdhor)

       call cts17m03_incluir_hist(w_cts61m00.atdsrvnum, w_cts61m00.atdsrvano )
       ...
       call cts17m03_envio_email(g_documento.ramcod, g_documento.c24astcod,
                                ...
                                w_cts61m00.lignum,  w_cts61m00.atdsrvnum,
                                w_cts61m00.atdsrvano, g_documento.prporg,
       ...
       whenever error continue
       open c_cts61m00_004 using w_cts61m00.atdsrvnum,
                                 w_cts61m00.atdsrvano,
                                 w_cts61m00.atdsrvnum,
                                 w_cts61m00.atdsrvano
       fetch c_cts61m00_004  into ws.atdetpcod
       whenever error stop
       ...
       if ws.atdetpcod    <> 3   and    # servico etapa concluida RE
          ...
          #--------------------------------------------
          whenever error continue
          execute p_cts61m00_005 using w_cts61m00.atdsrvnum,
                                       w_cts61m00.atdsrvano
          whenever error stop
          ...
          if sqlca.sqlcode <> 0  then
            ...
            call cts00g07_apos_servdesbloqueia(w_cts61m00.atdsrvnum,w_cts61m00.atdsrvano)
          end if
          ...
          let l_nulo = null
          whenever error continue
          open c_cts61m00_061 using w_cts61m00.atdsrvnum
                                , w_cts61m00.atdsrvano
          whenever error stop
          foreach c_cts61m00_061 into l_atdmltsrvnum, l_atdmltsrvano

               whenever error continue
               execute p_cts61m00_062 using l_nulo, l_atdmltsrvnum, l_atdmltsrvano
               whenever error stop
 ...
 if m_veiculo_aciona is not null then
    ...
    whenever error continue
    open c_cts61m00_063 using m_veiculo_aciona
    fetch c_cts61m00_063 into l_socacsflg
                           ,l_c24opemat
    whenever error stop
    close c_cts61m00_063

    whenever error continue
    open c_cts61m00_064 using m_veiculo_aciona
    fetch c_cts61m00_064 into l_c24atvcod
    whenever error stop

    close c_cts61m00_064
    ...
    if l_socacsflg = 1      and  # Verifica se o veiculo esta bloqueado pelo acn imd do laudo
       ...
       l_c24atvcod = 'QRV'  then
        ...
        if g_documento.acao is null then
           let l_servico = w_cts61m00.atdsrvnum
           let l_ano =  w_cts61m00.atdsrvano
        else
        ...
        call cts61m00_ac(l_servico, l_ano)
 ...
 #cancelamento de um servico para um servico ainda nao acionado
  if ws_acao = 'CAN' then
     # Funcao que substituiu a "cts61m00_cancela"
...
end function  ###  cts61m00

#--------------------------------------------------------------------
 function consulta_cts61m00()
#--------------------------------------------------------------------
 ...
 whenever error continue
 open c_cts61m00_006 using g_documento.atdsrvnum,
                           g_documento.atdsrvano
 fetch c_cts61m00_006 into d_cts61m00.nom      ,
                           d_cts61m00.cornom   ,
                           d_cts61m00.corsus   ,
                           d_cts61m00.atddfttxt,
                           ws.funmat           ,
                           d_cts61m00.asitipcod,
                           w_cts61m00.atddat   ,
                           w_cts61m00.atdhor   ,
                           d_cts61m00.atdlibflg,
                           w_cts61m00.atdlibhor,
                           w_cts61m00.atdlibdat,
                           w_cts61m00.atdhorpvt,
                           w_cts61m00.atdpvtretflg,
                           w_cts61m00.atddatprg,
                           w_cts61m00.atdhorprg,
                           w_cts61m00.atdfnlflg,
                           d_cts61m00.atdprinvlcod,
                           ws.atdprscod,
                           d_cts61m00.prslocflg,
                           m_acntntqtd,
...
whenever error stop
 ...
 close c_cts61m00_006

 let m_atdfnlflg = w_cts61m00.atdfnlflg
 ...
 whenever error continue
 open c_cts61m00_007 using  g_documento.atdsrvnum,
                            g_documento.atdsrvano
 fetch c_cts61m00_007 into d_cts61m00.lclrsccod,
                           d_cts61m00.orrdat   ,
                           d_cts61m00.socntzcod,
                           cpl_atdsrvnum,
                           cpl_atdsrvano,
                           d_cts61m00.srvretmtvcod,
                           d_cts61m00.espcod,
                           d_cts61m00.retprsmsmflg
 whenever error stop
 ...
 close c_cts61m00_007

 initialize d_cts61m00.servicorg  to null
 if cpl_atdsrvnum is not null then
    let cpl_atdsrvorg = 09
    let d_cts61m00.servicorg  = cpl_atdsrvorg using "&&",
                                "/", cpl_atdsrvnum using "&&&&&&&",
                                "-", cpl_atdsrvano using "&&"
 end if
...
#--------------------------------------------------------------------
 initialize d_cts61m00.srvretmtvdes to null
 if d_cts61m00.srvretmtvcod is not null then

    if d_cts61m00.srvretmtvcod = 999  then
       whenever error continue
       open c_cts61m00_008 using g_documento.atdsrvnum,
                                 g_documento.atdsrvano
       fetch c_cts61m00_008 into d_cts61m00.srvretmtvdes
       whenever error stop

    else
       whenever error continue
       open c_cts61m00_009 using d_cts61m00.srvretmtvcod
       fetch c_cts61m00_009 into d_cts61m00.srvretmtvdes
       whenever error stop
    end if

    close c_cts61m00_008
    close c_cts61m00_009
...
#--------------------------------------------------------------------
    call ctx04g00_local_gps(g_documento.atdsrvnum,
                            g_documento.atdsrvano,
                            1)
                  returning a_cts61m00[1].lclidttxt   ,
                            a_cts61m00[1].lgdtip      ,
                            a_cts61m00[1].lgdnom      ,
                            a_cts61m00[1].lgdnum      ,
                            a_cts61m00[1].lclbrrnom   ,
                            ...
                            a_cts61m00[1].endzon      ,
                            a_cts61m00[1].lgdcep      ,
                            a_cts61m00[1].lgdcepcmp   ,
                            a_cts61m00[1].lclltt      ,
                            a_cts61m00[1].lcllgt      ,
                            a_cts61m00[1].dddcod      ,
                            a_cts61m00[1].lcltelnum   ,
                            a_cts61m00[1].lclcttnom   ,
                            a_cts61m00[1].c24lclpdrcod,
                            a_cts61m00[1].celteldddcod,
                            a_cts61m00[1].celtelnum,
                            a_cts61m00[1].endcmp   ,
                            ws.cogidosql, a_cts61m00[1].emeviacod


    whenever error continue
    open c_cts61m00_010 using g_documento.atdsrvano,
                              g_documento.atdsrvnum
    fetch c_cts61m00_010 into a_cts61m00[1].ofnnumdig
    whenever error stop
    ...
    let a_cts61m00[1].lgdtxt = a_cts61m00[1].lgdtip clipped, " ",
                               a_cts61m00[1].lgdnom clipped, " ",
                               a_cts61m00[1].lgdnum using "<<<<#"


 let d_cts61m00.socntzdes = "*** NAO CADASTRADA ***"

 whenever error continue
 open c_cts61m00_011 using d_cts61m00.socntzcod
 fetch c_cts61m00_011 into d_cts61m00.socntzdes
 whenever error stop

 # busca descricao especialidade
 let d_cts61m00.espdes = null
 if d_cts61m00.espcod is not null then

    #como so quero buscar a descricao, nao importando a situacao da
    # especialidade (ativo ou nao), passo null para a funcao

    let l_espsit = null
    call cts31g00_descricao_esp(d_cts61m00.espcod, l_espsit)
         returning d_cts61m00.espdes

    if d_cts61m00.espdes is null then
       error "Descricao nao encontrada para especialidade."
    end if
 end if

 let d_cts61m00.asitipabvdes = "NAO PREV"

 whenever error continue

 open c_cts61m00_012 using d_cts61m00.asitipcod
 fetch c_cts61m00_012 into d_cts61m00.asitipabvdes

 whenever error stop

 close c_cts61m00_012

#--------------------------------------------------------------------
# Identificacao do SOLICITANTE/CONVENIO
#--------------------------------------------------------------------

 let w_cts61m00.lignum =
     cts20g00_servico(g_documento.atdsrvnum, g_documento.atdsrvano)

 call cts20g01_docto(w_cts61m00.lignum)
 ...
 call cts20g01_docto_tot(w_cts61m00.lignum)
 ...
 if g_documento.succod    is not null  and
    g_documento.ramcod    is not null  and
    g_documento.aplnumdig is not null  then
    let d_cts61m00.doctxt = "Apolice.: ", g_documento.succod    using "<<<&&", #"&&", Projeto succod
                                     " ", g_documento.ramcod    using "##&&",
                                     " ", g_documento.aplnumdig using "<<<<<<<& &"
 end if
 ...
 #   let d_cts61m00.doctxt = "Proposta: ", g_documento.prporg    using "&&",
 ...
 open c_cts61m00_013 using w_cts61m00.lignum
 fetch c_cts61m00_013 into d_cts61m00.c24solnom,
                           w_cts61m00.ligcvntip,
                           l_c24astcod

 whenever error stop

 close c_cts61m00_013
 #===========================================================================
 ...
 let g_documento.solnom = d_cts61m00.c24solnom
...
#--------------------------------------------------------------------
 ...
 open c_cts61m00_014 using ws.empcod                                  #Raul, Biz
                          ,ws.funmat
 fetch c_cts61m00_014 into ws.funnom, ws.dptsgl

 whenever error stop

 close c_cts61m00_014



 let d_cts61m00.atdtxt = w_cts61m00.atddat           , " ",
                         w_cts61m00.atdhor           , " ",
 ...
 if w_cts61m00.atdhorpvt is not null  or
    w_cts61m00.atdhorpvt  = "00:00"   then
    let d_cts61m00.imdsrvflg = "S"
 end if

 if w_cts61m00.atddatprg is not null  then
    let d_cts61m00.imdsrvflg = "N"
 end if

 let w_cts61m00.atdlibflg = d_cts61m00.atdlibflg

 if d_cts61m00.atdlibflg = "N"  then
    let w_cts61m00.atdlibdat = w_cts61m00.atddat
    let w_cts61m00.atdlibhor = w_cts61m00.atdhor
 end if

 let d_cts61m00.srvnum = g_documento.atdsrvorg using "&&",
                    "/", g_documento.atdsrvnum using "&&&&&&&",
                    "-", g_documento.atdsrvano using "&&"

 whenever error continue
 open c_cts61m00_015 using d_cts61m00.atdprinvlcod
 fetch c_cts61m00_015 into d_cts61m00.atdprinvldes
 whenever error stop
 close c_cts61m00_015

 whenever error continue
 open c_cts61m00_016 using g_documento.atdsrvnum,
                           g_documento.atdsrvano

 fetch c_cts61m00_016 into d_cts61m00.c24pbmcod

 whenever error stop

 close c_cts61m00_016


 let mr_salva.lgdnom    = a_cts61m00[1].lgdnom
 let mr_salva.lgdnum    = a_cts61m00[1].lgdnum
 let mr_salva.brrnom    = a_cts61m00[1].brrnom
 let mr_salva.lclbrrnom = a_cts61m00[1].lclbrrnom
 let mr_salva.cidnom    = a_cts61m00[1].cidnom
 let mr_salva.ufdcod    = a_cts61m00[1].ufdcod
 let mr_salva.lgdcep    = a_cts61m00[1].lgdcep
 let mr_salva.lclltt    = a_cts61m00[1].lclltt
 let mr_salva.imdsrvflg = d_cts61m00.imdsrvflg
 let mr_salva.atddatprg = w_cts61m00.atddatprg
 let mr_salva.atdhorprg = w_cts61m00.atdhorprg
 let mr_salva.atdlibdat = w_cts61m00.atdlibdat
 let mr_salva.atdlibhor = w_cts61m00.atdlibhor
 let mr_salva.c24lclpdrcod = a_cts61m00[1].c24lclpdrcod

whenever error continue
 open c_cts61m00_017 using g_documento.atdsrvnum,
                           g_documento.atdsrvano
 fetch c_cts61m00_017 into ms.atdsrvseq
whenever error stop
close c_cts61m00_017


whenever error continue
 open c_cts61m00_018 using g_documento.atdsrvnum,
                           g_documento.atdsrvano,
                           ms.atdsrvseq
 fetch c_cts61m00_018 into ms.atdetpcod
whenever error stop
close c_cts61m00_018

 let m_c24lclpdrcod = a_cts61m00[1].c24lclpdrcod

 let m_subbairro[1].lclbrrnom = a_cts61m00[1].lclbrrnom

 call cts06g10_monta_brr_subbrr(a_cts61m00[1].brrnom,
                                a_cts61m00[1].lclbrrnom)
      returning a_cts61m00[1].lclbrrnom

end function

#--------------------------------------------------------------------
 function modifica_cts61m00()
#--------------------------------------------------------------------
 ...
 initialize  lr_retorno.*  to  null
 initialize  ws.*  to  null
 initialize  hist_cts61m00.*  to  null
 initialize ws.*  to null

 call input_cts61m00() returning hist_cts61m00.*
 ...
 if a_cts61m00[1].lclltt is null or
    a_cts61m00[1].lclltt = 0 or
    a_cts61m00[1].lcllgt is null or
    a_cts61m00[1].lcllgt = 0 then
    let m_atdfnlflg = "N"
 end if

 #display 'cts61m00 - Modificar atendimento'

 whenever error continue

 begin work

 if m_imdsrvflg_ant <> d_cts61m00.imdsrvflg and
    g_documento.acao = "ALT" then

    call cts40g03_data_hora_banco(2) returning m_data, m_hora

    let w_cts61m00.atdlibdat = m_data
    let w_cts61m00.atdlibhor = m_hora
 ...
 whenever error continue
 execute p_cts61m00_019 using  d_cts61m00.nom,
                               d_cts61m00.cornom,
                               d_cts61m00.corsus,
                               d_cts61m00.atddfttxt,
                               d_cts61m00.atdlibflg,
 ...
 whenever error continue
 execute p_cts61m00_020 using d_cts61m00.lclrsccod
                              ,d_cts61m00.orrdat
                              ,d_cts61m00.socntzcod
                              ,d_cts61m00.espcod
                              ,d_cts61m00.srvretmtvcod
 ...
 # prepare
 whenever error continue
 execute p_cts61m00_021 using g_documento.atdsrvnum,
                              g_documento.atdsrvano
 whenever error stop


 if d_cts61m00.srvretmtvcod is not null  and
    d_cts61m00.srvretmtvcod  =  999      then

     whenever error continue
     execute p_cts61m00_022 using g_documento.atdsrvnum
                                 ,g_documento.atdsrvano
                                 ,d_cts61m00.srvretmtvdes
                                 ,m_data
                                 ,g_issk.empcod
                                 ,g_issk.funmat
                                 ,g_issk.usrtip
 ...
 if a_cts61m00[1].operacao is null  then
    let a_cts61m00[1].operacao = "M"
 end if

 let a_cts61m00[1].lclbrrnom = m_subbairro[1].lclbrrnom

 call cts06g07_local(a_cts61m00[1].operacao,
                     g_documento.atdsrvnum,
                     g_documento.atdsrvano,
                     1,
                     a_cts61m00[1].lclidttxt,
                     a_cts61m00[1].lgdtip,
                     a_cts61m00[1].lgdnom,
                     a_cts61m00[1].lgdnum,
                     a_cts61m00[1].lclbrrnom,
                     ...
                     a_cts61m00[1].lclcttnom,
                     a_cts61m00[1].c24lclpdrcod,
                     a_cts61m00[1].ofnnumdig,
                     a_cts61m00[1].emeviacod,
                     a_cts61m00[1].celteldddcod,
                     a_cts61m00[1].celtelnum,
                     a_cts61m00[1].endcmp)
 ...
 if w_cts61m00.atdlibflg <> d_cts61m00.atdlibflg  then
    if d_cts61m00.atdlibflg = "S"  then
       let w_cts61m00.atdetpcod = 1
    else
       let w_cts61m00.atdetpcod = 2
    end if

    call cts10g04_insere_etapa (g_documento.atdsrvnum,
                                g_documento.atdsrvano,
                                w_cts61m00.atdetpcod ,
                                ""                   ,
                                ""                   ,
                                ""                   ,
                                ""                   )
 ...
 whenever error stop
    ...
    if (g_documento.acao = "RET" and d_cts61m00.retprsmsmflg = 'N') or
       ...
       call cts61m00_alt_end(m_obter_mult
                            ,m_servico_original
                            ,m_ano_original)
             returning m_resultado
                      ,m_mensagem
...
end function  ###  modifica_cts61m00


#-------------------------------------------------------------------------------
 function inclui_cts61m00()
#-------------------------------------------------------------------------------
 ...
 #display 'cts61m00 - Incluir atendimento'
 ...
 while true
   ...
   if  w_cts61m00.atddat is null  then
   ...
   if  w_cts61m00.funmat is null  then
       let w_cts61m00.funmat    = g_issk.funmat
   end if
   ...
   let ms.* = ws.*
   let mr_hist.* = hist_cts61m00.*

   if  w_cts61m00.atdfnlflg is null  then
       let w_cts61m00.atdfnlflg = "N"
       let w_cts61m00.c24opemat = g_issk.funmat
   end if

   call cts61m00_grava_dados(d_cts61m00.socntzcod,
                             d_cts61m00.espcod,
                             d_cts61m00.c24pbmcod,
                             d_cts61m00.atddfttxt, '', '',
                             l_confirma)
   ...
   if l_resultado <> 1 then
      ...
      for l_for = 1 to 10
          ...
          call cts61m00_grava_dados(am_param[l_for].socntzcod,
         ...
         if m_operacao = 1  # obteve chave de regulacao
            ...
            if l_resultado = 1  # sucesso na gravacao do servico
               ...
               if l_reserva_ativa = true
                  ...
                  call cts02m08(w_cts61m00.atdfnlflg,
                                d_cts61m00.imdsrvflg,
                                m_altcidufd,
                                d_cts61m00.prslocflg,
                                w_cts61m00.atdhorpvt,
                                w_cts61m00.atddatprg,
                                ...
                                g_documento.atdsrvorg,
                                d_cts61m00.asitipcod,
                                d_cts61m00.socntzcod, # natureza
                                d_cts61m00.espcod)    # sub-natureza
                      returning w_cts61m00.atdhorpvt,
                                w_cts61m00.atddatprg,
                                w_cts61m00.atdhorprg,
                                w_cts61m00.atdpvtretflg,
                                d_cts61m00.imdsrvflg,
                  ...
                  display by name d_cts61m00.imdsrvflg
               ...
               if l_errcod = 0
                  ...
                  display 'cts61m00 nao gravou cota no IFX, baixa de cota nao realizada na inclusao: ', l_errcod
               end if
      ...
      let w_cts61m00.atdsrvnum = ws.atdsrvnum
      let w_cts61m00.atdsrvano = ws.atdsrvano

      let d_cts61m00.srvnum = g_documento.atdsrvorg using "&&",
                              "/", w_cts61m00.atdsrvnum using "&&&&&&&",
                              "-", w_cts61m00.atdsrvano using "&&"

      display by name d_cts61m00.srvnum  attribute (reverse)
      ...
      #   call  ctb85g02_envia_msg(2,               # Tipo de Envio de SMS
      #                            w_cts61m00.atdsrvnum,
      #                            w_cts61m00.atdsrvano  )
      ...
      call cts10g02_atualiza_flg_email(w_cts61m00.atdsrvnum,
                                       w_cts61m00.atdsrvano,
                                       l_confirma)
           returning l_resultado
                    ,l_mensagem
...
end function  ###  inclui_cts61m00

#--------------------------------------------------------------------
function input_cts61m00()
#--------------------------------------------------------------------
 ...
 initialize  ws.*  to  null
 initialize  dS_cts61m00.*  to  null
 initialize  wS_cts61m00.*  to  null
 initialize  aS_cts61m00.*  to  null
 initialize  hist_cts61m00.*  to  null
 ...
 let ws.lclcttnom            = a_cts61m00[1].lclcttnom
 let ws.lclrscflg            = d_cts61m00.lclrscflg
 let d_cts61m00.atdprinvlcod = 2  # SEMPRE 2-NORMAL
 let d_cts61m00.atdprinvldes = "NAO EXISTE"
 let m_veiculo_aciona        = null
...
whenever error stop
 ...
 let d_cts61m00.asitipcod = 6

 open c_cts61m00_023 using d_cts61m00.asitipcod
 whenever error continue
 fetch c_cts61m00_023 into d_cts61m00.asitipabvdes
 whenever error stop

 if sqlca.sqlcode <> 0 then
    if sqlca.sqlcode <> 100 then
       error 'Erro de SQL c_cts61m00_103 ',sqlca.sqlcode,'/'
       return hist_cts61m00.*
    else
       let d_cts61m00.asitipabvdes = null
    end if
 end if
 ...
 let m_imdsrvflg = d_cts61m00.imdsrvflg
 let m_cidnom = a_cts61m00[1].cidnom
 let m_ufdcod = a_cts61m00[1].ufdcod
 # PSI-2013-00440PR


 #display 'entrada do input, var null ou carregada na consulta'
 #display 'd_cts61m00.imdsrvflg :', d_cts61m00.imdsrvflg
 #display 'a_cts61m00[1].cidnom :', a_cts61m00[1].cidnom
 #display 'a_cts61m00[1].ufdcod :', a_cts61m00[1].ufdcod
 ...
 display by name d_cts61m00.atdprinvlcod
 display by name d_cts61m00.atdprinvldes
 display by name d_cts61m00.asitipcod

 input by name d_cts61m00.nom      ,
               d_cts61m00.corsus   ,
               d_cts61m00.cornom   ,
               d_cts61m00.lclrsccod,
               d_cts61m00.lclrscflg,
               ws.lclcttnom        ,
               d_cts61m00.orrdat   ,
               d_cts61m00.socntzcod,
               d_cts61m00.espcod,
               ...
               d_cts61m00.prslocflg,
               #d_cts61m00.frmflg,
               d_cts61m00.imdsrvflg   without defaults
   ...
   before field nom
          ...
          display by name d_cts61m00.nom        attribute (reverse)

   after  field nom
          display by name d_cts61m00.nom

          if d_cts61m00.nom is null  or
             d_cts61m00.nom =  "  "  then
             error " Nome deve ser informado!"
             next field nom
          end if

          if w_cts61m00.atdfnlflg = "S"      or
             ...
             # INICIO PSI-2013-00440PR
	          if m_agendaw = false   # regulacao antiga
                then
                call cts02m03(w_cts61m00.atdfnlflg, d_cts61m00.imdsrvflg,
                              w_cts61m00.atdhorpvt, w_cts61m00.atddatprg,
                              w_cts61m00.atdhorprg, w_cts61m00.atdpvtretflg)
                    returning w_cts61m00.atdhorpvt, w_cts61m00.atddatprg,
                              w_cts61m00.atdhorprg, w_cts61m00.atdpvtretflg
	          else
                call cts02m08(w_cts61m00.atdfnlflg,
                              d_cts61m00.imdsrvflg,
          ...
          if cpl_atdsrvnum is null then
             ...
             if g_documento.atdsrvnum is null  and
                ...
                if g_documento.succod    is not null  and
                   ...
                   #open c_cts61m00_024 using g_documento.ramcod,
                   #                        g_documento.succod,
                   #                        g_documento.aplnumdig,
                   #                        g_documento.itmnumdig
                   #whenever error continue
                   #fetch c_cts61m00_024 into l_atdsrvnum, l_atdsrvano
                   #whenever error stop
                   #if sqlca.sqlcode <> 0 then
                   #  if sqlca.sqlcode = 100 then
                   ...
                   if l_atdsrvnum is not null then
                      ...
                      open c_cts61m00_025 using l_atdsrvnum,
                                                l_atdsrvano
                      whenever error continue
                      fetch c_cts61m00_025 into a_cts61m00[1].lgdtip,
                                              a_cts61m00[1].lgdnom,
                                              a_cts61m00[1].lgdnum,
                                              a_cts61m00[1].brrnom,
                                              a_cts61m00[1].lclbrrnom,
                      ...
                      if a_cts61m00[1].endcmp is null or
                         a_cts61m00[1].endcmp = " " then
                         call cts06g03_busca_complemento_apolice()
                              returning a_cts61m00[1].endcmp
                      end if
                   else
                      ...
                      whenever error continue
                      open c_cts61m00_026 using g_documento.succod
                                               ,g_documento.aplnumdig
                                               ,g_documento.itmnumdig
                                               ,g_funapol.dctnumseq
                      fetch c_cts61m00_026 into ws.segnumdig
                      ...
                      if sqlca.sqlcode = 0   then
                         ...
                         open c_cts61m00_027 using ws.segnumdig
                         fetch c_cts61m00_027 into ws_cgccpfnum, ws_cgccpfdig

                         whenever error stop

                         whenever error continue

                         open c_cts61m00_028 using ws.segnumdig
                         fetch c_cts61m00_028 into a_cts61m00[1].lgdtip
                                                  ,a_cts61m00[1].lgdnom
                                                  ,a_cts61m00[1].lgdnum
                                                  ,a_cts61m00[1].endcmp
                                                  ,a_cts61m00[1].lclbrrnom
                ...
                let l_lgdtxt    = a_cts61m00[1].lgdtxt
                let l_lclbrrnom = a_cts61m00[1].lclbrrnom
                let l_cidnom    = a_cts61m00[1].cidnom
                let l_ufdcod    = a_cts61m00[1].ufdcod
             end if
          end if
          display by name d_cts61m00.corsus     attribute (reverse)

   after  field corsus
          display by name d_cts61m00.corsus

          if fgl_lastkey() <> fgl_keyval("up")   and
             fgl_lastkey() <> fgl_keyval("left") then

             if d_cts61m00.corsus is not null  then
                whenever error continue

                open c_cts61m00_029 using d_cts61m00.corsus
                fetch c_cts61m00_029 into d_cts61m00.cornom
                ...
                if sqlca.sqlcode = notfound  then
                   ...
                   display by name d_cts61m00.cornom
   ...
   before field cornom
          display by name d_cts61m00.cornom     attribute (reverse)
   ...
   before field lclrsccod
          ...
          if g_documento.succod    is null  or
             ...
             if g_documento.acao   = "INC" then
                let d_cts61m00.lclrscflg = "S"
             else
             	  let d_cts61m00.lclrscflg = "N"
             end if

             display by name d_cts61m00.lclrscflg
             next field lclrscflg

          else
             display by name d_cts61m00.lclrsccod  attribute (reverse)
          end if

   after  field lclrsccod
          display by name d_cts61m00.lclrsccod
          ...
          if fgl_lastkey() = fgl_keyval("up")   or
             ...
             if d_cts61m00.lclrsccod is null  then

                let d_cts61m00.lclrsccod = mr_rsc_re.lclrsccod
                ...
                if d_cts61m00.lclrsccod <> mr_rsc_re.lclrsccod then
                ...
                if g_documento.atdsrvnum is null  and
                   g_documento.atdsrvano is null  then
                      ...
                      open c_cts61m00_030 using g_documento.ramcod
                                             ,g_documento.succod
                                             ,g_documento.aplnumdig
                                             ,g_documento.itmnumdig
                      ...
                      whenever error continue
                      fetch c_cts61m00_030 into l_atdsrvnum, l_atdsrvano
                      whenever error stop
                      close c_cts61m00_030
                      ...
                      let a_cts61m00[1].lgdtxt =
                          a_cts61m00[1].lgdtip clipped, " ",
                          a_cts61m00[1].lgdnom clipped, " ",
                          a_cts61m00[1].lgdnum using "<<<<#"
               end if
             end if
   ...
   before field lclrscflg
          if g_documento.atdsrvnum is null      and
             g_documento.atdsrvano is null      and
             d_cts61m00.lclrsccod  is not null  then
             let d_cts61m00.lclrscflg = "S"
          end if

          display by name d_cts61m00.lclrscflg  attribute (reverse)
   ...
   after  field lclrscflg
          ...
          if fgl_lastkey() <> fgl_keyval("up")   and
             fgl_lastkey() <> fgl_keyval("left") then
             if d_cts61m00.lclrscflg is null  then
                error " Atendimento no local de risco deve ser informado!"
                next field lclrscflg
             else
                if d_cts61m00.lclrscflg <> "S"  and
                   d_cts61m00.lclrscflg <> "N"  then
                  error "Atendimento no local de risco deve ser (S)im ou (N)ao!"
                   next field lclrscflg
                end if
             end if

             if d_cts61m00.lclrscflg = "S"  then
             ...
             let l_lgdcep = a_cts61m00[1].lgdcep
             let l_lgdcepcmp = a_cts61m00[1].lgdcepcmp
             ...
             if m_acesso_ind = false then
                 call cts06g03(1,
                               ...
                               a_cts61m00[1].celtelnum,
                               a_cts61m00[1].endcmp,
                               hist_cts61m00.*, a_cts61m00[1].emeviacod)
                     returning a_cts61m00[1].lclidttxt,
                               a_cts61m00[1].cidnom,
                               a_cts61m00[1].ufdcod,
                               a_cts61m00[1].brrnom,
             ...
             if l_lgdcep <> a_cts61m00[1].lgdcep or
                l_lgdcepcmp <> a_cts61m00[1].lgdcepcmp then
                ...
                if l_resultado = "N" then
                   let a_cts61m00[1].lgdtxt    = l_lgdtxt
                   let a_cts61m00[1].lclbrrnom = l_lclbrrnom
                   let a_cts61m00[1].cidnom    = l_cidnom
                   let a_cts61m00[1].ufdcod    = l_ufdcod
                end if
             end if

             display by name a_cts61m00[1].lgdtxt
             display by name a_cts61m00[1].lclbrrnom
             display by name a_cts61m00[1].endzon
             display by name a_cts61m00[1].cidnom
             display by name a_cts61m00[1].ufdcod
             display by name a_cts61m00[1].lclrefptotxt
             display by name a_cts61m00[1].lclcttnom
             display by name a_cts61m00[1].dddcod
             display by name a_cts61m00[1].lcltelnum
             display by name a_cts61m00[1].celteldddcod
             display by name a_cts61m00[1].celtelnum
             display by name a_cts61m00[1].endcmp
   ...
   after  field lclcttnom
          ...
          let a_cts61m00[1].lclcttnom = ws.lclcttnom

   before field orrdat
   	      let d_cts61m00.orrdat = today
   	      next field socntzcod


   before field socntzcod
          display by name d_cts61m00.socntzcod attribute (reverse)
          let l_natureza = d_cts61m00.socntzcod



   after  field socntzcod
          display by name d_cts61m00.socntzcod
          ...
          if d_cts61m00.socntzcod is null  or
             d_cts61m00.socntzcod <> l_natureza then

             if d_cts61m00.socntzcod <> l_natureza then
             ...
             let l_null = null
               ...
               if l_cortesia = false and
                  ...
                  if cts12g08_valida_data_vigencia(g_doc_itau[1].itaasiplncod   ,
                       ...
                       returning d_cts61m00.socntzcod
                  else
                  ...
                  call cts17m06_popup_natureza
                       (g_documento.aplnumdig, g_documento.c24astcod,
                        ...
                        g_documento.crtsaunum)
                        returning d_cts61m00.socntzcod, l_clscod
               end if



             if d_cts61m00.socntzcod is null then
                 next field  socntzcod
              end if
          end if

          if d_cts61m00.socntzcod is not null then
             if g_documento.aplnumdig is not null then
                 if cts12g08_valida_data_vigencia(g_doc_itau[1].itaasiplncod   ,
                 	                                g_doc_itau[1].itaclisgmcod   ,
                                                  g_doc_itau[1].itaaplvigincdat) then
                       call cts12g11_verifica_natureza(g_doc_itau[1].itaasiplncod,
                                                       d_cts61m00.socntzcod      ,
                                                       g_doc_itau[1].itaclisgmcod,
                                                       g_doc_itau[1].itaaplvigincdat)
                       returning l_existe,l_mens
                 else
                      call cts12g04_verifica_natureza(g_doc_itau[1].itaasiplncod,
                                                      d_cts61m00.socntzcod)
                      returning l_existe,l_mens
                 end if
           ...
           call ctc16m03_inf_natureza(d_cts61m00.socntzcod,'A')
                returning l_status, l_mensagem, d_cts61m00.socntzdes, l_codigo


          if l_status <> 1 then
             initialize d_cts61m00.socntzcod to null
             error "Codigo de natureza invalido!"
             next field socntzcod
          else
             display by name d_cts61m00.socntzcod
             display by name d_cts61m00.socntzdes
          end if

          if cts17m06_assunto_natureza(g_documento.c24astcod,
                                       d_cts61m00.socntzcod) = 1 then
             next field socntzcod
          end if
    ...
    before field espcod
          ...
          if ws.confirma <> 0 then
             ...
             let d_cts61m00.espcod = 1
             display by name d_cts61m00.espcod attribute (reverse)
          else
             next field c24pbmcod
          end if

    after field espcod
          display by name d_cts61m00.espcod
          ...
          if d_cts61m00.espcod is null then
             ...
             call cts31g00_descricao_esp(d_cts61m00.espcod, "A")
                  returning d_cts61m00.espdes
    ...
    before field c24pbmcod
        display by name d_cts61m00.c24pbmcod attribute (reverse)

    after  field c24pbmcod
        display by name d_cts61m00.c24pbmcod

        if fgl_lastkey() = fgl_keyval("up")   or
           fgl_lastkey() = fgl_keyval("left") then

           let d_cts61m00.c24pbmcod = null
           let d_cts61m00.atddfttxt = null

           display by name d_cts61m00.c24pbmcod
           display by name d_cts61m00.atddfttxt
        ...
        display by name d_cts61m00.atddfttxt
         ...
         if g_documento.acao = 'INC' and d_cts61m00.c24pbmcod <> 999
   ...
   before field atddfttxt
          display by name d_cts61m00.atddfttxt attribute (reverse)
          if d_cts61m00.c24pbmcod <> 999 then
             next field srvretmtvcod
          end if
   ...
   after  field atddfttxt
          ...
          if fgl_lastkey() <> fgl_keyval("up")   and
             ...
             if d_cts61m00.atddfttxt  is null   then
    ...
    before field srvretmtvcod
        ...
        display by name d_cts61m00.srvretmtvcod attribute (reverse)

    after  field srvretmtvcod
        display by name d_cts61m00.srvretmtvcod
        ...
        if d_cts61m00.srvretmtvcod  is null  or
           d_cts61m00.srvretmtvcod  =  0     then
           call ctb24m01() returning d_cts61m00.srvretmtvcod
           next field srvretmtvcod
        else
           if d_cts61m00.srvretmtvcod <> 999 then
              ...
              display by name d_cts61m00.srvretmtvdes

              # Verifica prazo para abertura de servico de retorno
              call cts17m01_valida_prazo_retorno(cpl_atdsrvnum, cpl_atdsrvano, d_cts61m00.srvretmtvcod)
   ...
   before field srvretmtvdes
          ...
          display by name d_cts61m00.srvretmtvdes attribute (reverse)
   ...
   after  field srvretmtvdes
          ...
          if fgl_lastkey() <> fgl_keyval("up")   and
             ...
             if d_cts61m00.srvretmtvdes  is null   then
   ...
   before field retprsmsmflg
        ...
        display by name d_cts61m00.retprsmsmflg attribute (reverse)

    after  field retprsmsmflg
        display by name d_cts61m00.retprsmsmflg
        ...
        if  d_cts61m00.retprsmsmflg <> 'S' and
            d_cts61m00.retprsmsmflg <> 'N' then
   ...
   before field atdlibflg
          ...
          if d_cts61m00.atdlibflg is null then

             let d_cts61m00.atdlibflg = "S"
             display by name d_cts61m00.atdlibflg
          ...
          display by name d_cts61m00.atdlibflg attribute (reverse)

          if g_documento.atdsrvnum is not null  and
             w_cts61m00.atdfnlflg  =  "S"       then
   ...
   after  field atdlibflg
          ...
          if fgl_lastkey() <> fgl_keyval("up")   and
             ...
             if d_cts61m00.atdlibflg <> "S"  and
                d_cts61m00.atdlibflg <> "N"  then
                error " Envio liberado deve ser (S)im ou (N)ao!"
                next field atdlibflg
             end if

             let ws.atdlibflg = d_cts61m00.atdlibflg
             display by name d_cts61m00.atdlibflg

             if w_cts61m00.atdlibflg is null  then
                if ws.atdlibflg = "S"  then
                   ...
                   let d_cts61m00.atdlibflg = "N"
                   display by name d_cts61m00.atdlibflg
                   initialize w_cts61m00.atdlibhor to null
                   initialize w_cts61m00.atdlibdat to null
                end if
             else
                ...
                if w_cts61m00.atdlibflg = "S"  then
                   if ws.atdlibflg = "S" then
                   ...
                   if w_cts61m00.atdlibflg = "N"   then
   ...
   before field prslocflg
          display by name d_cts61m00.prslocflg attribute (reverse)

   after  field prslocflg
          let l_obter_qrv = true
          display by name d_cts61m00.prslocflg
          ...
          if ((d_cts61m00.prslocflg  is null)  or
              (d_cts61m00.prslocflg  <> "S"    and
             d_cts61m00.prslocflg    <> "N"))  then
             error " Prestador no local: (S)im ou (N)ao!"
             next field prslocflg
          end if

          if d_cts61m00.prslocflg = "S"   then
             if w_cts61m00.atdprscod is null then
                call ctn24c01()
                  returning w_cts61m00.atdprscod,
                            w_cts61m00.srrcoddig,
                            ws.atdvclsgl ,
                            w_cts61m00.socvclcod
             ...
             let w_cts61m00.cnldat    = m_data
             let w_cts61m00.atdfnlhor = m_hora

             let w_cts61m00.c24opemat = g_issk.funmat
             let w_cts61m00.atdfnlflg = "S"
             let w_cts61m00.atdetpcod =  3
             let d_cts61m00.imdsrvflg = "S"
             display by name d_cts61m00.imdsrvflg
             let w_cts61m00.atdhorpvt = "00:00"
             exit input
          else
                initialize w_cts61m00.funmat   ,
                           w_cts61m00.cnldat   ,
                           w_cts61m00.atdfnlhor,
                           w_cts61m00.c24opemat,
                           w_cts61m00.atdfnlflg,
                           w_cts61m00.atdetpcod,
                           w_cts61m00.atdprscod,
                           w_cts61m00.c24nomctt  to null
   ...
   before field imdsrvflg
          ...
          whenever error continue
          open c_cts61m00_031 using d_cts61m00.socntzcod
          fetch c_cts61m00_031 into l_natagdflg
          whenever error stop
          close  c_cts61m00_031
          ...
          let m_imdsrvflg_ant = d_cts61m00.imdsrvflg
          call cts61m00_verifica_endereco() returning l_flag

          display by name d_cts61m00.imdsrvflg attribute (reverse)
          ...
          if (l_obter_qrv = true or d_cts61m00.imdsrvflg = "S")
                and d_cts61m00.atdlibflg  = "S"
                and d_cts61m00.servicorg  is null then

                call cts61m00_imdsrvflg(a_cts61m00[1].lclltt,
                                        a_cts61m00[1].lcllgt,
                                        g_documento.acao,
                                        g_documento.atdsrvorg,
                                        d_cts61m00.socntzcod,
                                        ...
                                        l_hora,
                                        a_cts61m00[1].c24lclpdrcod)
                     returning d_cts61m00.imdsrvflg,
                               m_veiculo_aciona,
                               l_cotadisponivel,
                               w_cts61m00.atddatprg,
                               w_cts61m00.atdhorprg,
             ...
             let l_imdsrvflg = d_cts61m00.imdsrvflg
          else
             let w_cts61m00.atddatprg = l_data
             let w_cts61m00.atdhorprg = l_hora
          end if
    ...
    after field imdsrvflg
          ...
          # PSI-2013-00440PR
          if (m_imdsrvflg is null) or (m_imdsrvflg != d_cts61m00.imdsrvflg)
             then
             let m_rsrchv = null
             let m_operacao = 0  # regular novamente, cota agendada e imediata sempre distintas
          end if

          if (m_cidnom != a_cts61m00[1].cidnom) or
             (m_ufdcod != a_cts61m00[1].ufdcod) then
             let m_altcidufd = true
             let m_operacao = 0  # regular novamente
             #display 'cts61m00 - Elegivel para regulacao, alterou cidade/uf'
          else
          ...
          if d_cts61m00.imdsrvflg <> "S"    and
             d_cts61m00.imdsrvflg <> "N"    then
          ...
          if ml_srvabrprsinfflg = "S" then
             ...
             let w_cts61m00.atdprscod = l_pstcoddig

          end if

          if m_veiculo_aciona is null and
             l_imdsrvflg = "N" and
             d_cts61m00.imdsrvflg = "S" and  m_alt_end = "N"  and
          ...
          if w_cts61m00.atddatprg is not null and
             w_cts61m00.atdhorprg is not null and
             l_imdsrvflg = "N" and
             d_cts61m00.imdsrvflg = "S" then
             let d_cts61m00.imdsrvflg = "N"
          end if

          if l_cotadisponivel = true and d_cts61m00.imdsrvflg = "S" then
             let w_cts61m00.atddatprg = null
             let w_cts61m00.atdhorprg = null
          end if
          ...
          if m_agendaw = true
             ...
             while true
                ...
                call cts02m03(w_cts61m00.atdfnlflg, d_cts61m00.imdsrvflg,
                              w_cts61m00.atdhorpvt, w_cts61m00.atddatprg,
                              w_cts61m00.atdhorprg, w_cts61m00.atdpvtretflg)
                    returning w_cts61m00.atdhorpvt, l_data,
                              l_hora, w_cts61m00.atdpvtretflg

                if d_cts61m00.imdsrvflg = "S"  then
                    if w_cts61m00.atdhorpvt is null        then
                ...
                if w_cts61m00.atddatprg is null or
                   l_data <> w_cts61m00.atddatprg or
                   l_hora <> w_cts61m00.atdhorprg then
                   ...
                   ###if w_cts61m00.atddatprg  = aux_today and
                   if l_data  = aux_today and
                     (w_horaprg - w_horaatu) < 3 and
                      ...
                      if cpl_atdsrvnum        is not null and
                         ...
                         d_cts61m00.retprsmsmflg = 'S'    then
                          error "Para servico programado o horario deve ser maior que 3 hrs da hora atual"
                      else
                          let w_cts61m00.atdhorprg = null
                          call ctc59m03 ( a_cts61m00[1].cidnom,
                                          a_cts61m00[1].ufdcod,
                                          g_documento.atdsrvorg,
                                          d_cts61m00.socntzcod,
                                          aux_today,
                                          aux_hora)
                               returning  w_cts61m00.atddatprg,
                                          w_cts61m00.atdhorprg
                      end if
                      continue while
                   else
                      ...
                      if cpl_atdsrvnum        is not null and
                         cpl_atdsrvano        is not null and
                         d_cts61m00.servicorg is not null and
                         d_cts61m00.retprsmsmflg = 'S'    then
                          ...
                          if l_data is not null and
                             l_hora is not null then
                              ...
                              call cts61m00_verifica_retorno(g_documento.atdsrvnum
                                                            ,g_documento.atdsrvano
                                                            ,cpl_atdsrvnum
                                                            ,cpl_atdsrvano
                                                            ,l_data
                          ...
                          call ctc59m03_quota_imediato
                               (l_mpacidcod, g_documento.atdsrvorg,
                                d_cts61m00.socntzcod, l_data, l_hora)
          ...
          if (w_cts61m00.atddatprg is not null or w_cts61m00.atddatprg = " ") and
             (w_cts61m00.atdhorprg is not null or w_cts61m00.atdhorprg = " ") then
               if w_cts61m00.atddatprg < l_data_2   then
                  let w_cts61m00.atddatprg = null
                  let w_cts61m00.atdhorprg = null

                  next field atdlibflg
               else
                   if w_cts61m00.atddatprg = l_data_2 and
                      w_cts61m00.atdhorprg < l_hora_2  then
                      let w_cts61m00.atddatprg = null
                      let w_cts61m00.atdhorprg = null
          ...
          if m_agendaw = false
             then
             call cts61m00_cotas( m_veiculo_aciona,
                                  l_cotadisponivel,
                                  d_cts61m00.imdsrvflg,
                                  w_cts61m00.atddatprg,
                                  w_cts61m00.atdhorprg,
          ...
          if m_confirma_alt_prog = 'S' then
             ...
             call cts61m00_alt_prog(g_documento.atdsrvnum
                                    ,g_documento.atdsrvano
                                    ,m_obter_mult
                                    ,w_cts61m00.atddatprg
                                    ,w_cts61m00.atdhorprg
   ...
   on key (F1)
      if w_cts61m00.lignum is not null then

         #-- Acessa a tabela datmligacao --#

         whenever error continue
         open c_cts61m00_032 using w_cts61m00.lignum
         fetch c_cts61m00_032 into g_documento.c24astcod
         whenever error stop
   ...
   on key (F2)
      ...
      if erros_chk = "N"  then
         ...
         if ws_acao is not null and
            ...
            # Servico (RET)orno
            whenever error continue
            open c_cts61m00_033 using g_documento.atdsrvnum,
                                      g_documento.atdsrvano
            fetch c_cts61m00_033 into ws.refatdsrvnum, ws.refatdsrvano
            whenever error stop
            close c_cts61m00_033
            ...
            let dS_cts61m00.*    = d_cts61m00.*
            let wS_cts61m00.*    = w_cts61m00.*
            let aS_cts61m00.*    = a_cts61m00[1].*
            ...
            call cts04g00('cts61m00') returning ws.retflg
            ...
            let ws_acao               = "RET"
            let ws_tela               = "RET"
            let d_cts61m00.*          = dS_cts61m00.*
            let w_cts61m00.*          = wS_cts61m00.*
            let a_cts61m00[1].*       = aS_cts61m00.*
   ...
   on key (f4)
      ...
      if m_obter_mult = 1 then
         ...
         display by name d_cts61m00.lclrscflg
         display by name ws.lclcttnom
         #display by name d_cts61m00.orrdat
         display by name d_cts61m00.socntzcod
         display by name d_cts61m00.espcod
         display by name d_cts61m00.espdes
         display by name d_cts61m00.c24pbmcod
   ...
   on key (F6)
      ...
      if g_documento.atdsrvnum is null  and
         g_documento.atdsrvano is null  then
         call cts10m02(hist_cts61m00.*) returning hist_cts61m00.*
      else
         call cts40g03_data_hora_banco(2) returning m_data, m_hora
         let aux_today = m_data
         let aux_hora = m_hora
   ...
   on key (F9)
      ...
      if g_documento.atdsrvnum is not null  and
         ...
         whenever error continue
         open c_cts61m00_034 using g_documento.atdsrvnum,
                                   g_documento.atdsrvano
         fetch c_cts61m00_034 into l_atdlibflg
         whenever error stop
         close c_cts61m00_034
...
end function  ###  input_cts61m00

#-------------------------------------------------------------------------------
 function cts61m00_copia()
#-------------------------------------------------------------------------------
 define ws            record
    endlgdtip         like rlaklocal.endlgdtip     ,
    endlgdnom         like rlaklocal.endlgdnom     ,
 ...
 #------------------------------------------------
  ...
  whenever error continue
  open c_cts61m00_035 using g_documento.atdsrvnum,
                            g_documento.atdsrvano
  fetch c_cts61m00_035 into d_cts61m00.atddfttxt,
                            d_cts61m00.asitipcod,
                            ws.nom_cp,
                            ws.corsus_cp,
                            ws.cornom_cp
  ...
  if d_cts61m00.nom is null then
     let d_cts61m00.nom  =  ws.nom_cp
  end if

  if d_cts61m00.corsus is null then
     let d_cts61m00.corsus  =  ws.corsus_cp
     let d_cts61m00.cornom  =  ws.cornom_cp
  end if
 ...
 #------------------------------------------------
  whenever error continue
  open c_cts61m00_036 using g_documento.atdsrvnum,
                            g_documento.atdsrvano


  foreach c_cts61m00_036 into ws.c24solnom_cp, ws.ligcvntip_cp
     exit foreach
  end foreach
  whenever error stop
  close c_cts61m00_036
 ...
 #------------------------------------------------
  ...
  whenever error continue
  open c_cts61m00_037 using cpl_atdsrvnum,
                            cpl_atdsrvano
  fetch c_cts61m00_037 into d_cts61m00.lclrsccod
                            ,ws.atdorgsrvnum
                            ,ws.atdorgsrvano
                            ,d_cts61m00.socntzcod
                            ,d_cts61m00.orrdat
  ...
  let cpl_atdsrvano = ws.atdorgsrvano
    ...
    whenever error continue
    open c_cts61m00_038 using ws.atdorgsrvnum,
                              ws.atdorgsrvano
    fetch c_cts61m00_038 into ws.atdsrvseq
    ...
    if sqlca.sqlcode = 0 then
       ...
       whenever error continue
       open c_cts61m00_039 using ws.atdorgsrvnum
                                ,ws.atdorgsrvano
                                ,ws.atdsrvseq
       fetch c_cts61m00_039 into ws.pstcoddig,ws.srrcoddig,ws.socvclcod
       ...
       if ws.socvclcod is not null then
          ...
          whenever error continue
          open c_cts61m00_040 using ws.socvclcod
          fetch c_cts61m00_040 into ws.atdvclsgl
          whenever error stop
          close c_cts61m00_040
    ...
    let w_cts61m00.atdprscod = ws.pstcoddig
    let w_cts61m00.srrcoddig = ws.srrcoddig
    let w_cts61m00.socvclcod = ws.socvclcod
 ...
 call cts06g10_monta_brr_subbrr(a_cts61m00[1].brrnom,
  ...
  whenever error continue
  open c_cts61m00_041 using g_documento.atdsrvano,
                            g_documento.atdsrvnum
  fetch c_cts61m00_041 into a_cts61m00[1].ofnnumdig
  whenever error stop
  ...
  whenever error continue
  open c_cts61m00_042 using g_documento.atdsrvnum,
                            g_documento.atdsrvano
  fetch c_cts61m00_042 into d_cts61m00.c24pbmcod
  whenever error stop
  ...
  whenever error continue
  open c_cts61m00_043 using d_cts61m00.socntzcod
  fetch c_cts61m00_043 into d_cts61m00.socntzdes
  whenever error stop
  ...
  if d_cts61m00.espcod is not null then
      ...
      let d_cts61m00.espdes = "*** NAO CADASTRADA ***"
  ...
  whenever error continue
  open c_cts61m00_044 using d_cts61m00.asitipcod
  fetch c_cts61m00_044 into d_cts61m00.asitipabvdes
  whenever error stop
...
end function  ###  cts61m00_copia

#=========================================================
 function cts61m00_grava_dados(lr_param,l_confirma)
#=========================================================
 ...
 if g_documento.lclocodesres = "S" then
    let w_cts61m00.atdrsdflg = "S"
 else
    let w_cts61m00.atdrsdflg = "N"
 end if
 ...
 # Busca numeracao ligacao / servico
   ...
   let w_cts61m00.atdsrvnum  = l_atdsrvnum
   let w_cts61m00.atdsrvano  = l_atdsrvano
   ...
   call cts10g02_grava_servico( w_cts61m00.atdsrvnum,
                                w_cts61m00.atdsrvano,
                                g_documento.soltip  ,     # atdsoltip
                                d_cts61m00.c24solnom,     # c24solnom
                                ""                  ,     # vclcorcod
                                w_cts61m00.funmat   ,
                                d_cts61m00.atdlibflg,
                                w_cts61m00.atdlibhor,
   ...
   if d_cts61m00.prslocflg = "S" then
      whenever error continue
      execute p_cts61m00_045 using d_cts61m00.prslocflg
                               , w_cts61m00.socvclcod
                               , w_cts61m00.srrcoddig
                               , w_cts61m00.atdsrvnum
                               , w_cts61m00.atdsrvano
 ...
 #---------------------------
    call ctx09g02_inclui(w_cts61m00.atdsrvnum,
                         w_cts61m00.atdsrvano,
                         1               , # Org. informacao 1-Segurado 2-Pst
                         lr_param.c24pbmcod,
                         lr_param.atddfttxt,
...
#------------------------------------------------------------------------------
 ...
 #---------------------------
   if a_cts61m00[1].operacao is null then
      let a_cts61m00[1].operacao = "I"
   end if

   let a_cts61m00[1].lclbrrnom = m_subbairro[1].lclbrrnom

   let ms.codigosql = cts06g07_local( a_cts61m00[1].operacao    ,
                                    w_cts61m00.atdsrvnum      ,
                                    w_cts61m00.atdsrvano      ,
                                    1                         ,
                                    a_cts61m00[1].lclidttxt   ,
 ...
 #-------------------------------
   open  c_cts61m00_046 using l_atdsrvnum, l_atdsrvano
   whenever error continue
   fetch c_cts61m00_046 into ms.atdsrvseq
   whenever error stop
   ...
   if w_cts61m00.atdetpcod is null then
      if d_cts61m00.atdlibflg = "S" then
         let w_cts61m00.atdetpcod = 1
         let ms.etpfunmat = w_cts61m00.funmat
         let ms.atdetpdat = w_cts61m00.atdlibdat
         let ms.atdetphor = w_cts61m00.atdlibhor
      else
         let w_cts61m00.atdetpcod = 2
         let ms.etpfunmat = w_cts61m00.funmat
         let ms.atdetpdat = w_cts61m00.atddat
         let ms.atdetphor = w_cts61m00.atdhor
      end if
   else

      call cts10g04_insere_etapa(w_cts61m00.atdsrvnum,
                                 w_cts61m00.atdsrvano,
                                 1,
                                 "",
                                 "",
      ...
      let ms.atdetpdat = w_cts61m00.cnldat
      let ms.atdetphor = w_cts61m00.atdfnlhor
      let ms.etpfunmat = w_cts61m00.c24opemat
  end if
  ...
  if d_cts61m00.prslocflg = "N" then
     let w_cts61m00.atdetpcod = null
  end if
 ...
 #-----------------
  ...
  whenever error continue
  execute p_cts61m00_047 using l_atdsrvnum             , l_atdsrvano,
                             d_cts61m00.lclrsccod    , d_cts61m00.orrdat,
                             lr_param.socntzcod      , cpl_atdsrvnum,
                             cpl_atdsrvano           , d_cts61m00.srvretmtvcod,
                             d_cts61m00.retprsmsmflg , lr_param.espcod,
  ...
  if d_cts61m00.srvretmtvcod is not null and
     ...
     execute p_cts61m00_048 using l_atdsrvnum, l_atdsrvano,
                                d_cts61m00.srvretmtvdes, m_data,
                                g_issk.empcod,
 ...
 #---------------------------------------
   if g_documento.succod is not null and
      ...
      whenever error continue
      execute p_cts61m00_049 using l_atdsrvnum, l_atdsrvano,
  ...
  if (ws_acao = "RET" and d_cts61m00.retprsmsmflg = 'N') or
     m_veiculo_aciona is not null then
 ...
 #---------------------------------------------------------------
    if g_documento.c24astcod = "I64" then

         let g_cc.anosrv = w_cts61m00.atdsrvano
         let g_cc.nrosrv = w_cts61m00.atdsrvnum

         whenever error continue
         execute p_cts61m00_050 using g_cc.anosrv,
                                      g_cc.nrosrv,
                                      g_cc.pgttipcodps,
                                      g_cc.pgtmat,
                                      g_cc.corsus,
 ...
 #---------------------------
  ...
  if lr_param.atdsrvnum is not null then
     ...
     execute p_cts61m00_051 using lr_param.atdsrvnum, lr_param.atdsrvano
  ...
  # Ponto de acesso apos a gravacao do laudo
  call cts00g07_apos_grvlaudo(w_cts61m00.atdsrvnum,
                              w_cts61m00.atdsrvano)
...
#-----------------------------------
function cts61m00_alt_prog(lr_input)
#-----------------------------------
   ...
   if lr_input.obter_mult = 1 then
      for l_i = 1 to 10
         if am_cts29g00[l_i].atdmltsrvnum is not null then
            whenever error continue
            execute p_cts61m00_052 using lr_input.atddatprg
                                      ,lr_input.atdhorprg
                                      ,lr_input.atdhorpvt
...
#-----------------------------------
function cts61m00_alt_end(lr_input)
#-----------------------------------
 define lr_input record
        obter_mult       smallint
       ,servico_original like datmservico.atdsrvnum
...
function cts61m00_imdsrvflg(lr_param)
...
function cts61m00_cotas(lr_param)
   ...
   ## Reservando a cota
   if l_reservar_cota = "S" then
      call cts61m00_reservar_cota(lr_param.veiculo_aciona,
...
function cts61m00_reservar_cota(lr_param)
   ...
   if lr_param.veiculo_aciona is not null and
      ...
      let l_rglflg = ctc59m02(a_cts61m00[1].cidnom
                             ,a_cts61m00[1].ufdcod
                             ,lr_param.atdsrvorg
                             ,lr_param.socntzcod
                             ,lr_param.data_cota
...
function cts61m00_verifica_endereco()
   ...
   if g_documento.acao = "ALT" or
      ...
      if (((mr_salva.c24lclpdrcod <> 3 and a_cts61m00[1].c24lclpdrcod = 3)  or
           (mr_salva.c24lclpdrcod <> 4 and a_cts61m00[1].c24lclpdrcod = 4)  or # PSI 252891
           (mr_salva.c24lclpdrcod <> 5 and a_cts61m00[1].c24lclpdrcod = 5)) or
         (mr_salva.lclltt = a_cts61m00[1].lclltt)) then

         let l_reservar = "N"
         let m_alt_end = "N"
      else

         if mr_salva.lclltt <> a_cts61m00[1].lclltt or
            mr_salva.brrnom <> a_cts61m00[1].brrnom or
            mr_salva.lgdnom <> a_cts61m00[1].lgdnom or
            mr_salva.lgdnum <> a_cts61m00[1].lgdnum then
            ## alterou endereco
            let m_alt_end = "S"
         end if
      end if
...
function cts61m00_abater_cota()
   ...
   if w_cts61m00.atdfnlflg = 'S' then
      call cts11g00(w_cts61m00.lignum)
      let int_flag = true
   end if
...
function cts61m00_verifica_data_hora()
   ...
   if mr_salva.imdsrvflg <> d_cts61m00.imdsrvflg  or
      mr_salva.atddatprg <> w_cts61m00.atddatprg  or
      mr_salva.atdhorprg <> w_cts61m00.atdhorprg  or
      (mr_salva.atddatprg is null and w_cts61m00.atddatprg is not null) then
...
function cts61m00_ac(l_atdsrvnum, l_atdsrvano)
  ...
  define msg_erro char(500)
   ...
   whenever error continue
   open c_cts61m00_053 using l_atdsrvnum, l_atdsrvano
   fetch c_cts61m00_053 into l_lclltt1, l_lcllgt1, l_c24lclpdrcod
   whenever error stop
   close c_cts61m00_053

   ##obter viatura acionado
   whenever error continue
   open c_cts61m00_054 using l_atdsrvnum, l_atdsrvano
   fetch c_cts61m00_054 into  l_pstcoddig, l_socvclcod, l_srrcoddig
   whenever error stop
   close c_cts61m00_054

   ##obter coordenada da viatura no servico
   whenever error continue
   open c_cts61m00_055 using l_atdsrvnum, l_atdsrvano
   fetch c_cts61m00_055 into  l_lclltt2, l_lcllgt2
   whenever error stop
   close c_cts61m00_055
...
#--------------------------------------------------------------
 function cts61m00_verifica_retorno(p_cts61m00)
#--------------------------------------------------------------
 define p_cts61m00   record
    atdsrvnum        like datmservico.atdsrvnum,
    atdsrvano        like datmservico.atdsrvano,
 ...
 if p_cts61m00.atdorgsrvnum is not null and
    p_cts61m00.atdorgsrvano is not null then

    # Busca o prestador do servico original
    whenever error continue
    open c_cts61m00_056 using p_cts61m00.atdorgsrvnum,
                              p_cts61m00.atdorgsrvano
    fetch c_cts61m00_056 into ws.atdprscod, ws.socvclcod, ws.srrcoddig
    whenever error stop

    # Foreach de atendimentos dentro do intervalo

    whenever error continue
    open c_cts61m00_057 using lr_agd_p.min_atddatprg,
                              lr_agd_p.min_atdhorprg,
                              lr_agd_p.max_atddatprg,
                              lr_agd_p.max_atdhorprg,
                              ws.atdprscod

    foreach c_cts61m00_057 into lr_ret.atdsrvnum
                          ,lr_ret.atdsrvano
                          ,lr_ret.socvclcod
                          ,lr_ret.srrcoddig
                          ,lr_ret.atddatprg
        ...
        if p_cts61m00.atdsrvnum = lr_ret.atdsrvnum and
           p_cts61m00.atdsrvano = lr_ret.atdsrvano then
            continue foreach
        end if

        whenever error continue
        open c_cts61m00_058 using lr_ret.atdsrvnum,
                                  lr_ret.atdsrvano,
                                  ws.socvclcod
        fetch c_cts61m00_058 into l_status
        whenever error stop
        close c_cts61m00_058

        if sqlca.sqlcode = 100 then
            whenever error continue
            open c_cts61m00_059 using lr_ret.atdsrvnum,
                                      lr_ret.atdsrvano
            fetch c_cts61m00_059 into lr_org.atdsrvnum, lr_org.atdsrvano
            whenever error stop
            close c_cts61m00_059

            if sqlca.sqlcode = 0 then
               whenever error continue
               open c_cts61m00_060 using lr_org.atdsrvnum,
                                         lr_org.atdsrvano,
                                         ws.socvclcod
               fetch c_cts61m00_060 into l_status
               whenever error stop
               close c_cts61m00_060
    ...
    whenever error stop
    close c_cts61m00_057

    if p_cts61m00.tipo = 1 and
       l_contador > 0 then
       ...
       while true
           let l_status = 0
           call cts61m00_verifica_retorno(p_cts61m00.atdsrvnum
                                         ,p_cts61m00.atdsrvano
                                         ,p_cts61m00.atdorgsrvnum
                                         ,p_cts61m00.atdorgsrvano
                                         ,lr_agd_p.min_atddatprg
                                         ,lr_agd_p.min_atdhorprg
                                         ,2)
...
end function  #  cts61m00_verifica_retorno

function cts61m00_assunto_cortesia()
  ...
  whenever error continue
  open c_cts61m00_065 using g_documento.c24astcod
  fetch c_cts61m00_065 into l_count
  whenever error stop
