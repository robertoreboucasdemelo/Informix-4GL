...
#-------------------------------
push @ARG,$usrtip,$webusrcod,$sesnum,$macsissgl,$inicio;

 #-----------------------------------------------------------------------------
 # Carregando parametros recebidos
 #-----------------------------------------------------------------------------
 $cabec  = 'POSIÇÃO DA FROTA';
 ...
 #-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; /webserver/cgi-bin/ct24h/trs/wdatc005.4gc $ARG 2>&1)";
...
open (PROG, "$prog |") || die ("N\343o foi poss\355vel executar $prog: $!\n");
 ...
 while (<PROG>)
   {
    ...
    elsif ($REGISTRO[0] eq "PRESTADOR")
          { $prestador = $REGISTRO[1]; }
 ...
 #-----------------------------------------------------------------------------
 $texto    = 'Clique no botão consultar para receber movimentos do veículo. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button name=btnImp value="Ver mapa" onclick="doVerMapa()">';
 ...
 start_form(-method=>'POST',
            -name=>'wdatc004',
            -action=>"/cgi-bin/ct24h/trs/wdatc008.pl"),"\n",
 ...
 #-----------------------------------------------------------------------------
 push @html, @cabecalho;
 push @html, "<script language='JavaScript'>",
                "function doVerMapa() {",
                    "location.href = 'https://wwws.portoseguro.com.br/psportal/frota/frota.aspx?webusrcod=$webusrcod&usrtip=$usrtip&sesnum=$sesnum&macsissgl=$macsissgl&portal=2';",
                "}",
            "</script>";
 ...
 center(
       ...
       #"<a href='http://nt59/psportal/frota/frota.aspx?webusrcod=$webusrcod&usrtip=$usrtip&sesnum=$sesnum&macsissgl=$macsissgl&portal=2'>mapa novo</a>",
       #"<a href='https://wwws.portoseguro.com.br/psportal/frota/frota.aspx?webusrcod=$webusrcod&usrtip=$usrtip&sesnum=$sesnum&macsissgl=$macsissgl&portal=2'>mapa novo</a>",
