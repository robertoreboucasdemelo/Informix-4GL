...
# ---------- -------------- ------------  ---------------------------------------#
# 15/04/2015 Marcos Goes                  Modificacao do mecanismo de loop da    #
#                                         carga diaria para considerar dias      #
#                                         anteriores perdidos.                   #
#                                         Retirada da leitura de arquivos texto. #
# ---------- -------------- ------------- ---------------------------------------#
# 28/10/2015 Roberto Fornax ST-2015-00075 Tarifa Auto Premium                    # 
#................................................................................#
...
define m_bdata004_prep   smallint
...
#========================================================================
   ...
   call bdata004_cria_log()

   call bdata004_exibe_inicio()
   ...
   display " PREPARANDO... "
   display "##################################"
   call bdata004_prepare()

   display "##################################"
   display " RECUPERANDO CAMINHOS... "
   display "##################################"
   call bdata004_obtem_caminhos()

   display "##################################"
   display " RECUPERANDO QUEBRA... "
   display "##################################"
   if not bdata004_recupera_quebra() then
      exit program
   end if  
   ...
   ### CARGA FULL ###
   ##################
   if bdata004_valida_carga() then
   
      if not bdata004_carga_full() then
         let m_mensagem = "Carga Full abortada. Verificar os dominios."
         call ERRORLOG(m_mensagem);
         display m_mensagem
      end if
      call bdata004_atualiza_full()      
   end if
   
   ####################
   ### CARGA DIARIA ###
   ####################
   if not bdata004_carga_diaria() then
      exit program
   end if
  
   call bdata004_exibe_final()

   call bdata004_dispara_email()
...
define l_sql char(10000)
   ...
   let l_sql = ' select count(*)           '
             ...
             , '  and   plnclscod <>  ?    '     
             , '  and   clsvigfimdat <= ?  '           
   prepare p_bdata004_001 from l_sql
   declare c_bdata004_001 cursor for p_bdata004_001
   
   
   let l_sql = ' select count(*)        '
            ,  '  from datksrvesp       '
            ,  '  where srvespnum   = ? '
   prepare p_bdata004_002 from l_sql
   declare c_bdata004_002 cursor for p_bdata004_002
   ...
   let l_sql = ' select plnclscod          '
             ...
             , '  and   plnclscod <>  ?    '     
             , '  and   clsvigfimdat <= ?  '           
   prepare p_bdata004_003 from l_sql
   declare c_bdata004_003 cursor for p_bdata004_003
   ...
   prepare p_bdata004_005 from l_sql
   declare c_bdata004_005 cursor with hold for p_bdata004_005
   ...
   let l_sql = ' select min(dctnumseq) '
              ...
              ,'   and aplnumdig = ?	  '
              ,'   and itmnumdig = ?	  '
   prepare p_bdata004_006 from l_sql
   declare c_bdata004_006 cursor with hold for p_bdata004_006
   ...
   prepare p_bdata004_007 from l_sql
   declare c_bdata004_007 cursor with hold for p_bdata004_007
   ...
   let l_sql =  '  select segnumdig,    '
               ...
               ,'  and   prporgidv =  ? '
               ,'  and   prpnumidv =  ? '
   prepare p_bdata004_008 from l_sql
   declare c_bdata004_008 cursor for p_bdata004_008
   ...
   prepare p_bdata004_009 from l_sql
   declare c_bdata004_009 cursor with hold for p_bdata004_009
   ...
   let l_sql =  ' select clscod       '
               ...
               ,'  and   prporgidv =  ? '
               ,'  and   prpnumidv =  ? '
   prepare p_bdata004_010 from l_sql
   declare c_bdata004_010 cursor with hold for p_bdata004_010
   ...
   let l_sql = ' select plnclscod,         '
             ...
             , '  and   clsvigfimdat >=  ? '
             , '  and   regsitflg = "A"    '
   prepare p_bdata004_011 from l_sql
   declare c_bdata004_011 cursor for p_bdata004_011
   ...
   let l_sql = ' select a.srvcod                 ,   '
              ...
              ,' and   a.plnclscod  = ?              '
   prepare p_bdata004_012 from l_sql
   declare c_bdata004_012 cursor with hold for p_bdata004_012
   
   let l_sql = ' select empnom     '
              ,' from gabkemp      '
              ,' where empcod = ? 	'
   prepare p_bdata004_013 from l_sql
   declare c_bdata004_013 cursor for p_bdata004_013
   
   let l_sql = ' select count(*)         '
              ,' from datkcbtcss         '
              ,' where srvclscod   =  ?  '
              ,' and   cbtcod      =  ?  '
   prepare p_bdata004_014 from l_sql
   declare c_bdata004_014 cursor for p_bdata004_014
   
   let l_sql = ' select count(*)        '
              ,' from datktrfctgcss     '
              ,' where srvclscod   =  ? '
              ,' and   trfctgcod   =  ? '
   prepare p_bdata004_015 from l_sql
   declare c_bdata004_015 cursor for p_bdata004_015
   
   let l_sql = ' select lclclartccod       '
              ,' from datklclclartc        '
              ,' where srvclscod    =  ?   '
              ,' and   lclclacod    =  ?   '
   prepare p_bdata004_016 from l_sql
   declare c_bdata004_016 cursor for p_bdata004_016
   ...
   let l_sql = ' select count(*)             '
              ...
              ,' and   b.cidnom   	  =  ?   '
              ,' and   b.ufdcod       =  ?   '
   prepare p_bdata004_017 from l_sql
   declare c_bdata004_017 cursor for p_bdata004_017
   ...
   let l_sql = ' select endcid ,      '
              ...
              ,' where segnumdig =  ? '
              ,' and   endfld    =  1 '
   prepare p_bdata004_018 from l_sql
   declare c_bdata004_018 cursor for p_bdata004_018
   
   let l_sql =  ' update datkplncls     '
             ,  ' set irdclsflg = "S"   '
             ,  ' where plnclscod = ?   '
   prepare p_bdata004_019 from l_sql
   
   let l_sql = ' select cpodes        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
              ,' and   cpocod =  ?    '
   prepare p_bdata004_020 from l_sql
   declare c_bdata004_020 cursor for p_bdata004_020
   
   let l_sql =  ' update datkdominio    '
              , ' set   cpodes =  ?     '
              , ' where cponom =  ?     '
              , ' and   cpocod =  ?     '
   prepare p_bdata004_021 from l_sql
   ...
   let l_sql = 'select nscdat,        ',
               ...
               ' from gsakseg         ',
               ' where segnumdig  = ? '
   prepare p_bdata004_022 from l_sql
   declare c_bdata004_022 cursor for p_bdata004_022
   ...
   let l_sql = ' select vcluso      '
              ...
              ,' where  prporgpcp =  ? '
      				 ...
      				 ,'  and   prporgidv =  ? '
       	  	 ,'  and   prpnumidv =  ? '
   prepare p_bdata004_023 from l_sql
   declare c_bdata004_023 cursor for p_bdata004_023
   ...
   let l_sql = 'select imsvlr        '
              ...
              ,' where succod    = ? '
      				 ...
      				 ,'   and itmnumdig = ? '
       	  	 ,'   and dctnumseq = ? '
   prepare p_bdata004_024 from l_sql
   declare c_bdata004_024 cursor for p_bdata004_024
   ...
   let l_sql = 'select rspdat           '
              ...
              ,' where  prporgpcp =  ? '
       	  	 ...
       	  	 ,'  and   prpnumidv =  ? '
       	  	 ,'   and qstcod    = 2    '
   prepare p_bdata004_025 from l_sql
   declare c_bdata004_025 cursor for p_bdata004_025
   ...
   let l_sql = 'select rspcod           '
              ...
              ,' where  prporgpcp =  ? '
       	  	 ...
       	  	 ,'  and   prpnumidv =  ? '
       	  	 ,'   and qstcod    = 120  '
   prepare p_bdata004_026 from l_sql
   declare c_bdata004_026 cursor for p_bdata004_026
   
   let l_sql = ' select cpodes        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
   prepare p_bdata004_027 from l_sql
   declare c_bdata004_027 cursor for p_bdata004_027
   
   let l_sql = ' select count(*)        '
               ,' from datkdominio     '
               ,' where cponom =  ?    '
   prepare p_bdata004_028 from l_sql
   declare c_bdata004_028 cursor for p_bdata004_028
   ...
   let l_sql = " insert into datmbnfcrgmov             "
              ...
              ," values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,? "
              ,"  ,?,?,?,?,?)                          "
   prepare p_bdata004_029 from l_sql
   ...
   let l_sql = ' insert into datmbnfcrgico             '
              ...
              ,'  ,?,?,?,?,?,?,?,?,?,?,?,?,?            '
              ,'  ,?,?,?,?,?,?,?  )                     '
   prepare p_bdata004_030 from l_sql
    ...
    let l_sql = ' select cpodes[8,12]     '  
              ...
              ,' and   cpodes[1,2] =  ?  '
              ,' and   cpodes[4,6] =  ?  '             
   prepare p_bdata004_031  from l_sql                
   declare c_bdata004_031  cursor for p_bdata004_031
   ...
   let l_sql = ' select count(*)          '
              ...
              ,' and   pcpprpdignum =  ?  '
              ,' and   incvigdat    =  ?  '              
   prepare p_bdata004_032 from l_sql
   declare c_bdata004_032 cursor for p_bdata004_032
   ...
   let l_sql = ' select count(*)         '
              ...
              ,' and   dctclscod    =  ? '
              ,' and   pcmflg in ("S","N") '                
   prepare p_bdata004_033 from l_sql
   declare c_bdata004_033 cursor for p_bdata004_033 
    ...
    let l_sql = ' select count(*)         '
              ...
              ,' and   dctclscod    =  ? '
              ,' and   pcmflg in ("R","E") '                
   prepare p_bdata004_034 from l_sql
   declare c_bdata004_034 cursor for p_bdata004_034 	 	
   
   
   let m_bdata004_prep = true
...
#========================================================================
   ...
   let l_path = m_path_log clipped, "bdata004.log"
...
#========================================================================
function bdata004_obtem_caminhos()
#========================================================================
...
#========================================================================
function bdata004_carrega_beneficio()
#========================================================================
...
let mr_inconsistencia.dtger     = today
    ...
    #--------------------------------------------------------
     ...
     open c_bdata004_013 using mr_processo2.empcod

     whenever error continue
     fetch c_bdata004_013 into mr_processo2.empnom
     whenever error stop
    ...
    open c_bdata004_005 using mr_data.inicio

    foreach c_bdata004_005 into mr_processo2.viginc
    	                        , mr_processo2.vigfnl
       ...
       let mr_total.apoli  = mr_total.apoli + 1
        ...
        #------------------------------------------------------  
        call bdata004_grava_apolice_processada()          
        ...
        open c_bdata004_008 using mr_processo2.prporgpcp ,
                                  mr_processo2.prpnumpcp ,
                                  mr_processo2.prporgidv ,
                                  mr_processo2.prpnumidv
        whenever error continue
        fetch c_bdata004_008 into mr_processo2.segnumdig ,
        ...
        open c_bdata004_018 using mr_processo2.segnumdig

        whenever error continue
        fetch c_bdata004_018 into mr_processo2.endcid ,
                                  mr_processo2.endufd
        whenever error stop
        ...
        open c_bdata004_009 using mr_processo2.prporgpcp ,
                                  mr_processo2.prpnumpcp ,
                                  mr_processo2.prporgidv ,
                                  mr_processo2.prpnumpcp
        whenever error continue
        fetch c_bdata004_009 into mr_processo2.cbtcod    ,
        ...
        open c_bdata004_022 using mr_processo2.segnumdig

        whenever error continue
        fetch c_bdata004_022 into mr_processo2.nscdat     ,
                                  mr_processo2.segsex     ,
                                  mr_processo2.pestip     ,
        ...
        if mr_processo2.cgccpfnum is null then
           ...
           call bdata004_grava_inconsistencia()
        ...
        open c_bdata004_023  using mr_processo2.prporgpcp ,
                                   mr_processo2.prpnumpcp ,
                                   mr_processo2.prporgidv ,
                                   mr_processo2.prpnumidv
        whenever error continue
        fetch c_bdata004_023 into mr_processo2.vcluso

        whenever error stop

        close c_bdata004_023
        ...
        open c_bdata004_024  using mr_processo2.succod    ,
                                   mr_processo2.aplnumdig ,
                                   mr_processo2.itmnumdig ,
                                   mr_funapol.autsitatu
        whenever error continue
        fetch c_bdata004_024 into mr_processo2.imsvlr

        whenever error stop


        close c_bdata004_024
        ...
        #   mr_processo2.vcluso = 1   then
            ...
            open c_bdata004_025 using mr_processo2.prporgpcp ,
                                      mr_processo2.prpnumpcp ,
                                      mr_processo2.prporgidv ,
                                      mr_processo2.prpnumidv
            whenever error continue
            fetch c_bdata004_025 into mr_processo2.rspdat

            whenever error stop

            let mr_inconsistencia.rspdat =  mr_processo2.rspdat

            close c_bdata004_025

            #-----------------------------------------------------------
            # Recupera o Sexo do Principal Condutor
            #-----------------------------------------------------------

            open c_bdata004_026  using mr_processo2.prporgpcp ,
                                       mr_processo2.prpnumpcp ,
                                       mr_processo2.prporgidv ,
                                       mr_processo2.prpnumidv
            whenever error continue
            fetch c_bdata004_026  into mr_processo2.rspcod

            whenever error stop


            close c_bdata004_026
        ...
        open c_bdata004_010 using mr_processo2.prporgpcp ,
                                  mr_processo2.prpnumpcp ,
                                  mr_processo2.prporgidv ,
                                  mr_processo2.prpnumidv

        foreach c_bdata004_010 into mr_processo2.clscod
        	   ...
        	   if not bdata004_valida_geracao_claus(mr_processo2.clscod) then
        	      let m_mensagem = "Clausula ",mr_processo2.clscod, " Não está cadastrado no dominio "
        	      call errorlog(m_mensagem)
        	      continue foreach
        	   end if

        	   call bdata004_calcula_perfil(mr_processo2.nscdat    ,
                                          mr_processo2.segsex    ,
                                          mr_processo2.pestip    ,
                                          mr_processo2.viginc    ,
                                          mr_processo2.vcluso    ,
             ...
             #--------------------------------------------------------
             open c_bdata004_011 using   mr_processo2.empcod ,
                                         mr_processo2.ramcod ,
                                         mr_processo2.clscod ,
                                         mr_processo2.perfil ,
                                         mr_processo2.clcdat ,
                                         mr_processo2.clcdat
             whenever error continue
             fetch c_bdata004_011 into   mr_processo2.plnclscod,
             ...
             if bdata004_acessa_inativacao() then
                if bdata004_regra_anterior() then   
                   call bdata004_carrega_inativacao()
                end if
             end if
             ...
             open c_bdata004_012 using mr_processo2.plnclscod

             foreach c_bdata004_012 into mr_processo2.srvcod                 ,
                   ...
                   open c_bdata004_014 using mr_processo2.srvplnclscod ,
                                             mr_processo2.cbtcod

                   whenever error continue
                   fetch c_bdata004_014 into lr_retorno.cont
                   whenever error stop
                   ...
                   open c_bdata004_015 using mr_processo2.srvplnclscod ,
                                             mr_processo2.ctgtrfcod

                   whenever error continue
                   fetch c_bdata004_015 into lr_retorno.cont
                   whenever error stop
                   ...
                   open c_bdata004_016 using mr_processo2.srvplnclscod ,
                                             mr_processo2.clalclcod

                   whenever error continue
                   fetch c_bdata004_016 into mr_processo2.lclclartccod
                   whenever error stop
                   ...
                   if sqlca.sqlcode <> notfound then
                        ...
                        open c_bdata004_017 using mr_processo2.lclclartccod ,
                                                  mr_processo2.endcid       ,
                                                  mr_processo2.endufd

                        whenever error continue
                        fetch c_bdata004_017 into lr_retorno.cont
                        whenever error stop
                   ...
                   if bdata004_valida_beneficio_processado() then
             ...
             if lr_retorno.grava then
             	  call bdata004_atualiza_exportado()
             	  let lr_retorno.grava = false
             end if
    ...
    call bdata004_exibe_dados_parciais()
...
#========================================================================
function bdata004_exibe_inicio()
#========================================================================
define l_data  date,
...
let mr_param.hour_ini = current
   ...
   display " "
   display "-----------------------------------------------------------"
   display " INICIO bdata004 - CARGA DE PROPOSTA PARA BASE DE BENEFICIO"
   display "-----------------------------------------------------------"
   display " "
...
#========================================================================
function bdata004_atualiza_exportado()
#========================================================================

   whenever error continue
   execute p_bdata004_019 using mr_processo2.plnclscod
...
#========================================================================
function bdata004_valida_carga()
#========================================================================
...
let lr_retorno.cponom = "bdata004_full"
let lr_retorno.cpocod = 1


  open c_bdata004_020 using  lr_retorno.cponom ,
                             lr_retorno.cpocod
  whenever error continue
  fetch c_bdata004_020 into lr_retorno.cpodes
  whenever error stop
...
#========================================================================
#========================================================================
function bdata004_valida_geracao_claus(lr_param)
#========================================================================
...
let l_count = 0
  open c_bdata004_028 using  lr_retorno.cponom
  whenever error continue
  fetch c_bdata004_028 into l_count
  whenever error stop
  if l_count > 0 then
     open c_bdata004_027 using  lr_retorno.cponom
     whenever error continue
     foreach c_bdata004_027 into lr_retorno.cpodes
     whenever error stop
...
#========================================================================
function bdata004_carga_diaria()
#========================================================================

   display "##################################"
   display " CARREGANDO PROPOSTAS DIARIAS... "
   display "##################################"
   

   initialize mr_data.* to null
   call bdata004_recupera_data_diaria()
   ...
   let m_mensagem = " CARGA PROPOSTAS DIARIA.............: ", mr_data.inicio, " - ", mr_data.fim
   call bdata004_monta_mensagem2(m_mensagem)
   ...
   while mr_data.inicio <= mr_data.fim
      ...
      call bdata004_atualiza_data_diaria()

      call bdata004_carrega_beneficio()
         
      let mr_data.inicio = mr_data.inicio + 1 units day
     
   end while
   
   call bdata004_exibe_dados_totais()
...
#========================================================================
function bdata004_recupera_data_inicio()
#========================================================================
...
let lr_retorno.cponom = "bdata004_inicio"
let lr_retorno.cpocod = 1
...
#========================================================================
function bdata004_recupera_data_diaria()
#========================================================================
...
let lr_retorno.cponom = "bdata004_diaria"
let lr_retorno.cpocod = 1
...
#========================================================================
function bdata004_recupera_data_fim()
#========================================================================
...
let lr_retorno.cponom = "bdata004_fim"
let lr_retorno.cpocod = 1
...
#========================================================================
   ...
   initialize mr_data.* to null
   call bdata004_recupera_data_inicio()
   call bdata004_recupera_data_fim()
   ...
   while mr_data.inicio <= mr_data.fim
      ...
      call bdata004_atualiza_data_full()

      call bdata004_carrega_beneficio()
         
      let mr_data.inicio = mr_data.inicio + 1 units day
      
      if not bdata004_valida_dia_hora() then
         exit while
      end if
...
#========================================================================
function bdata004_atualiza_data_full()
#========================================================================
...
let lr_retorno.cpodes = mr_data.inicio
   ...
   whenever error continue
   execute p_bdata004_021 using lr_retorno.cpodes,
                                lr_retorno.cponom,
                                lr_retorno.cpocod
   whenever error continue
...
#========================================================================
function bdata004_atualiza_data_diaria()
#========================================================================
...
#========================================================================
function bdata004_atualiza_full()
#========================================================================
...
#========================================================================
function bdata004_calcula_perfil(lr_param)
#========================================================================
...
initialize lr_retorno.* to null
  ...
  if lr_param.dt_cal < '01/02/2014' then
   ...
   if bdata004_valida_segmento_moto(lr_param.ctgtrfcod) then    
   ...
   if bdata004_valida_segmento_taxi(lr_param.ctgtrfcod) then
   ...
   if bdata004_valida_segmento_caminhao(lr_param.ctgtrfcod) then
   ...
   #if bdata004_valida_segmento_premium(lr_retorno.idade,
   ...
   if lr_param.pestip = "F" then
         ...
         #----------------------------------#
      	 ...
      	 if bdata004_valida_segmento_mulher(lr_retorno.idade,
      	 ...
      	 if bdata004_valida_segmento_jovem(lr_retorno.idade) then
      	 ...
      	 if bdata004_valida_segmento_senior(lr_retorno.idade) then
...
#========================================================================
function bdata004_exibe_dados_parciais()
#========================================================================
...
#========================================================================
function bdata004_exibe_dados_totais()
#========================================================================
...
#========================================================================
function bdata004_recupera_quebra()
#========================================================================
...
let lr_retorno.cpocod = 1
  ...
  open c_bdata004_020 using  lr_retorno.cponom ,
                             lr_retorno.cpocod
  whenever error continue
  fetch c_bdata004_020 into m_quebra
  whenever error stop
...
#========================================================================
function bdata004_dispara_email()
#========================================================================
...
initialize lr_mail.* to null
    ...
    let lr_mail.para    = bdata004_recupera_email()
    let lr_mail.cc      = ""
    let lr_mail.cco     = ""

    let lr_mail.assunto = "Carga Base Beneficios - Porto Auto Proposta"

    let lr_mail.mensagem  = bdata004_monta_mensagem()
...
#========================================================================
function bdata004_recupera_email()
#========================================================================
...
#========================================================================
function bdata004_monta_mensagem()
#========================================================================
...
#========================================================================
#========================================================================
function bdata004_grava_inconsistencia()
#========================================================================
define lr_retorno record
  status  char(3000)
end record
...
initialize lr_retorno.* to null
   whenever error continue
   execute p_bdata004_030 using   mr_inconsistencia.empcod
...
#========================================================================
function bdata004_grava_beneficio()
#========================================================================
...
initialize lr_retorno.* to null
   ...
   whenever error continue
   execute p_bdata004_029 using mr_processo2.empcod
...
#========================================================================
function bdata004_monta_mensagem2(l_param)
#========================================================================
...
#========================================================================                                       
 function bdata004_valida_segmento_moto(lr_param)                              
#========================================================================                                     
...
#========================================================================                                                                                          
 function bdata004_valida_segmento_taxi(lr_param)                       
#========================================================================                      
...
#========================================================================                                                                                  
 function bdata004_valida_segmento_caminhao(lr_param)                       
#========================================================================                       
...
#========================================================================                    
 function bdata004_valida_segmento_premium(lr_param)                        
#========================================================================                      
...
#========================================================================                  
 function bdata004_valida_segmento_mulher(lr_param)                         
#========================================================================                      
...
#========================================================================                       
 function bdata004_valida_segmento_jovem(lr_param)                          
#========================================================================                       
...
#========================================================================                       
 function bdata004_valida_segmento_senior(lr_param)                         
#========================================================================              
...
#========================================================================    
 function bdata004_recupera_produto(lr_param)                
#========================================================================    
...
let lr_retorno.cponom = "ctc69m07_prod"                                     
  ...
  open c_bdata004_031 using  lr_retorno.cponom ,                            
                             lr_param.empcod   ,
                             lr_param.ramcod                            
  whenever error continue                                                   
  fetch c_bdata004_031 into lr_retorno.procod                               
  whenever error stop                                                       
...
#======================================================================== 
#======================================================================== 
 function bdata004_valida_dia_hora()
#======================================================================== 
...
#========================================================================
function bdata004_grava_apolice_processada()
#========================================================================
...
initialize lr_retorno.* to null
   ...
   if bdata004_valida_processado() then
...
#========================================================================
 function bdata004_valida_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata004_032 using   mr_inconsistencia.empcod   
                            , lr_retorno.doctipcod
                            , mr_inconsistencia.prporgidv
                            , mr_inconsistencia.prpnumidv
                            , mr_inconsistencia.prporgpcp
  ...
  whenever error continue                                                   
  fetch c_bdata004_032 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata004_valida_beneficio_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata004_033 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc  
                            , mr_processo2.prporgidv                             
                            , mr_processo2.prpnumidv                             
                            , mr_processo2.srvcod
  ...
  whenever error continue                                                   
  fetch c_bdata004_033 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata004_valida_beneficio_inativado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata004_034 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc  
                            , mr_processo2.prporgidv                             
                            , mr_processo2.prpnumidv                             
                            , mr_processo3.srvcod
  ...
  whenever error continue                                                   
  fetch c_bdata004_034 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
function bdata004_regra_anterior()
#========================================================================
...
let lr_retorno.cont = 0    
  ...
  open c_bdata004_001 using   mr_processo2.empcod      ,              
                              mr_processo2.ramcod      ,              
                              mr_processo2.clscod      ,              
                              mr_processo2.perfil      ,              
                              ...
                              mr_processo2.clsviginidat                    
  whenever error continue
  fetch c_bdata004_001 into   lr_retorno.cont                             
  whenever error stop
...
#========================================================================                                                                                                                      
function bdata004_carrega_inativacao()                                             
#========================================================================          
...
initialize lr_retorno.* to null    
    ...
    open c_bdata004_003 using   mr_processo2.empcod      ,       
                                mr_processo2.ramcod      ,       
                                mr_processo2.clscod      ,       
                                mr_processo2.perfil      ,       
                                mr_processo2.plnclscod   ,       
    ...
    foreach c_bdata004_003 into mr_processo3.plnclscod                           
                           
        #--------------------------------------------------------                                                            
        # Recupera os Servicos de Cada Regra                                                                                 
        #--------------------------------------------------------                                                            
                                                                                                                           
        open c_bdata004_012 using mr_processo3.plnclscod                                                                   
                                                                                                                           
        foreach c_bdata004_012 into mr_processo3.srvcod                 ,                                                  
              ...
              open c_bdata004_014 using mr_processo3.srvplnclscod ,                                                        
                                        mr_processo2.cbtcod                                                                
              ...
              open c_bdata004_015 using mr_processo3.srvplnclscod ,                                
                                        mr_processo2.ctgtrfcod                                     
              ...
              open c_bdata004_016 using mr_processo3.srvplnclscod ,                                
                                        mr_processo2.clalclcod                                     
                                                                                                   
              whenever error continue                                                              
              fetch c_bdata004_016 into mr_processo3.lclclartccod                                  
              whenever error stop                                                                  
              ...
              if sqlca.sqlcode <> notfound then                                                    
                   ...
                   open c_bdata004_017 using mr_processo3.lclclartccod ,                           
                                             mr_processo2.endcid       ,                           
                                             mr_processo2.endufd                                   
              ...
              if bdata004_valida_beneficio_inativado() then
                	let mr_count1.proce = mr_count1.proce + 1
              	  let mr_total.proce  = mr_total.proce + 1
							 	continue foreach
              end if  
...
#========================================================================                        
function bdata004_grava_inativo()                                                           
#========================================================================                     
...
#========================================================================
function bdata004_acessa_inativacao()
#========================================================================
