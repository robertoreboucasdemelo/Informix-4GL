...
#-----------------------------------------------------------------------------#
# 15/12/2006 Priscila Staingel  PSI205206 Separar relatório por empresa       #
...
#--------------------------------------------------------------------
 ...
 #relatorio recibo tb gerado qdo tipo de pgto é cheque
   ...
   format
      page header
           if pageno  =  1   then
              ...
              #se 1º pagina - carrega opçao em suas devidas posicoes
              for arr_tip = 1 to 3
           ...
           #else #se é uma pagina de fechamento
