...
# Modulo.........: bdata011                                                      #
# Objetivo.......: Batch de Geracao de Apolices Retroativas Porto Auto           #
...
define m_bdata011_prep   smallint
...
#========================================================================
   ...
   call bdata011_cria_log()

   call bdata011_exibe_inicio()
   ...
   display "##################################"
   if not bdata011_recupera_quebra() then
      exit program
   end if  

 
   if not bdata011_carga_full() then
   ...
   call bdata011_exibe_final()

   call bdata011_dispara_email()
...
define l_sql char(10000)
   ...
   let l_sql = ' select count(*)           '
             ...
             , '  and   plnclscod <>  ?    '     
             , '  and   clsvigfimdat <= ?  '           
   prepare p_bdata011_001 from l_sql
   declare c_bdata011_001 cursor for p_bdata011_001

   let l_sql = ' select count(*)        '
            ,  '  from datksrvesp       '
            ,  '  where srvespnum   = ? '
   prepare p_bdata011_002 from l_sql
   declare c_bdata011_002 cursor for p_bdata011_002
   ...
   let l_sql = ' select plnclscod          '
             ...
             , '  and   plnclscod <>  ?    '     
             , '  and   clsvigfimdat <= ?  '           
   prepare p_bdata011_003 from l_sql
   declare c_bdata011_003 cursor for p_bdata011_003
   ...
   let l_sql =  ' select a.emsdat    ,            '
               ...
               ,'   max(c.dctnumseq)              '
               ,'   from abbmdoc c                '
               ,'   where b.succod = c.succod     '
               ,'   and b.aplnumdig = c.aplnumdig '
               ,'   and b.itmnumdig = c.itmnumdig)'
               ,' and   not exists                '
               ,' (select * from datmbnfcrgico d  '
               ,'  where d.empcod  = ?            '
               ,'  and d.dcttipcod = 999          '
               ,'  and d.apldignum = b.aplnumdig  ' 
               ,'  and d.succod    = b.succod     ' 
               ,'  and d.itmdignum = b.itmnumdig  '
               ,'  and d.dctseqnum = b.dctnumseq  '
               ,'  and d.dctemsdat = ?)           '       
               ,' group by 1,2,3,4,5,6,7,8        '
               ,' order by 1,2,3,4,5,6,7,8        '
   prepare p_bdata011_005 from l_sql
   declare c_bdata011_005 cursor with hold for p_bdata011_005
   ...
   let l_sql = ' select min(dctnumseq) '
              ...
              ,'   and aplnumdig = ?    '
              ,'   and itmnumdig = ?    '
   prepare p_bdata011_006 from l_sql
   declare c_bdata011_006 cursor with hold for p_bdata011_006
   ...
   prepare p_bdata011_007 from l_sql
   declare c_bdata011_007 cursor with hold for p_bdata011_007
   ...
   let l_sql =  ' select segnumdig,    '
               ...
               ,' and   itmnumdig =  ? '
               ,' and   dctnumseq =  ? '
   prepare p_bdata011_008 from l_sql
   declare c_bdata011_008 cursor for p_bdata011_008
   ...
   let l_sql =  ' select cbtcod    ,   '
               ...
               ,' and   itmnumdig = ?  '
               ,' and   dctnumseq = ?  '
   prepare p_bdata011_009 from l_sql
   declare c_bdata011_009 cursor with hold for p_bdata011_009
   ...
   let l_sql =  ' select clscod       '
               ...
               ,' and   itmnumdig = ? '
               ,' and   dctnumseq = ? '
   prepare p_bdata011_010 from l_sql
   declare c_bdata011_010 cursor with hold for p_bdata011_010
   ...
   let l_sql = ' select plnclscod,         '
             ...
             , '  and   clsvigfimdat >=  ? '
             , '  and   regsitflg = "A"    '
   prepare p_bdata011_011 from l_sql
   declare c_bdata011_011 cursor for p_bdata011_011
   ...
   let l_sql = ' select a.srvcod                 ,   '
              ...
              ,' and   a.plnclscod  = ?              '
   prepare p_bdata011_012 from l_sql
   declare c_bdata011_012 cursor with hold for p_bdata011_012
   
   let l_sql = ' select empnom     '
              ,' from gabkemp      '
              ,' where empcod = ?   '
   prepare p_bdata011_013 from l_sql
   declare c_bdata011_013 cursor for p_bdata011_013
   ...
   let l_sql = ' select count(*)         '
              ...
              ,' where srvclscod   =  ?  '
              ,' and   cbtcod      =  ?  '
   prepare p_bdata011_014 from l_sql
   declare c_bdata011_014 cursor for p_bdata011_014
   ...
   let l_sql = ' select count(*)        '
              ...
              ,' where srvclscod   =  ? '
              ,' and   trfctgcod   =  ? '
   prepare p_bdata011_015 from l_sql
   declare c_bdata011_015 cursor for p_bdata011_015
   ...
   let l_sql = ' select lclclartccod       '
              ...
              ,' where srvclscod    =  ?   '
              ,' and   lclclacod    =  ?   '
   prepare p_bdata011_016 from l_sql
   declare c_bdata011_016 cursor for p_bdata011_016
   ...
   let l_sql = ' select count(*)              '
              ...
              ,' and   b.cidnom        =  ?    '
              ,' and   b.ufdcod       =  ?    '
   prepare p_bdata011_017 from l_sql
   declare c_bdata011_017 cursor for p_bdata011_017
   ...
   let l_sql = ' select endcid ,      '
              ...
              ,' where segnumdig =  ? '
              ,' and   endfld    =  1 '
   prepare p_bdata011_018 from l_sql
   declare c_bdata011_018 cursor for p_bdata011_018
   
   
   let l_sql =  ' update datkplncls     '
             ,  ' set irdclsflg = "S"   '
             ,  ' where plnclscod = ?   '
   prepare p_bdata011_019 from l_sql
   
   let l_sql = ' select cpodes        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
              ,' and   cpocod =  ?    '
   prepare p_bdata011_020 from l_sql
   declare c_bdata011_020 cursor for p_bdata011_020
   ...
   let l_sql =  ' update datkdominio    '
              ...
              , ' where cponom =  ?     '
              , ' and   cpocod =  ?     '
   prepare p_bdata011_021 from l_sql
   ...
   let l_sql = 'select nscdat,        ',
               ...
               ' from gsakseg         ',
               ' where segnumdig  = ? '
   prepare p_bdata011_022 from l_sql
   declare c_bdata011_022 cursor for p_bdata011_022
   ...
   let l_sql = ' select vcluso      '
              ...
              ,' where succod   = ? '
               ...
               ,' and  itmnumdig = ? '
              ,' and  dctnumseq = ? '
   prepare p_bdata011_023 from l_sql
   declare c_bdata011_023 cursor for p_bdata011_023
   ...
   let l_sql = 'select imsvlr        '
              ...
              ,' where succod    = ? '
               ...
               ,'   and itmnumdig = ? '
              ,'   and dctnumseq = ? '
   prepare p_bdata011_024 from l_sql
   declare c_bdata011_024 cursor for p_bdata011_024
   ...
   let l_sql = 'select rspdat           '
              ...
              ,'   and dctnumseq = ?    '
              ,'   and qstcod    = 2    '
   prepare p_bdata011_025 from l_sql
   declare c_bdata011_025 cursor for p_bdata011_025
   ...
   let l_sql = 'select rspcod           '
              ...
              ,'   and dctnumseq = ?    '
              ,'   and qstcod    = 120  '
   prepare p_bdata011_026 from l_sql
   declare c_bdata011_026 cursor for p_bdata011_026
   
   let l_sql = ' select cpodes        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
   prepare p_bdata011_027 from l_sql
   declare c_bdata011_027 cursor for p_bdata011_027
   
   let l_sql = ' select count(*)        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
   prepare p_bdata011_028 from l_sql
   declare c_bdata011_028 cursor for p_bdata011_028
   ...
   let l_sql = " insert into datmbnfcrgmov             "
             ...
             ," values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,? "
             ,"  ,?,?,?,?,?)                          "
   prepare p_bdata011_029 from l_sql
   ...
   let l_sql = ' insert into datmbnfcrgico             '
             ...
             ,'  ,?,?,?,?,?,?,?,?,?,?,?,?,?            '
             ,'  ,?,?,?,?,?,?,?  )                     '
   prepare p_bdata011_030 from l_sql
   ...
   let l_sql = ' select cpodes[8,12]     '  
              ...
              ,' and   cpodes[1,2] =  ?  '
              ,' and   cpodes[4,6] =  ?  '             
   prepare p_bdata011_031  from l_sql                
   declare c_bdata011_031  cursor for p_bdata011_031
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctseqnum =  ? '
              ,' and   dctemsdat =  ? '              
   prepare p_bdata011_032 from l_sql
   declare c_bdata011_032 cursor for p_bdata011_032
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctclscod =  ? '
              ,' and   pcmflg in ("S","N") '               
   prepare p_bdata011_033 from l_sql
   declare c_bdata011_033 cursor for p_bdata011_033 	
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctclscod =  ? '
              ,' and   pcmflg in ("R","E") '               
   prepare p_bdata011_034 from l_sql
   declare c_bdata011_034 cursor for p_bdata011_034 	
   

  
   let m_bdata011_prep = true
...
#========================================================================
   ...
   let l_path = m_path_log clipped, "bdata011.log"
...
#========================================================================
function bdata011_carrega_beneficio()
#========================================================================
...
let mr_inconsistencia.dtger     = today
    ...
    #--------------------------------------------------------
     ...
     open c_bdata011_013 using mr_processo2.empcod

     whenever error continue
     fetch c_bdata011_013 into mr_processo2.empnom
     whenever error stop
    ...
    #--------------------------------------------------------
    open c_bdata011_005 using mr_data.fim        ,
                              mr_processo2.empcod,
                              mr_data.fim

    foreach c_bdata011_005 into mr_processo2.emsdat
                              , mr_processo2.viginc
                              , mr_processo2.vigfnl
                              , mr_processo2.succod
       ...
       #-------------------------------------------------------
        ...
        if mr_funapol.dctnumseq is null  then
            ...
            open c_bdata011_006 using mr_processo2.succod    ,
                                      mr_processo2.aplnumdig ,
                                      mr_processo2.itmnumdig

            whenever error continue
            fetch c_bdata011_006 into mr_funapol.dctnumseq
            whenever error stop


        end if
        let mr_inconsistencia.dctnumseq =  mr_funapol.dctnumseq
        ...
        open c_bdata011_007 using mr_processo2.succod    ,
                                  mr_processo2.aplnumdig ,
                                  mr_funapol.dctnumseq

        whenever error continue
        fetch c_bdata011_007 into mr_processo2.edsnumref
        whenever error stop
        ...
        #------------------------------------------------------  
        call bdata011_grava_apolice_processada()                 
        ...
        open c_bdata011_008 using mr_processo2.succod    ,
                                  mr_processo2.aplnumdig ,
                                  mr_processo2.itmnumdig ,
                                  mr_funapol.dctnumseq
        whenever error continue
        fetch c_bdata011_008 into mr_processo2.segnumdig ,
        ...
        open c_bdata011_018 using mr_processo2.segnumdig

        whenever error continue
        fetch c_bdata011_018 into mr_processo2.endcid ,
                                  mr_processo2.endufd
        whenever error stop
        ...
        open c_bdata011_009 using mr_processo2.succod    ,
                                  mr_processo2.aplnumdig ,
                                  mr_processo2.itmnumdig ,
                                  mr_funapol.dctnumseq
        whenever error continue
        fetch c_bdata011_009 into mr_processo2.cbtcod    ,
        ...
        open c_bdata011_022 using mr_processo2.segnumdig

        whenever error continue
        fetch c_bdata011_022 into mr_processo2.nscdat     ,
                                  mr_processo2.segsex     ,
                                  mr_processo2.pestip     ,
        ...
        if mr_processo2.cgccpfnum is null then
           ...
           call bdata011_grava_inconsistencia()
        ...
        open c_bdata011_023  using mr_processo2.succod    ,
                                   mr_processo2.aplnumdig ,
                                   mr_processo2.itmnumdig ,
                                   mr_funapol.dctnumseq
        whenever error continue
        fetch c_bdata011_023 into mr_processo2.vcluso

        whenever error stop

        close c_bdata011_023
        ...
        open c_bdata011_024  using mr_processo2.succod    ,
                                   mr_processo2.aplnumdig ,
                                   mr_processo2.itmnumdig ,
                                   mr_funapol.autsitatu
        whenever error continue
        fetch c_bdata011_024 into mr_processo2.imsvlr

        whenever error stop


        close c_bdata011_024
             
        #-----------------------------------------------------------
        # Recupera a Data de Nascimento do Principal Condutor
        #-----------------------------------------------------------

        open c_bdata011_025 using mr_processo2.succod    ,
                                  mr_processo2.aplnumdig ,
                                  mr_processo2.itmnumdig ,
                                  mr_funapol.dctnumseq
        whenever error continue
        fetch c_bdata011_025 into mr_processo2.rspdat

        whenever error stop

        let mr_inconsistencia.rspdat =  mr_processo2.rspdat

        close c_bdata011_025
        
        #-----------------------------------------------------------
        # Recupera o Sexo do Principal Condutor
        #-----------------------------------------------------------

        open c_bdata011_026  using mr_processo2.succod    ,
                                   mr_processo2.aplnumdig ,
                                   mr_processo2.itmnumdig ,
                                   mr_funapol.dctnumseq
        whenever error continue
        fetch c_bdata011_026  into mr_processo2.rspcod

        whenever error stop


        close c_bdata011_026
        ...
        open c_bdata011_010 using mr_processo2.succod    ,
                                  mr_processo2.aplnumdig ,
                                  mr_processo2.itmnumdig ,
                                  mr_funapol.dctnumseq

        foreach c_bdata011_010 into mr_processo2.clscod
             ...
             if not bdata011_valida_geracao_claus(mr_processo2.clscod) then
             ...
             call bdata011_calcula_perfil(mr_processo2.nscdat    ,
                                          mr_processo2.segsex    ,
                                          mr_processo2.pestip    ,
                                          mr_processo2.viginc    ,
                                          mr_processo2.vcluso    ,
             ...
             #------------------------------------------------------  
             let mr_processo2.codprod = bdata011_recupera_produto(mr_processo2.ramcod,mr_processo2.empcod)             
             ...
             open c_bdata011_011 using   mr_processo2.empcod ,
                                         mr_processo2.ramcod ,
                                         mr_processo2.clscod ,
                                         mr_processo2.perfil ,
                                         mr_processo2.clcdat ,
                                         mr_processo2.clcdat
             whenever error continue
             fetch c_bdata011_011 into   mr_processo2.plnclscod,
             ...
             if bdata011_acessa_inativacao() then 
                if bdata011_regra_anterior() then
                  call bdata011_carrega_inativacao()
                end if
             end if
             ...
             open c_bdata011_012 using mr_processo2.plnclscod

             foreach c_bdata011_012 into mr_processo2.srvcod                 ,
                   ...
                   open c_bdata011_014 using mr_processo2.srvplnclscod ,
                                             mr_processo2.cbtcod

                   whenever error continue
                   fetch c_bdata011_014 into lr_retorno.cont
                   whenever error stop
                   ...
                   open c_bdata011_015 using mr_processo2.srvplnclscod ,
                                             mr_processo2.ctgtrfcod

                   whenever error continue
                   fetch c_bdata011_015 into lr_retorno.cont
                   whenever error stop
                   ...
                   open c_bdata011_016 using mr_processo2.srvplnclscod ,
                                             mr_processo2.clalclcod

                   whenever error continue
                   fetch c_bdata011_016 into mr_processo2.lclclartccod
                   whenever error stop
                   ...
                   if sqlca.sqlcode <> notfound then
                        ...
                        open c_bdata011_017 using mr_processo2.lclclartccod ,
                                                  mr_processo2.endcid       ,
                                                  mr_processo2.endufd

                        whenever error continue
                        fetch c_bdata011_017 into lr_retorno.cont
                        whenever error stop
                   ...
                   if bdata011_valida_beneficio_processado() then
    ...
    call bdata011_exibe_dados_parciais()
...
#========================================================================
function bdata011_exibe_inicio()
#========================================================================
define l_data  date,
...
let mr_param.hour_ini = current
   ...
   display " "
   display "-----------------------------------------------------------"
   display " INICIO bdata011 - CARGA DE APOLICES PARA BASE DE BENEFICIO"
   display "-----------------------------------------------------------"
   display " "
...
#========================================================================
function bdata011_valida_geracao_claus(lr_param)
#========================================================================
...
let l_count = 0
  open c_bdata011_028 using  lr_retorno.cponom
  whenever error continue
  fetch c_bdata011_028 into l_count
  whenever error stop
  if l_count > 0 then
     open c_bdata011_027 using  lr_retorno.cponom
     whenever error continue
     foreach c_bdata011_027 into lr_retorno.cpodes
     whenever error stop
...
#========================================================================
function bdata011_recupera_dias()
#========================================================================
...
let lr_retorno.cponom = "bdata001_retro"
let lr_retorno.cpocod = 1


  open c_bdata011_020 using  lr_retorno.cponom ,
                             lr_retorno.cpocod
  whenever error continue
  fetch c_bdata011_020 into lr_retorno.cpodes
  whenever error stop
...
#========================================================================
function bdata011_recupera_data_validacao()
#========================================================================
...
let lr_retorno.cponom = "bdata011_data"
let lr_retorno.cpocod = 1
...
#========================================================================
function bdata011_recupera_data_inicio()
#========================================================================

  call bdata011_recupera_dias()
...
#========================================================================
function bdata011_recupera_data_fim()
#========================================================================
...
#========================================================================
   ...
   call bdata011_recupera_data_inicio()
   call bdata011_recupera_data_fim()
   call bdata011_recupera_data_validacao() 
  
   let m_mensagem = " CARGA APOLICES FULL................: ", mr_data.inicio, " - ", mr_data.fim   
   call bdata011_monta_mensagem2(m_mensagem)
   ...
   while mr_data.inicio <= mr_data.fim
      ...
      call bdata011_carrega_beneficio()
         
      let mr_data.fim = mr_data.fim - 1 units day
      
      if not bdata011_valida_dia_hora() then
         exit while
      end if
          
   end while
   
   call bdata011_exibe_dados_totais()
...
#========================================================================
function bdata011_calcula_perfil(lr_param)
#========================================================================
...
initialize lr_retorno.* to null
  ...
  if lr_param.dt_cal < '01/02/2014' then
   ...
   if bdata011_valida_segmento_moto(lr_param.ctgtrfcod) then    
   ...
   if bdata011_valida_segmento_taxi(lr_param.ctgtrfcod) then
   ...
   if bdata011_valida_segmento_caminhao(lr_param.ctgtrfcod) then
   ...
   #if bdata011_valida_segmento_premium(lr_retorno.idade,
   ...
   if lr_param.pestip = "F" then
         ...
         #----------------------------------#
      	 ...
      	 if bdata011_valida_segmento_mulher(lr_retorno.idade,
      	 ...
      	 if bdata011_valida_segmento_jovem(lr_retorno.idade) then
      	 ...
      	 if bdata011_valida_segmento_senior(lr_retorno.idade) then
...
#========================================================================
function bdata011_exibe_dados_parciais()
#========================================================================
...
#========================================================================
function bdata011_exibe_dados_totais()
#========================================================================
...
#========================================================================
function bdata011_recupera_quebra()
#========================================================================
...
let lr_retorno.cpocod = 1
  ...
  open c_bdata011_020 using  lr_retorno.cponom ,
                             lr_retorno.cpocod
  whenever error continue
  fetch c_bdata011_020 into m_quebra
  whenever error stop
...
#========================================================================
function bdata011_dispara_email()
#========================================================================
...
initialize lr_mail.* to null
    ...
    let lr_mail.para    = bdata011_recupera_email()
    let lr_mail.cc      = ""
    let lr_mail.cco     = ""

    let lr_mail.assunto = "Carga Retroativa Porto Auto Apolices"

    let lr_mail.mensagem  = bdata011_monta_mensagem()
...
#========================================================================
function bdata011_recupera_email()
#========================================================================
...
#========================================================================
function bdata011_monta_mensagem()
#========================================================================
...
#========================================================================
#========================================================================
function bdata011_grava_inconsistencia()
#========================================================================
define lr_retorno record
  status  char(3000)
end record
initialize lr_retorno.* to null
   whenever error continue
   execute p_bdata011_030 using   mr_inconsistencia.empcod
...
#========================================================================
#========================================================================
function bdata011_grava_beneficio()
#========================================================================
define lr_retorno record
  status  char(30000)
end record         
...
initialize lr_retorno.* to null
  ...
  let mr_processo2.data_ger = today
   ...
   whenever error continue
   execute p_bdata011_029 using mr_processo2.empcod
...
#========================================================================
function bdata011_monta_mensagem2(l_param)
#========================================================================
...
#========================================================================                                       
 function bdata011_valida_segmento_moto(lr_param)                              
#========================================================================                                     
...
#========================================================================                                                                                          
 function bdata011_valida_segmento_taxi(lr_param)                       
#========================================================================                      
...
#========================================================================                                                                                  
 function bdata011_valida_segmento_caminhao(lr_param)                       
#========================================================================                       
...
#========================================================================                    
 function bdata011_valida_segmento_premium(lr_param)                        
#========================================================================                      
...
#========================================================================                  
 function bdata011_valida_segmento_mulher(lr_param)                         
#========================================================================                      
...
#========================================================================                       
 function bdata011_valida_segmento_jovem(lr_param)                          
#========================================================================                       
...
#========================================================================                       
 function bdata011_valida_segmento_senior(lr_param)                         
#========================================================================              
...
#========================================================================    
 function bdata011_recupera_produto(lr_param)                
#========================================================================    
...
let lr_retorno.cponom = "ctc69m07_prod"                                     
  ...
  open c_bdata011_031 using  lr_retorno.cponom ,                            
                             lr_param.empcod   ,
                             lr_param.ramcod                            
  whenever error continue                                                   
  fetch c_bdata011_031 into lr_retorno.procod                               
  whenever error stop                                                       
...
#======================================================================== 
 function bdata011_valida_dia_hora()
#======================================================================== 
...
#========================================================================
function bdata011_grava_apolice_processada()
#========================================================================
...
initialize lr_retorno.* to null
   ...
   if bdata011_valida_processado() then
...
#========================================================================
 function bdata011_valida_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata011_032 using   mr_inconsistencia.empcod   
                            , lr_retorno.doctipcod
                            , mr_inconsistencia.succod
                            , mr_inconsistencia.ramcod
                            , mr_inconsistencia.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata011_032 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata011_valida_beneficio_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata011_033 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc
                            , mr_processo2.succod
                            , mr_processo2.ramcod
                            , mr_processo2.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata011_033 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata011_valida_beneficio_inativado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata011_034 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc
                            , mr_processo2.succod
                            , mr_processo2.ramcod
                            , mr_processo2.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata011_034 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
function bdata011_regra_anterior()
#========================================================================
...
let lr_retorno.cont = 0  
  ...
  open c_bdata011_001 using   mr_processo2.empcod      ,              
                              mr_processo2.ramcod      ,              
                              mr_processo2.clscod      ,              
                              mr_processo2.perfil      ,              
                              ...
                              mr_processo2.clsviginidat                    
  whenever error continue
  fetch c_bdata011_001 into   lr_retorno.cont                             
  whenever error stop
...
#========================================================================                                                                                                                      
function bdata011_carrega_inativacao()                                             
#========================================================================          
...
initialize lr_retorno.* to null    
    ...
    open c_bdata011_003 using   mr_processo2.empcod      ,       
                                mr_processo2.ramcod      ,       
                                mr_processo2.clscod      ,       
                                mr_processo2.perfil      ,       
                                mr_processo2.plnclscod   ,       
    ...
    foreach c_bdata011_003 into mr_processo3.plnclscod                           
        ...
        open c_bdata011_012 using mr_processo3.plnclscod                                                                   
                                                                                                                           
        foreach c_bdata011_012 into mr_processo3.srvcod                 ,                                                  
              ...
              open c_bdata011_014 using mr_processo3.srvplnclscod ,                                                        
                                        mr_processo2.cbtcod                                                                
              ...
              open c_bdata011_015 using mr_processo3.srvplnclscod ,                                
                                        mr_processo2.ctgtrfcod                                     
              ...
              open c_bdata011_016 using mr_processo3.srvplnclscod ,                                
                                        mr_processo2.clalclcod                                     
                                                                                                   
              whenever error continue                                                              
              fetch c_bdata011_016 into mr_processo3.lclclartccod                                  
              whenever error stop                                                                  
              ...
              if sqlca.sqlcode <> notfound then                                                    
                   ...
                   open c_bdata011_017 using mr_processo3.lclclartccod ,                           
                                             mr_processo2.endcid       ,                           
                                             mr_processo2.endufd                                   
              ...
              if bdata011_valida_beneficio_inativado() then           
                	let mr_count1.proce = mr_count1.proce + 1            
              	  let mr_total.proce  = mr_total.proce + 1             
               	continue foreach                                       
              end if                                                   
...
#========================================================================                        
function bdata011_grava_inativo()                                                           
#========================================================================                     
...
#========================================================================
function bdata011_acessa_inativacao()
#========================================================================
...
let lr_retorno.cponom = "bdata001_acessa"
let lr_retorno.cpocod = 1
