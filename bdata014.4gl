...
# Modulo.........: bdata014                                                   #
# Objetivo.......: Batch de Geracao de Apolices Retroativas Itau RE           #
# Analista Resp. : R.Fornax                                                   #
# PSI            :                                                            #
#.............................................................................#
# Desenvolvimento: R.Fornax                                                   #
# Liberacao      : 22/05/2016                                                 #
#-----------------------------------------------------------------------------#
...
define m_bdata014_prep   smallint
...
#========================================================================
   ...
   call bdata014_cria_log()

   call bdata014_exibe_inicio()
   ...
   display " PREPARANDO... "
   display "##################################"
   call bdata014_prepare()


   display "##################################"
   display " RECUPERANDO QUEBRA... "
   display "##################################"
   if not bdata014_recupera_quebra() then
      exit program
   end if  
   
   if not bdata014_carga_full() then
      let m_mensagem = "Carga Full Abortada. Verificar os Dominios."
      call ERRORLOG(m_mensagem);
      display m_mensagem
   end if
        
   call bdata014_exibe_final()

   call bdata014_dispara_email()
...
define l_sql char(10000)
   ...
   let l_sql =  ' select b.itaciacod          '
               ...
               ,'  where d.empcod  = ?                        '
               ,'  and d.dcttipcod = 999                      '
               ,'  and d.apldignum = a.aplnum              '
               ,'  and d.itmdignum = b.aplitmnum           '
               ,'  and d.dctseqnum = b.aplseqnum              '
               ,'  and d.ramcod = a.itaramcod                 '
               ,'  and d.incvigdat = ?)                       ' 
               ,' order by a.incvigdat desc                   '            
   prepare p_bdata014_001 from l_sql
   declare c_bdata014_001 cursor with hold for p_bdata014_001
   ...
   let l_sql = ' select plnclscod,         '
             ...
             , '  and   clsvigfimdat >=  ? '
             , '  and   regsitflg = "A"    '
   prepare p_bdata014_002 from l_sql
   declare c_bdata014_002 cursor for p_bdata014_002
   ...
   let l_sql = ' select a.srvcod                 ,   '
              ...
              ,' and   a.plnclscod  = ?              '
   prepare p_bdata014_003 from l_sql
   declare c_bdata014_003 cursor with hold for p_bdata014_003
   
   let l_sql = ' select empnom     '
              ,' from gabkemp      '
              ,' where empcod = ?   '
   prepare p_bdata014_004 from l_sql
   declare c_bdata014_004 cursor for p_bdata014_004
   ...
   let l_sql = ' select count(*)        '
              ...
              ,' where srvclscod   =  ? '
              ,' and   trfctgcod   =  ? '
   prepare p_bdata014_005 from l_sql
   declare c_bdata014_005 cursor for p_bdata014_005
   

   let l_sql =  ' update datkplncls     '
             ,  ' set irdclsflg = "S"   '
             ,  ' where plnclscod = ?   '
   prepare p_bdata014_006 from l_sql
   
   let l_sql = ' select cpodes        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
              ,' and   cpocod =  ?    '
   prepare p_bdata014_007 from l_sql
   declare c_bdata014_007 cursor for p_bdata014_007
   ...
   let l_sql =  ' update datkdominio    '
              ...
              , ' where cponom =  ?     '
              , ' and   cpocod =  ?     '
   prepare p_bdata014_008 from l_sql
   
 
   let l_sql = ' select cpodes        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
   prepare p_bdata014_009 from l_sql
   declare c_bdata014_009 cursor for p_bdata014_009
   ...
   let l_sql = ' insert into datmbnfcrgmov  '
             ...
             ,'  values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,? '
             ,'  ,?,?,?,?,?,?)                         '
   prepare p_bdata014_010 from l_sql   
    ...
    let l_sql = ' insert into datmbnfcrgico '
             ...
             ,'  ,?,?,?,?,?,?,?,?,?,?,?,?,?            '
             ,'  ,?,?,?,?,?,?,?  )                     '
  prepare p_bdata014_011 from l_sql
   ...
   let l_sql = ' select cpodes[8,12]     '  
              ...
              ,' and   cpodes[1,2] =  ?  '
              ,' and   cpodes[4,6] =  ?  '             
   prepare p_bdata014_012 from l_sql                
   declare c_bdata014_012 cursor for p_bdata014_012	
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctseqnum =  ? '
              ,' and   incvigdat =  ? '              
   prepare p_bdata014_013 from l_sql
   declare c_bdata014_013 cursor for p_bdata014_013
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctclscod =  ? ' 
              ,' and   pcmflg in ("S","N") '               
   prepare p_bdata014_014 from l_sql
   declare c_bdata014_014 cursor for p_bdata014_014
   ...
   let l_sql = ' select count(*)           '
             ...
             , '  and   plnclscod <>  ?    '     
             , '  and   clsvigfimdat <= ?  '           
   prepare p_bdata014_015 from l_sql
   declare c_bdata014_015 cursor for p_bdata014_015
   ...
   let l_sql = ' select plnclscod          '
             ...
             , '  and   plnclscod <>  ?    '     
             , '  and   clsvigfimdat <= ?  '           
   prepare p_bdata014_016 from l_sql
   declare c_bdata014_016 cursor for p_bdata014_016
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctclscod =  ? ' 
              ,' and   pcmflg in ("R","E") '               
   prepare p_bdata014_017 from l_sql
   declare c_bdata014_017 cursor for p_bdata014_017	 	
   	   	
   	
   let m_bdata014_prep = true
...
#========================================================================
   ...
   let l_path = m_path_log clipped, "bdata014.log"
...
#========================================================================
function bdata014_carrega_beneficio()
#========================================================================
...
let mr_processo2.prpnumidv      = 0
    ...
    #--------------------------------------------------------
     ...
     open c_bdata014_004 using mr_processo2.empcod

     whenever error continue
     fetch c_bdata014_004 into mr_processo2.empnom
     whenever error stop
    ...
    #--------------------------------------------------------
    open c_bdata014_001 using mr_data.fim         ,
                              mr_processo2.empcod ,
                              mr_data.fim
  
    foreach c_bdata014_001 into mr_processo2.itaciacod
                              , mr_processo2.succod
       ...
       #------------------------------------------------------
       call bdata014_grava_apolice_processada()               
			
			 #------------------------------------------------------  
			 # Recupera o Codigo do Produto       
			 #------------------------------------------------------  
			 let mr_processo2.codprod = bdata014_recupera_produto(mr_processo2.ramcod,mr_processo2.empcod)
       ...
       open c_bdata014_002 using   mr_processo2.empcod ,
                                   mr_processo2.ramcod ,
                                   mr_processo2.clscod ,
                                   mr_processo2.perfil ,
                                   mr_processo2.viginc ,
                                   mr_processo2.viginc  
       whenever error continue
       fetch c_bdata014_002 into   mr_processo2.plnclscod,
       ...
       if sqlca.sqlcode = notfound  then
            ...
            call bdata014_grava_inconsistencia()
       ...
       if bdata014_acessa_inativacao() then
          if bdata014_regra_anterior() then
             call bdata014_carrega_inativacao()
          end if
       end if
       ...
       open c_bdata014_003 using mr_processo2.plnclscod

       foreach c_bdata014_003 into mr_processo2.srvcod                 ,
             ...
             if bdata014_valida_beneficio_processado() then
    ...
    call bdata014_exibe_dados_parciais()
...
#========================================================================
function bdata014_exibe_inicio()
#========================================================================
define l_data  date,
...
let mr_param.hour_ini = current
   ...
   display " "
   display "-------------------------------------------------------------------------"
   display " INICIO bdata014 - CARGA DE APOLICES ITAU AUTO PARA BASE DE BENEFICIO"
   display "-------------------------------------------------------------------------"
   display " "
...
#========================================================================
function bdata014_recupera_dias()
#========================================================================
...
let lr_retorno.cponom = "bdata009_retro"
let lr_retorno.cpocod = 1


  open c_bdata014_007 using  lr_retorno.cponom ,
                             lr_retorno.cpocod
  whenever error continue
  fetch c_bdata014_007 into lr_retorno.cpodes
  whenever error stop
...
#========================================================================
function bdata014_recupera_data_inicio()
#========================================================================

  call bdata014_recupera_dias()
...
#========================================================================
function bdata014_recupera_data_fim()
#========================================================================
...
#========================================================================
function bdata014_recupera_data_validacao()
#========================================================================
...
let lr_retorno.cponom = "bdata014_data"
let lr_retorno.cpocod = 1
...
#========================================================================
   ...
   call bdata014_recupera_data_inicio()
   call bdata014_recupera_data_fim() 
   call bdata014_recupera_data_validacao()
        
  
   let m_mensagem = " CARGA APOLICES RETROATIVO..........: ", mr_data.inicio, " - ", mr_data.fim   
   call bdata014_monta_mensagem2(m_mensagem)
   ...
   while mr_data.inicio <= mr_data.fim
      ...
      call bdata014_carrega_beneficio()
         
      let mr_data.fim = mr_data.fim - 1 units day

      if not bdata014_valida_dia_hora() then
         exit while
      end if
     
   end while
   
   call bdata014_exibe_dados_totais()
...
#========================================================================
function bdata014_exibe_dados_parciais()
#========================================================================
...
#========================================================================
function bdata014_exibe_dados_totais()
#========================================================================
...
#========================================================================
function bdata014_recupera_quebra()
#========================================================================
...
let lr_retorno.cpocod = 1
  ...
  open c_bdata014_007 using  lr_retorno.cponom ,
                             lr_retorno.cpocod
  whenever error continue
  fetch c_bdata014_007 into m_quebra
  whenever error stop
...
#========================================================================
function bdata014_dispara_email()
#========================================================================
...
initialize lr_mail.* to null
    ...
    let lr_mail.para    = bdata014_recupera_email()
    let lr_mail.cc      = ""
    let lr_mail.cco     = ""

    let lr_mail.assunto = "Carga Retroativa Itau RE"

    let lr_mail.mensagem  = bdata014_monta_mensagem()
...
#========================================================================
function bdata014_recupera_email()
#========================================================================
...
let lr_retorno.cponom = "bdata009_email"
  ...
  open c_bdata014_009 using  lr_retorno.cponom
  foreach c_bdata014_009 into lr_retorno.cpodes
...
#========================================================================
function bdata014_monta_mensagem()
#========================================================================
...
#========================================================================
#========================================================================
function bdata014_grava_inconsistencia()
#========================================================================
...
initialize lr_retorno.* to null
   ...
   whenever error continue
   execute p_bdata014_011 using   mr_inconsistencia.empcod
...
#========================================================================
#========================================================================
function bdata014_grava_beneficio()
#========================================================================
...
initialize lr_retorno.* to null
  ...
  let mr_processo2.data_ger = today
   ...
   whenever error continue
   execute p_bdata014_010 using mr_processo2.empcod
...
#========================================================================
function bdata014_monta_mensagem2(l_param)
#========================================================================
...
#------------------------------------------------------------
 function bdata014_recupera_produto(lr_param)                
#------------------------------------------------------------
...
let lr_retorno.cponom = "ctc69m07_prod"                                     
  ...
  open c_bdata014_012 using  lr_retorno.cponom ,                            
                             lr_param.empcod   ,
                             lr_param.ramcod                            
  whenever error continue                                                   
  fetch c_bdata014_012 into lr_retorno.procod                               
  whenever error stop                                                       
...
#======================================================================== 
 function bdata014_valida_dia_hora()
#======================================================================== 
...
#========================================================================
function bdata014_grava_apolice_processada()
#========================================================================
...
initialize lr_retorno.* to null
   ...
   if bdata014_valida_processado() then
...
#========================================================================
 function bdata014_valida_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata014_013 using   mr_inconsistencia.empcod   
                            , lr_retorno.doctipcod
                            , mr_inconsistencia.succod
                            , mr_inconsistencia.ramcod
                            , mr_inconsistencia.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata014_013 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata014_valida_beneficio_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata014_014 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc
                            , mr_processo2.itaciacod
                            , mr_processo2.ramcod
                            , mr_processo2.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata014_014 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata014_valida_beneficio_inativado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata014_017 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc
                            , mr_processo2.itaciacod
                            , mr_processo2.ramcod
                            , mr_processo2.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata014_017 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
function bdata014_regra_anterior()
#========================================================================
...
let lr_retorno.cont = 0    
  ...
  open c_bdata014_015 using   mr_processo2.empcod      ,              
                              mr_processo2.ramcod      ,              
                              mr_processo2.clscod      ,              
                              mr_processo2.perfil      ,              
                              ...
                              mr_processo2.clsviginidat                    
  whenever error continue
  fetch c_bdata014_015 into   lr_retorno.cont                             
  whenever error stop
...
#========================================================================                                                                                                                      
function bdata014_carrega_inativacao()                                             
#========================================================================          
...
initialize lr_retorno.* to null   
     ...
     open c_bdata014_016 using   mr_processo2.empcod      ,          
                                 mr_processo2.ramcod      ,          
                                 mr_processo2.clscod      ,          
                                 mr_processo2.perfil      ,          
                                 mr_processo2.plnclscod   ,          
     ...
     foreach c_bdata014_016 into mr_processo3.plnclscod           
          ...
          open c_bdata014_003 using mr_processo3.plnclscod
          
          foreach c_bdata014_003 into mr_processo3.srvcod                 ,
                ...
                if bdata014_valida_beneficio_inativado() then
                  	let mr_count1.proce = mr_count1.proce + 1
                	  let mr_total.proce  = mr_total.proce + 1
							   	continue foreach
                end if
...
#========================================================================
function bdata014_grava_inativo()
#========================================================================
...
#========================================================================
function bdata014_acessa_inativacao()
#========================================================================
