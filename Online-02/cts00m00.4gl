...
#@INICIALIZADA PELA COMPILADA-NAO APAGAR@#
        ...
        let     l_cidcod = null
        let     l_atnflg = null
        let     l_count_auto = null #Situação local de ocorrência
        let     l_flag_auto    = null #Situação local de ocorrência
...
#--------------------------------------------------------------------
      ...
      if w_cts00m00.emeviacod is not null and w_cts00m00.emeviacod <> 0 then
         ...
         if l_count_auto = 0 then
           ...
           #display "Não É auto!!" #Kelly2 - retirar
         else
           let l_flag_auto = 'S' #Serviço auto
           #display "É auto!!" #Kelly2 - retirar
