...
#-----------------------------------------------------------------------------
 ...
 $prsmsgdstsit = param("prsmsgdstsit");
 $dataini      = param("dataini");
...
#-----------------------------------------------------------------------------
 ...
 if ($prsmsgdstsit eq "") {
    $cabec  = 'NOVAS MENSAGENS';
 }
 else {
    $cabec  = 'HISTÓRICO DE MENSAGENS';
 }
 $texto = 'Para consultar o texto da mensagem, clique sobre o número da mensagem';
...
#-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh ; /webserver/cgi-bin/ct24h/trs/wdatc067.4gc $ARG 2>&1)";
