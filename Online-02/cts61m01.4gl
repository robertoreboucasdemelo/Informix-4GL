...
define m_cts61m01_prep smallint

#--------------------------#
function cts61m01_prepare()
#--------------------------#
 ...
 let l_sql = "select a.atdsrvnum ,"
            ...
            ,"and d.itaaplitmnum = ? "               
            ,"and b.c24astcod = ?"
 prepare p_cts61m01_001 from l_sql
 declare c_cts61m01_001 cursor for p_cts61m01_001
 ...
 prepare p_cts61m01_002 from l_sql
 declare c_cts61m01_002 cursor for p_cts61m01_002 
 ...
 let l_sql = "select a.atdsrvnum ,"
            ...
            ,"and d.itaaplnum = ? "            
            ,"and b.c24astcod = ?"
 prepare p_cts61m01_003 from l_sql
 declare c_cts61m01_003 cursor for p_cts61m01_003	
 	
  
 let m_cts61m01_prep = true

end function


#----------------------------------------#
function cts61m01_qtd_servico(lr_entrada)
#----------------------------------------#
 ...
 if m_cts61m01_prep is null or
    m_cts61m01_prep <> true then        
    call cts61m01_prepare()
 end if
 ...
 let l_mensagem  = null
    ...
    if lr_entrada.itaaplnum is not null then
       ...
       if not cty22g00_verifica_empresarial(lr_entrada.itaasiplncod) then
            ...
            open c_cts61m01_001 using lr_entrada.itaciacod
            ...
            foreach c_cts61m01_001 into lr_servico.*  
                                                   
                   
             call cts61m01_consiste_servico(lr_servico.*,
            ...
            close c_cts61m01_001
       else
       	      
       	    open c_cts61m01_003 using lr_entrada.itaciacod           
       	                             ,lr_entrada.itaramcod           
       	                             ,lr_entrada.itaaplnum           
       	                             ,lr_entrada.c24astcod           
       	                                                             
       	                                                             
       	    foreach c_cts61m01_003 into lr_servico.*                 
...
#---------------------------------------------#
function cts61m01_consiste_servico(lr_entrada)
#---------------------------------------------#
 define lr_entrada record
 ...
 if l_resultado = 1 then 
    ...
    open c_cts61m01_002 using lr_entrada.atdsrvnum,
                              lr_entrada.atdsrvano,
                              lr_entrada.socntzcod
    fetch c_cts61m01_002 into l_qtde
    whenever error stop 
