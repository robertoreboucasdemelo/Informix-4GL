...
$prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; DBMONEY=,;export DBMONEY;wdatc017.4gc $ARG 2>&1; /webserver/cgi-bin/ct24h/trs/wdatc042.4gc $ARG 2>&1)";
...
$onload = "";
push @rodape, &rodape_btn_imprimir(@impressao);
