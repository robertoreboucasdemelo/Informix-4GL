...
#----------------------------------------------------------------------------#
#                                                                            #
#  Alteracao: Fornecer novas informações aos prestadores.                    #
#  Referente: OSF 19690                                                      #
...
$atdetpcod = param("atdetpcod");


#-------------------------------
# Montando parametros para o 4GL
#-------------------------------
push @ARG,$usrtip,$webusrcod,$sesnum,$macsissgl,$de,$ate,$atdsrvorg,$atdetpcod;
...
{
 var dias=0;
  dias = subtrai_datas(document.wdatc030.de.value, document.wdatc030.ate.value);
//   alert(document.wdatc030.de.value);
//   alert(document.wdatc030.ate.value);

 if ( dias > 15 ){
   alert('Período da consulta deve ter no máximo 15 dias');
   return false;
 }
 else {
  // alert (dias);
   document.wdatc030.submit();
 }
}
//-->
</script>
END
 ...
 #-----------------------------------------------------------------------------
#$cabec  = 'CONSULTAR SERVIÇOS'; OSF 19690
 $cabec  = 'CONSULTAR SITUAÇÃO';
...
#push @ARG, $padrao;
 ...
 #-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; /webserver/cgi-bin/ct24h/trs/wdatc031.4gc $ARG 2>&1)";
...
open (PROG, "$prog |") || die ("N\343o foi poss\355vel executar $prog: $!\n");
 ...
 #-----------------------------------------------------------------------------
#$texto    = 'Consulte os serviços e complementos recebidos pela sua empresa. Caso queira consultar informações mais detalhadas, clique sobre o número do serviço.'; OSF 19690

 $texto    = 'Consulte os serviços e complementos não aceitos. Caso queira consultar informações mais detalhadas, clique sobre o número do serviço.';
 ...
 start_form(-method=>'POST',
            -name=>'wdatc030',
            -action=>"/cgi-bin/ct24h/trs/wdatc030.pl",
