...
#$macsissgl = 'XXX';
#$usrtip    = '12';
#$datainicial = '10/10/2003';
#$datafinal   = '11/10/2003';
#$fase        = '1';
#$evento      = '1';
 ...
 #-------------------------------
 push @ARG,$usrtip,$webusrcod,$sesnum,$macsissgl,$datainicial,$datafinal,$fase,$evento;

 #-----------------------------------------------------------------------------
 # Carregando parametros recebidos
 #-----------------------------------------------------------------------------
 $cabec  = 'SERVIÇOS BLOQUEADOS';
 ...
 #-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; /webserver/cgi-bin/ct24h/trs/wdatc059.4gc $ARG 2>&1)";
