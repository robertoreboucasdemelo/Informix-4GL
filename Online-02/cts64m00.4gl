...
#---------------------------------------------------------------------------#
#23/03/2016 SPR-2016-03858  - Carro Reserva Itaú, fase II                   #
#---------------------------------------------------------------------------#
#25/04/2016 Alberto Rodrigues Carro Reserva Itaú, alterado de 5% para 12%   #
#---------------------------------------------------------------------------#
          ...
          if d_cts64m00.c24astcod = "I07" or
             ...
             if d_cts64m00.avialgmtv is not null then
                ...
                if l_flag = false then
                   error "Motivo não permitido para este plano" sleep 1
                   next field avialgmtv
                end if
              end if
          end if
   ...
   after  field avivclcod
          ...
          if d_cts64m00.avialgmtv <> 8 then
             ...
             call cts08g01("A",
                           ...
                           "MAIS INFORMAÇOES TRANSFERIR PARA CENTRAL",
                           "DE SINISTRO.")
             returning ws.confirma     
...
function cts64m00_dados_sinistro()
  ...
  if lr_dados.sindat is null then
     error " Não foram localizados dados do processo Itau ! "
  else
