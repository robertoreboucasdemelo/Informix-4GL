...
push @ARG,$usrtip,$webusrcod,$sesnum,$macsissgl,$mdtmvtcod;
...
#----------------------------
$prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvar.sh; wctn01m01.4gc $ARG)";
               ...
               table({-border=>'0',-width=>'550',-cellpadding=>'0',-cellspacing=>'0'},
                    Tr(
                      td(img {-src=>'/corporat/images/logo_porto.gif',-width=>'173',-height=>'18',-alt=>'Porto Seguro'},
                         img {-src=>'/auto/images/ramo_psocorro.gif',-alt=>'Porto Socorro'}
                        ),"\n",
                    ...
                    Tr(
                      td(img {-src=>'/corporat/images/img_transp.gif',-width=>'180',-height=>'14',-border=>'0'},
                         font({-face=>'ARIAL,HELVETICA,VERDANA',-size=>'2',-color=>'#6484BF'},b('POSIÇÃO DA FROTA - SINAL'))
                        ),"\n",
                      ),"\n",
                    Tr(
