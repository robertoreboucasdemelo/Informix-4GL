...
#$ambiente = "remsh aplweb01 -l runwww ";
 ...
 $etpmtvcod = param("etpmtvcod");
 $srvobs    = param("srvobs");

#-------------------------------
# Montando parametros para o 4GL
#-------------------------------
push @ARG,$usrtip,$webusrcod,$sesnum,$macsissgl,$atdsrvnum,$atdsrvano,$etpmtvcod,$srvobs;
...
#print header, start_html,$ARG;
 ...
 #-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; /webserver/cgi-bin/ct24h/trs/wdatc029.4gc $ARG 2>&1)";
...
#$prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; wctn03m00.4gc $ARG 2>&1)";
