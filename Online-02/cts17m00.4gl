...
#                            OSF28851   alerta                               #
#----------------------------------------------------------------------------#
# 24/05/2004  Marcio - FSW   CT-191264 Acesso a tabela datmligação           #
...
#----------------------------------------------------------------------------#
# 13/04/2011 Robert Lima    PSI 05440 Abertura da agenda para serviços prog  #
 ...
 input by name d_cts17m00.nom      ,
   ...
   before field imdsrvflg
    ...
    after field imdsrvflg
                ...
                if d_cts17m00.imdsrvflg = "S"  then
                    ...
                    if w_cts17m00.atddatprg <> l_data or w_cts17m00.atdhorprg <> l_hora then
                       ...
                       if l_tem_cota = false then
                          error "Não existe cota para horario informado"
                          sleep 2
          ...
          # CORREÇÃO PROBLEMA ACIONANDO SOCORRISTAS MESMO
          # QUANDO A FLAG DE IMEDIATIO ESTÁ COMO 'N'      - BURINI
   ...
   on key (interrupt)
      ...
      #PSI 202363 - se interrompeu laudo, mas está com prestador bloqueado
      if g_documento.atdsrvnum is null  and
         g_documento.atdsrvano is null  then
...
#=========================================================
 ...
 #-----------------
  ...
  #------------------------------------------------------------------------#
  # Essa implementação foi realizada devido ter ocorrido uma gravação na   #
...
#--------------------------------------------------------------------------
   ...
   # Regra estava impedindo alteração do laudo de programado para imediato # CT-678783
