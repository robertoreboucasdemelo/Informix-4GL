...
#                            envio serviço de apoio e inclusao de mais        #
#                            ocorrencias.                                     #
...
#-----------------------------------------------------------------------------#
#05/02/2016 - Josiane Almeida       Inclusão de endereço de correspondencia   #
#                                   na tecla F5                               #
#-----------------------------------------------------------------------------#
          ...
          if g_documento.acao = "INC" then
             ...
             if lr_retcli.coderro = false then
                ...
                prompt "Erro ao Consultar Cadastro de Clientes - Avise ",
                       "Informática " for char l_prompt_key
             end if
...
#--------------------------------------------------------------------
  ...
  if ws.cogidosql <> 0  then
     error "Endereco Correspondencia Não Encontrado. Assumindo Endereco de Ocorrencia "
     # Informacoes do local da ocorrencia
     call ctx04g00_local_gps(cpl_atdsrvnum, cpl_atdsrvano, 1)
                   returning a_cts71m00[2].lclidttxt   ,
                             a_cts71m00[2].lgdtip      ,
