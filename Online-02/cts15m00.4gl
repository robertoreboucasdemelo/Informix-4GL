...
#---------------------------------------------------------------------------#
# 25/03/2003  PSI169277/OSF14966 Paula  Implementação de uma nova critica   #
...
#---------------------------------------------------------------------------#
# 17/11/2010 Amilton, Meta                Integração localiza webservice    #
...
#--------------------------------------------------------------------
 ...
 #PSI 205206 - caso global de empresa não está setada (entrar no servico pelo rádio)
         ...
         if m_reserva.loccntcod is not null then
            if d_cts15m00.avialgmtv = 5 then
               call cts08g01("A","S","","VEICULO ENTREGUE AO CLIENTE",
                                        ...
                                        "MOTIVO DE LOCAÇÃO DESEJA ALTERAR ? ")
                  returning ws.confirma
               if ws.confirma = "S" then
...
####      end if
   ...
   after  field avialgmtv
          ...
          #======================================================
          # Busca da Ultima Situação da Apolice
          #======================================================
             ...
             if m_clcdat >= "01/07/2003" then
                ...
                if d_cts15m00.avialgmtv     = 1    and
                   w_cts15m00.clscod26[1,2] is null then
                     error "Motivo não relacionado a clausula contratada !"
                     next field avialgmtv
                end if
                            ...
                            if l_endosso = false then
                             ...
                             if l_endosso = false then
                                call cts08g01("A","N",
                                              ...
                                              "SEM DIREITO A LOCAÇÃO PARA SINISTRO DE ",
                                              " PERDA PARCIAL")
                             else
                                call cts08g01_6l("A","N",
             ...
             if ws.endcep is null  or
               ...
               if d_cts15m00.avialgmtv = 5    and
                  ...
                  if w_cts15m00.clscod26 = "26H" or
                     ...
                     let l_linha2 = " INTENÇÃO DE REVERSAO PARA MOTIVO"
   ...
   after  field lcvextcod
          ...
          if ws.prtaertaxvlr is not null and
             ...
             # Localiza e motivo particular apresenta o alerta. 09/04/2007
               ...
               # E-Mail da Cibele de confirmação em :-18/06/2014 09:13
               # Pasta \\pfs01\DOC_MDS\Central 24 Horas\Atendimento Segurado\Documentação de Projeto\ST-2014-00013-Tarifa Porto Auto Mar 2014\AlertaCarroExtra
...
#--------------------------------------------------------------#
  ...
  whenever error stop
         ...
         if sqlca.sqlcode <> 0 then
            ...
            let l_bloco.mens1 = "Numero do Serviço : ", l_var.atdsrvorg using '&&', "/",
...
function cts15m00_verifica_endosso()
   ...
   foreach ccts15m00034 into l_edstip,
       ...
       if l_edstip = 0 or
          (l_edstip = 1 and l_edstxt = 1 ) or # 1/1 inclusão de item
          (l_edstip = 2 and l_edstxt = 2 ) or # 2/2 Substituição de Veiculo
          (l_edstip = 3 and l_edstxt = 63 ) then # 3/63 Inclusão de clausula
