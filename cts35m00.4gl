     ...
     if cty42g00_automatico() then
      ...
      if l_datmcntsrv.atdsrvnum is not null then  # SERVICO CARGA DO IFX
         ...
         if sqlca.sqlcode <> 0 then
            ...
            if sqlca.sqlcode <> 0 then
               display 'erro: ', sqlca.sqlcode, 'serviço: ',l_datmcntsrv.seqreg
            end if
            whenever error stop
...
####Alterar tipo de verificação#######
      ...
      if l_datmcntsrv.atdsrvnum is null  then
         ...
         #Não há pesquisa de apólice para SAPS
...
#@INICIALIZADA PELA COMPILADA-NAO APAGAR@#
  ...
  if l_remetentes is null or
     l_remetentes = " " then
      ...
      let msg.linha1 = "NÃO EXISTEM EMAILS CADASTRADOS"
