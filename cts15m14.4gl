...
#-----------------------------------------------------------------------------#
# 27/12/2012 Luiz, BRQ PSI-2012-26565/EV  Alteração é criar um link concate-  #
#                                         nar os atributos localizados no ban-#
#                                         co de dados referente ao Serviço/Lo-#
#                                         cadora a fim de sensibilizar o res- #
#                                         ponsável na loja da Locadora que    #
...
#-----------------------------------------------------------------------------#
# 03/09/2013 Issamu                      inclusão da chamada do fax via       #
#                                        right fa                             #
#                                                                             #
#                                                                             #
#-----------------------------------------------------------------------------#
...
# Fim Alteração - Fabrica BRQ - Luiz Gustavo - PSI-2012-26565/EV
    ...
    if lr_param.enviar = "E" or  lr_param.enviar = "I" then 
       ...
       output to report cts15m14_impressao(lr_param.enviar
                                          ...
                                          ,l_c24soltipdes
                                          ,lr_param.execucao
                                          ,m_ciaempcod  # Inicio Alteração - Fabrica BRQ - Luiz Gustavo - PSI-2012-26565/EV
                                          ,l_result       )# Fim Alteração - Fabrica BRQ - Luiz Gustavo - PSI-2012-26565/EV
...
#-----------------------------------
 ...
 if lr_param.acao <> 2 then
    ...
    if lr_retorno.c24astcod is null then
       display "PADRAO@@1@@B@@C@@0@@Autorizamos a locação do veículo conforme as seguintes condições@@"
    else
       display "PADRAO@@1@@B@@C@@0@@Cancelamos a locação do veículo conforme as seguintes condições@@"
    end if

    if lr_param.ciaempcod = 1  or   #Porto
       lr_param.ciaempcod = 50 then #Saude
       display "PADRAO@@1@@B@@C@@0@@Laudo do serviço@@"
    else if lr_param.ciaempcod = 35 then #Azul
            display "PADRAO@@1@@B@@C@@0@@Laudo do serviço - AZUL SEGUROS@@"
         else
            if lr_param.ciaempcod = 43 and l_psaerrcod = 0   #--> PSI-2013-06224/PR
               then
               display "PADRAO@@1@@B@@C@@0@@Laudo de Serviços Avulsos Porto Seguro@@"
            end if
         end if
    end if

    if lr_retorno.c24astcod is null then
       display "PADRAO@@8@@Número do  serviço@@", lr_param.atdsrvnum using "<<<<<<<<<<","/", lr_param.atdsrvano using "&&", "@@"
    else
       display "PADRAO@@8@@Número do  serviço@@", lr_param.atdsrvnum using "<<<<<<<<<<","/", lr_param.atdsrvano using "&&", "  CANCELADO@@"
    end if

    display "PADRAO@@1@@B@@C@@0@@Dados do Locatário@@"

    display "PADRAO@@8@@Segurado@@", lr_param.nom, "@@"

    display "PADRAO@@8@@Usuário@@", lr_param.avilocnom, "@@"
    ...
    display "PADRAO@@1@@B@@C@@0@@Dados do veículo preferencial@@"

    display "PADRAO@@8@@Grupo@@", lr_param.avivclgrp,'-', lr_param.avivcldes, "@@"
    display "PADRAO@@8@@Veículo@@", lr_param.descricao, "@@"

    display "PADRAO@@8@@Condição@@", lr_param.condicao, "@@"
    ...
    display "PADRAO@@8@@Previsão de uso@@", lr_param.aviprvent using '&&', ' Dia(s)', "@@"

    display "PADRAO@@1@@B@@C@@0@@Considerações importantes@@"

    display "PADRAO@@1@@N@@L@@1@@- COMBUSTÍVEL, HORAS E TAXAS EXTRAS (PROTEÇÃO OPCIONAL) POR CONTA DO USUÁRIO.@@"

    display "PADRAO@@1@@N@@L@@1@@- APÓS O RECEBIMENTO DESTE, A LOCADORA DISPÕE DE 0:20 MIN. PARA NEGAR A RESERVA POR FALTA DE VEÍCULOS.@@"
    ...
    case lr_param.avirsrgrttip
       when 1
         display "PADRAO@@1@@N@@L@@1@@- LOCAÇÃO SERÁ FEITA ATRAVÉS DE CARTÃO DE CRÉDITO@@"
       when 2
         display "PADRAO@@1@@N@@L@@1@@- LOCAÇÃO SERÁ FEITA ATRAVÉS DE CHEQUE CAUÇÃO@@"
    end case

    if lr_param.cdtoutflg is not null  and
       lr_param.cdtoutflg = "S" then
       display "PADRAO@@1@@N@@L@@1@@- PARA ESTA LOCAÇÃO HAVERÁ SEGUNDO(S) CONDUTOR(ES)@@"
    end if
    ...
    if lr_param.adcsgrtaxvlr is not null and
       ...
       if lr_param.lcvcod = 2  and lr_param.lcvregprccod = 2  then
          ...
          ### INIBIDO CONFORME SOLICITACAO DA SILMARA - 18/08/06 - Lucas Scheid
          ### display "PADRAO@@1@@N@@L@@1@@- A LOJA NÃO OPERA COM TAXA DE ISENÇÃO DE FRANQUIA@@"

          display "PADRAO@@1@@N@@L@@1@@- A LOJA NÃO OPERA COM TAXA DE ISENÇÃO NA PARTICIPAÇÃO EM CASO DE SINISTRO@@"

       else
          ### INIBIDO CONFORME SOLICITACAO DA SILMARA - 18/08/06 - Lucas Scheid
          ###display "PADRAO@@1@@N@@L@@1@@- A LOCADORA OFERECERÁ TAXA DE ISENÇÃO DE FRANQUIA (COBERTURA DE RISCO),@@"
          ###display "PADRAO@@1@@N@@L@@1@@  OPTATIVA, AO CUSTO DE R$ ",  lr_param.adcsgrtaxvlr using "<<<,<<&.&&", "/DIA.@@"

          display "PADRAO@@1@@N@@L@@1@@- A LOCADORA OFERECERÁ TAXA DE ISENÇÃO NA PARTICIPAÇÂO EM CASO DE SINISTRO@@"
          display "PADRAO@@1@@N@@L@@1@@  (COBERTURA DE RISCO), OPTATIVA, AO CUSTO DE R$ ",  lr_param.adcsgrtaxvlr using "<<<,<<&.&&", "/DIA.@@"

       end if
    end if

    display "PADRAO@@1@@B@@C@@0@@Prorrogações@@"
    ...
    for l_i = 1 to 50
       ...
       display "PADRAO@@1@@N@@L@@1@@    AS ", am_cts36g01[l_i].aviprosolhor,"@@"
        ...
        display "PADRAO@@1@@N@@L@@1@@DATA DE PRORROGAÇÃO: ", am_cts36g01[l_i].vclretdat, "@@"
        display "PADRAO@@1@@N@@L@@1@@HORA DE PRORROGAÇÃO: ", am_cts36g01[l_i].vclrethor, "@@"
        display "PADRAO@@1@@N@@L@@1@@PREVISÃO DE USO....: ", am_cts36g01[l_i].aviprodiaqtd using "<<<<<<", " DIA(S)", "@@"
    ...
    if lr_retorno.c24astcod is null then
       display "PADRAO@@10@@1@@2@@1@@B@@C@@M@@4@@3@@2@@100%@@Autorizamos a locação do veículo conforme as seguintes condições@@@@"
    else
       display "PADRAO@@10@@1@@2@@1@@B@@C@@M@@4@@3@@2@@100%@@Cancelamos a locação do veículo conforme as seguintes condições@@@@"
    end if

    if lr_param.ciaempcod = 1  or   #Porto
       lr_param.ciaempcod = 50 then #Saude
       display "PADRAO@@10@@1@@2@@1@@B@@C@@M@@4@@3@@2@@100%@@Laudo do serviço@@@@"
    else if lr_param.ciaempcod = 35 then #Azul
            display "PADRAO@@10@@1@@2@@1@@B@@C@@M@@4@@3@@2@@100%@@Laudo do serviço - AZUL SEGUROS@@@@"
         else
            if lr_param.ciaempcod = 43 and l_psaerrcod = 0   #--> PSI-2013-06224/PR
               then
               display "PADRAO@@10@@1@@2@@1@@B@@C@@M@@4@@3@@2@@100%@@Laudo de Serviços Avulsos Porto Seguro@@@@"
            end if
         end if
    end if

    if lr_retorno.c24astcod is null then
       display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@025%@@Número do  serviço@@@@N@@L@@M@@4@@3@@1@@075%@@", lr_param.atdsrvnum using "<<<<<<<<<<","/", lr_param.atdsrvano using "&&", "@@@@"
    else
       display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@025%@@Número do  serviço@@@@N@@L@@M@@4@@3@@1@@075%@@", lr_param.atdsrvnum using "<<<<<<<<<<","/", lr_param.atdsrvano using "&&", "  CANCELADO@@"
    end if

    display "PADRAO@@10@@1@@2@@1@@B@@C@@M@@4@@3@@2@@100%@@Dados do Locatário@@@@"
    display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@025%@@Segurado@@@@N@@L@@M@@4@@3@@1@@075%@@", lr_param.nom, "@@@@"

    display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@025%@@Usuário@@@@N@@L@@M@@4@@3@@1@@075%@@", lr_param.avilocnom, "@@@@"
    ...
    display "PADRAO@@10@@1@@2@@1@@B@@C@@M@@4@@3@@2@@100%@@Dados do veículo preferencial@@@@"

    display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@025%@@Grupo@@@@N@@L@@M@@4@@3@@1@@075%@@", lr_param.avivclgrp,'-', lr_param.avivcldes, "@@@@"

    display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@025%@@Veículo@@@@N@@L@@M@@4@@3@@1@@075%@@", lr_param.descricao, "@@@@"

    display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@025%@@Condição@@@@N@@L@@M@@4@@3@@1@@075%@@", lr_param.condicao, "@@@@"
    ...
    display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@025%@@Previsão de uso@@@@N@@L@@M@@4@@3@@1@@075%@@", lr_param.aviprvent using '&&', ' Dia(s)', "@@@@"

    display "PADRAO@@10@@1@@2@@1@@B@@C@@M@@4@@3@@2@@100%@@Considerações importantes@@@@"

    display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@- COMBUSTÍVEL, HORAS E TAXAS EXTRAS (PROTEÇÃO OPCIONAL) POR CONTA DO USUÁRIO.@@@@"

    display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@- APÓS O RECEBIMENTO DESTE, A LOCADORA DISPÕE DE 0:20 MIN. PARA NEGAR A RESERVA POR FALTA DE VEÍCULOS.@@@@"
    ...
    case lr_param.avirsrgrttip
       when 1
         display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@- LOCAÇÃO SERÁ FEITA ATRAVÉS DE CARTÃO DE CRÉDITO@@@@"
       when 2
         display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@- LOCAÇÃO SERÁ FEITA ATRAVÉS DE CHEQUE CAUÇÃO@@@@"
    end case

    if lr_param.cdtoutflg is not null  and
       lr_param.cdtoutflg = "S" then
       display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@- PARA ESTA LOCAÇÃO HAVERÁ SEGUNDO(S) CONDUTOR(ES)@@@@"
    end if
    ...
    if lr_param.adcsgrtaxvlr is not null and
       ...
       if lr_param.lcvcod = 2  and lr_param.lcvregprccod = 2  then
          ...
          ### INIBIDO CONFORME SOLICITACAO DA SILMARA - 18/08/06 - Lucas Scheid
          ### display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@- A LOJA NÃO OPERA COM TAXA DE ISENÇÃO DE FRANQUIA@@@@"

          display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@- A LOJA NÃO OPERA COM TAXA DE ISENÇÃO NA PARTICIPAÇÃO EM CASO DE SINISTRO@@@@"

       else
          ### INIBIDO CONFORME SOLICITACAO DA SILMARA - 18/08/06 - Lucas Scheid
          ### display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@- A LOCADORA OFERECERÁ TAXA DE ISENÇÃO DE FRANQUIA (COBERTURA DE RISCO),@@@@"
          ### display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@  OPTATIVA, AO CUSTO DE R$ ",  lr_param.adcsgrtaxvlr using "<<<,<<&.&&", "/DIA.@@@@"

          display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@- A LOCADORA OFERECERÁ TAXA DE ISENÇÃO NA PARTICIPAÇÃO EM CASO DE SINISTRO@@@@"
    ...
    display "PADRAO@@10@@1@@2@@1@@B@@C@@M@@4@@3@@2@@100%@@Prorrogações@@@@"
    ...
    for l_i = 1 to 50
       ...
       display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@    AS ", am_cts36g01[l_i].aviprosolhor,"@@@@"
        ...
        display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@DATA DE PRORROGAÇÃO: ", am_cts36g01[l_i].vclretdat, "@@@@"

        display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@HORA DE PRORROGAÇÃO: ", am_cts36g01[l_i].vclrethor, "@@@@"

        display "PADRAO@@10@@2@@2@@0@@N@@L@@M@@4@@3@@1@@0%@@@@@@N@@L@@M@@4@@3@@1@@100%@@PREVISÃO DE USO....: ", am_cts36g01[l_i].aviprodiaqtd using "<<<<<<", " DIA(S)", "@@@@"
