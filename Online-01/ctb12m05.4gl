###############################################################################
# Nome do Modulo: ctb12m05                                           Marcelo  #
#                                                                    Gilberto #
# Exibe as ordens de pagto. encontradas para uma O.S.                Out/1997 #
###############################################################################

database porto

#-----------------------------------------------------------
 function ctb12m05(param)
#-----------------------------------------------------------
 ...
 define a_ctb12m05 array[10] of record
    socopgnum      like dbsmopg.socopgnum,
    socopgsitdes   char (15),
    socfatentdat   like dbsmopg.socfatentdat
 end record

 initialize a_ctb12m05 to null
 initialize ws.*       to null

 let arr_aux = 1

 declare c_ctb12m05 cursor for
 ...
 foreach c_ctb12m05 into a_ctb12m05[arr_aux].socopgnum,
                         ws.socopgsitcod,
                         a_ctb12m05[arr_aux].socfatentdat

    let a_ctb12m05[arr_aux].socopgsitdes = "**NAO PREVISTA**"

    select cpodes
      into a_ctb12m05[arr_aux].socopgsitdes
      from iddkdominio
 ...
 if arr_aux = 1  then
    ...
    if arr_aux = 2  then
       ...
       open window ctb12m05 at 08,12 with form "ctb12m05"
       ...
       display array a_ctb12m05 to s_ctb12m05.*
 ...
 return a_ctb12m05[arr_aux].socopgnum

end function  ###  ctb12m05
