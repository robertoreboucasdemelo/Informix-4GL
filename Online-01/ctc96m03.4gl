...
#============================
 ...
 let l_sql =   '  insert into datkitaclisgmre (       itaclisgmcod ,    '
                                            ,'      itaclisgmdes ,    '                                            
                                            ,'      atlusrtip  ,      '
                                            ,'      atlemp     ,      '
                                            ,'      atlmat     ,      '
 ...
 let l_sql =   '  update datkitaclisgmre  set     itaclisgmdes  = ?  ,      '                                          
                                          ,'    atlusrtip  = ?     ,      '
                                          ,'    atlemp     = ?     ,      '
                                          ,'    atlmat     = ?     ,      '
                                          ,'    atldat     = ?            '
 ...
 let l_sql =  'delete datkitaclisgmre      '
              ,'where itaclisgmcod  = ?  '
 ...
 let l_sql =  '  select first 1 itasegtipcod    '
             ,'    from datmitaaplre              '
             ,'   where itasegtipcod  =  ?      '
...
#==============================
  ...
  open window w_ctc96m01 at 6,2 with form 'ctc96mxx'
  ...
  while true
    ...
    input array a_ctc96m01 without defaults from s_ctc96mxx.*
        ...
        #--------------------
               ...
               if a_ctc96m01[arr_aux].codigo is null then
                  ...
                  display a_ctc96m01[arr_aux].* to s_ctc96mxx[scr_aux].* attribute(reverse)
        ...
        #--------------------
         after field codigo
        #--------------------
              display a_ctc96m01[arr_aux].* to s_ctc96mxx[scr_aux].*
              
              if fgl_lastkey() = fgl_keyval("up")     or
                 fgl_lastkey() = fgl_keyval("left")   then
                 let a_ctc96m01[arr_aux].codigo = ''
                 display a_ctc96m01[arr_aux].codigo to s_ctc96mxx[scr_aux].codigo
        ...
        #-------------------------
            ...
            # Retirar espaços em branco a esqeurada e a direita
              let a_ctc96m01[arr_aux].descricao = fungeral_trim(a_ctc96m01[arr_aux].descricao)
              display a_ctc96m01[arr_aux].descricao to
                      s_ctc96mxx[scr_aux].descricao
            # -
     ...
     if l_descricao <> a_ctc96m01[arr_aux].descricao then
          ...
          #  returning m_confirma
           ...
           if m_confirma = "S" then
              ...
              display a_ctc96m01[arr_aux].descricao to s_ctc96mxx[scr_aux].descricao           
           end if
     end if
...
define l_cod char(4)
   ...
   call fungeral_func(r_ctc96m01.atlemp, r_ctc96m01.atlmat)
