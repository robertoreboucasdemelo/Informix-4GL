...
#$ambiente = "remsh aplweb01 -l runwww ";
 ...
 #-----------------------------------------------------------------------------
#$cabec  = 'RECEBER SERVIÇOS - COMPLEMENTO';
...
#   { &wissc219_mensagem($titgif,$cabec,"LOGIN","Código do padrão não informado!"); }
 ...
 #-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; /webserver/cgi-bin/ct24h/trs/wdatc021.4gc $ARG 2>&1)";
...
open (PROG, "$prog |") || die ("N\343o foi poss\355vel executar $prog: $!\n");
 ...
 #-----------------------------------------------------------------------------
 $texto    = 'Consulte as informaçoes sobre o complemento de serviço.';
 ...
 if ($acao == 1)
    ...
    {
      $cabec  = 'CONSULTAR SERVIÇOS - COMPLEMENTO';
    }
