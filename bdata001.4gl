...
# ---------- -------------- ----------    ---------------------------------------#
# 14/04/2015 Marcos Goes                  Modificacao do mecanismo de loop da    #
...
#========================================================================
   ...
   display "##################################"
   if not bdata001_recupera_quebra() then
      exit program
   end if  
   ...
   if bdata001_valida_carga() then
      ...
      call bdata001_atualiza_full()      
   end if
     
   ####################
   ### CARGA DIARIA ###
   ####################
   if not bdata001_carga_diaria() then
      exit program
   end if
...
define l_sql char(10000)
   ...
   declare c_bdata001_003 cursor for p_bdata001_003
   ...
   declare c_bdata001_005 cursor with hold for p_bdata001_005
   ...
   declare c_bdata001_006 cursor with hold for p_bdata001_006
   ...
   declare c_bdata001_007 cursor with hold for p_bdata001_007
   ...
   declare c_bdata001_009 cursor with hold for p_bdata001_009
   ...
   declare c_bdata001_010 cursor with hold for p_bdata001_010
   ...
   declare c_bdata001_012 cursor with hold for p_bdata001_012
   ...
   let l_sql = ' select count(*)        '
              ,' from datkdominio     '
              ,' where cponom =  ?    '
   prepare p_bdata001_028 from l_sql
   declare c_bdata001_028 cursor for p_bdata001_028
   ...
   let l_sql = " insert into datmbnfcrgmov             "
             ...
             ," values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,? "
             ,"  ,?,?,?,?,?)                          "
   prepare p_bdata001_029 from l_sql
   ...
   let l_sql = ' insert into datmbnfcrgico             '
             ...
             ,'  ,?,?,?,?,?,?,?,?,?,?,?,?,?            '
             ,'  ,?,?,?,?,?,?,?  )                     '
   prepare p_bdata001_030 from l_sql
   ...
   let l_sql = ' select cpodes[8,12]     '  
              ...
              ,' and   cpodes[1,2] =  ?  '
              ,' and   cpodes[4,6] =  ?  '             
   prepare p_bdata001_031  from l_sql                
   declare c_bdata001_031  cursor for p_bdata001_031
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctseqnum =  ? '
              ,' and   dctemsdat =  ? '              
   prepare p_bdata001_032 from l_sql
   declare c_bdata001_032 cursor for p_bdata001_032
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctclscod =  ? '
              ,' and   pcmflg in ("S","N") '                
   prepare p_bdata001_033 from l_sql
   declare c_bdata001_033 cursor for p_bdata001_033 	
   ...
   let l_sql = ' select count(*)      '
              ...
              ,' and   dctclscod =  ? '
              ,' and   pcmflg in ("R","E") '                
   prepare p_bdata001_034 from l_sql
   declare c_bdata001_034 cursor for p_bdata001_034 
...
let mr_inconsistencia.dtger     = today
    ...
    foreach c_bdata001_005 into mr_processo2.emsdat
       ...
       #-------------------------------------------------------
        ...
        #------------------------------------------------------  
        call bdata001_grava_apolice_processada()                 
        ...
        if mr_processo2.cgccpfnum is null then
           ...
           call bdata001_grava_inconsistencia()
        ...
        foreach c_bdata001_010 into mr_processo2.clscod
             ...
             if not bdata001_valida_geracao_claus(mr_processo2.clscod) then
             ...
             #------------------------------------------------------  
             let mr_processo2.codprod = bdata001_recupera_produto(mr_processo2.ramcod,mr_processo2.empcod)             
             ...
             if bdata001_acessa_inativacao() then
                if bdata001_regra_anterior() then
                   call bdata001_carrega_inativacao()
                end if
             end if
             ...
             foreach c_bdata001_012 into mr_processo2.srvcod                 ,
                   ...
                   if bdata001_valida_beneficio_processado() then
...
let mr_param.hour_ini = current
   ...
   display " "
   display "-----------------------------------------------------------"
   display " INICIO bdata001 - CARGA DE APOLICES PARA BASE DE BENEFICIO"
   display "-----------------------------------------------------------"
   display " "
...
#========================================================================
#========================================================================
function bdata001_valida_geracao_claus(lr_param)
#========================================================================
...
let l_count = 0
  open c_bdata001_028 using  lr_retorno.cponom
  whenever error continue
  fetch c_bdata001_028 into l_count
  whenever error stop
  if l_count > 0 then
...
#========================================================================
   ...
   call bdata001_recupera_data_diaria()
   ...
   while mr_data.inicio <= mr_data.fim
      ...
      call bdata001_atualiza_data_diaria()
...
#========================================================================
function bdata001_recupera_data_diaria()
#========================================================================
...
let lr_retorno.cponom = "bdata001_diaria"
let lr_retorno.cpocod = 1
...
#========================================================================
   ...
   while mr_data.inicio <= mr_data.fim
      ...
      call bdata001_atualiza_data_full()

      call bdata001_carrega_beneficio()
         
      let mr_data.inicio = mr_data.inicio + 1 units day
      
      if not bdata001_valida_dia_hora() then
         exit while
      end if
...
#========================================================================
function bdata001_atualiza_data_full()
#========================================================================
...
#========================================================================
function bdata001_atualiza_data_diaria()
#========================================================================
...
#========================================================================
function bdata001_atualiza_full()
#========================================================================
...
initialize lr_retorno.* to null
  ...
  if lr_param.dt_cal < '01/02/2014' then
   ...
   if bdata001_valida_segmento_moto(lr_param.ctgtrfcod) then    
   ...
   if bdata001_valida_segmento_taxi(lr_param.ctgtrfcod) then
   ...
   if bdata001_valida_segmento_caminhao(lr_param.ctgtrfcod) then
   ...
   #if bdata001_valida_segmento_premium(lr_retorno.idade,
   ...
   if lr_param.pestip = "F" then
         ...
         #----------------------------------#
      	 ...
      	 if bdata001_valida_segmento_mulher(lr_retorno.idade,
      	 ...
      	 if bdata001_valida_segmento_jovem(lr_retorno.idade) then
      	 ...
      	 if bdata001_valida_segmento_senior(lr_retorno.idade) then
...
initialize lr_mail.* to null
    ...
    let lr_mail.assunto = "Carga Base Beneficios - Porto Auto Apolice"
...
#========================================================================
#========================================================================
function bdata001_grava_inconsistencia()
#========================================================================
define lr_retorno record
  status  char(3000)
end record
initialize lr_retorno.* to null
   whenever error continue
   execute p_bdata001_030 using   mr_inconsistencia.empcod
...
#========================================================================
#========================================================================
function bdata001_grava_beneficio()
#========================================================================
define lr_retorno record
  status  char(30000)
end record         
...
initialize lr_retorno.* to null
  ...
  let mr_processo2.data_ger = today
   ...
   whenever error continue
   execute p_bdata001_029 using mr_processo2.empcod
...
#========================================================================                                       
 function bdata001_valida_segmento_moto(lr_param)                              
#========================================================================                                     
...
#========================================================================                                                                                          
 function bdata001_valida_segmento_taxi(lr_param)                       
#========================================================================                      
...
#========================================================================                                                                                  
 function bdata001_valida_segmento_caminhao(lr_param)                       
#========================================================================                       
...
#========================================================================                    
 function bdata001_valida_segmento_premium(lr_param)                        
#========================================================================                      
...
#========================================================================                  
 function bdata001_valida_segmento_mulher(lr_param)                         
#========================================================================                      
...
#========================================================================                       
 function bdata001_valida_segmento_jovem(lr_param)                          
#========================================================================                       
...
#========================================================================                       
 function bdata001_valida_segmento_senior(lr_param)                         
#========================================================================              
...
#========================================================================    
 function bdata001_recupera_produto(lr_param)                
#========================================================================    
...
let lr_retorno.cponom = "ctc69m07_prod"                                     
  ...
  open c_bdata001_031 using  lr_retorno.cponom ,                            
                             lr_param.empcod   ,
                             lr_param.ramcod                            
  whenever error continue                                                   
  fetch c_bdata001_031 into lr_retorno.procod                               
  whenever error stop                                                       
...
#======================================================================== 
 function bdata001_valida_dia_hora()
#======================================================================== 
...
#========================================================================
function bdata001_grava_apolice_processada()
#========================================================================
...
initialize lr_retorno.* to null
   ...
   if bdata001_valida_processado() then
...
#========================================================================
 function bdata001_valida_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata001_032 using   mr_inconsistencia.empcod   
                            , lr_retorno.doctipcod
                            , mr_inconsistencia.succod
                            , mr_inconsistencia.ramcod
                            , mr_inconsistencia.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata001_032 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata001_valida_beneficio_processado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata001_033 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc
                            , mr_processo2.succod
                            , mr_processo2.ramcod
                            , mr_processo2.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata001_033 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
 function bdata001_valida_beneficio_inativado()                
#========================================================================
...
define lr_retorno record  
  ...
  open c_bdata001_034 using   mr_processo2.empcod   
                            , mr_processo2.codtipdoc
                            , mr_processo2.succod
                            , mr_processo2.ramcod
                            , mr_processo2.aplnumdig
  ...
  whenever error continue                                                   
  fetch c_bdata001_034 into lr_retorno.qtd                            
  whenever error stop
...
#========================================================================
function bdata001_regra_anterior()
#========================================================================
...
let lr_retorno.cont = 0    
  ...
  open c_bdata001_001 using   mr_processo2.empcod      ,              
                              mr_processo2.ramcod      ,              
                              mr_processo2.clscod      ,              
                              mr_processo2.perfil      ,              
                              ...
                              mr_processo2.clsviginidat                    
  whenever error continue
  fetch c_bdata001_001 into   lr_retorno.cont                             
  whenever error stop
...
#========================================================================                                                                                                                      
function bdata001_carrega_inativacao()                                             
#========================================================================          
...
initialize lr_retorno.* to null    
    ...
    open c_bdata001_003 using   mr_processo2.empcod      ,       
                                mr_processo2.ramcod      ,       
                                mr_processo2.clscod      ,       
                                mr_processo2.perfil      ,       
                                mr_processo2.plnclscod   ,       
    ...
    foreach c_bdata001_003 into mr_processo3.plnclscod                           
        ...
        open c_bdata001_012 using mr_processo3.plnclscod                                                                   
                                                                                                                           
        foreach c_bdata001_012 into mr_processo3.srvcod                 ,                                                  
              ...
              open c_bdata001_014 using mr_processo3.srvplnclscod ,                                                        
                                        mr_processo2.cbtcod                                                                
              ...
              open c_bdata001_015 using mr_processo3.srvplnclscod ,                                
                                        mr_processo2.ctgtrfcod                                     
              ...
              open c_bdata001_016 using mr_processo3.srvplnclscod ,                                
                                        mr_processo2.clalclcod                                     
                                                                                                   
              whenever error continue                                                              
              fetch c_bdata001_016 into mr_processo3.lclclartccod                                  
              whenever error stop                                                                  
              ...
              if sqlca.sqlcode <> notfound then                                                    
                   ...
                   open c_bdata001_017 using mr_processo3.lclclartccod ,                           
                                             mr_processo2.endcid       ,                           
                                             mr_processo2.endufd                                   
              ...
              if bdata001_valida_beneficio_inativado() then           
                	let mr_count1.proce = mr_count1.proce + 1            
              	  let mr_total.proce  = mr_total.proce + 1             
               	continue foreach                                       
              end if                                                   
...
#========================================================================                        
function bdata001_grava_inativo()                                                           
#========================================================================                     
...
#========================================================================
function bdata001_acessa_inativacao()
#========================================================================
