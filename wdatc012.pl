...
push @ARG,$usrtip,$webusrcod,$sesnum,$macsissgl,$inicio;
 ...
 #-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; /webserver/cgi-bin/ct24h/trs/wdatc013.4gc $ARG 2>&1)";
...
open (PROG, "$prog |") || die ("N\343o foi poss\355vel executar $prog: $!\n");
 ...
 #-----------------------------------------------------------------------------
 $texto    = 'Consulte abaixo as viaturas que não estão, por algum motivo, enviando sinais para a Porto Seguro. Para visualizar informações mais detalhadas sobre a viatura, clique no link de viaturas.';
 ...
 start_form(-method=>'POST',
            -name=>'wdatc012',
            -action=>"/cgi-bin/ct24h/trs/wdatc012.pl"),"\n",
