#! /usr/local/bin/perl 
 ...
 #  Autor....: Marcus                                                         #
 #                                                                            #
 #  Objetivo.: Tela de Inconsistencia de localizacao de viaturas              #
 #----------------------------------------------------------------------------#
#............................................................................#
#                  * * *  ALTERACOES  * * *                                  #
#                                                                            #
...
function funcchama()
{
  var myemis = "/cgi-bin/ct24h/trs/wctn01m02.pl?usrtip=$usrtip&webusrcod=$webusrcod&sesnum=$sesnum&macsissgl=$macsissgl";
  location = myemis;

}
function comeco()
{
  setTimeout("funcchama()",120000);
}
...
END
 ...
 #-----------------------------------------------------------------------------
 $cabec  = 'FROTA - INCONSISTÊNCIA DE SINAIS';
 ...
 #-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvar.sh; wctn01m02.4gc $ARG 2>&1)";
 ...
 #-----------------------------------------------------------------------------
 $texto    = 'Tela de inconsistência de sinais da viatura. O Texto daqui deve ser definido pelo Porto Socorro !!!!!! - TESTE - TESTE - Fase de prototipo';
 ...
 start_form(-method=>'POST',
            -name=>'wctn01m02',
            -action=>"/cgi-bin/ct24h/trs/wctn01m02.pl"),"\n",
