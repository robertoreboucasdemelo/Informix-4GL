...
#$titgif = '/carlos/sc/atend_vida_prev.gif';
 ...
 #-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; /webserver/cgi-bin/ct24h/trs/wdatc053.4gc $ARG 2>&1)";
...
#open (PROG, "$ambiente\"$prog\" |") || die ("N\343o foi poss\355vel executar $prog: $!\n");
 ...
 #-----------------------------------------------------------------------------
 $texto    = 'Consulte os serviços recebidos pela sua empresa.';
