...
#----------------------------
$prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvar.sh; wctn00m01.4gc $ARG)";
...
# Montando botao
#---------------
if ($ERROR[0] ne NOSESS && $ERROR[0] ne ERRORS) {
    #--------------------
    # Montando JavaScript
    #--------------------
#    &Create_JavaScript;
...
{
   push @header,header,
         start_html(-title=>$titulo,-bgcolor=>'#FFFFFF',-script=>$JSCRIPT),
         start_form(-method=>'POST',-name=>'wctn00m01',-action=>"/cgi-bin/ct24h/trs/wctn01m00.pl?usrtip=%s&webusrcod=%d&sesnum=%d&macsissgl=%s&atdvclsgl=%s&',$usrtip,$webusrcod,$sesnum,$macsissgl,$MUNIC[1])"),br,
         hidden(-name=>'usrtip',
                -value=>$usrtip
               ),"\n",
               ...
               table({-border=>'0',-width=>'550',-cellpadding=>'0',-cellspacing=>'0'},
                    ...
                    Tr(
                      td(img {-src=>'/corporat/images/img_transp.gif',-width=>'180',-height=>'14',-border=>'0'},
                         font({-face=>'ARIAL,HELVETICA,VERDANA',-size=>'2',-color=>'#6484BF'},b('POSIÇÃO DA FROTA - VEÍCULO'))
                        ),"\n",
                      ),"\n",
                    Tr(
                    ...
                    Tr(
                      td(font({-face=>'ARIAL,HELVETICA,VERDANA',-size=>'2',-color=>'#6484BF'},'Clique no botão para receber movimentos do veículo.')
                      ),"\n",
                    ),"\n",
                    Tr(
                      td({-colspan=>'2',height=>'12'},'&nbsp;'),"\n",
