...
#  Autor....: Marcus                                                         #
#                                                                            #
#  Objetivo.: Tela de informacoes adicionais da viatura                      #
#----------------------------------------------------------------------------#
# Alteracoes:                                                                #
#                                                                            #
# DATA        SOLICITACAO  RESPONSAVEL  DESCRICAO                            #
# 05/12/2002  PSI 150550   Zyon         Implementação da versão de impressão #
#                                                                            #
#----------------------------------------------------------------------------#
#............................................................................#
#                  * * *  ALTERACOES  * * *                                  #
...
#-------------------------------
push @ARG,$usrtip,$webusrcod,$sesnum,$macsissgl,$atdvclsgl,$acao;

 #-----------------------------------------------------------------------------
 # Carregando parametros recebidos
 #-----------------------------------------------------------------------------
 $cabec  = 'FROTA - VEÍCULOS';
 ...
 if ($acao == 2) {
    ...
    $texto  = 'Clique no botão Consultar para receber movimentos do veículo.';
    $funcao = '';
 }
 ...
 #-----------------------------------------------------------------------------
 $prog = "(cd /webserver/cgi-bin/ct24h/trs ; . ../../setvaru01.sh; /webserver/cgi-bin/ct24h/trs/wdatc007.4gc $ARG 2>&1)";
...
#open (PROG, "$ambiente\"$prog\" |") || die ("N\343o foi poss\355vel executar $prog: $!\n");
 ...
 if ($acao != 2) {
    push @impressao,
        ...
        "<script language='JavaScript'>",
            "function doImpressao() {",
                "var strPagina = '/cgi-bin/ct24h/trs/wdatc006.pl?usrtip=$usrtip&webusrcod=$webusrcod&sesnum=$sesnum&voltar=$voltar&inicio=$inicio&macsissgl=$macsissgl&atdvclsgl=$atdvclsgl&acao=2';",
    ...
    push @botoes,
        ...
        Tr(td(submit(-name=>'btoSubmit',-value=>'Consultar'),
              @impressao,
        "\n"),
        "\n"),
        "\n"),
 ...
 if ($voltar == 0) {
    ...
    push @rodape, &wissc211_rodape("BACK","00");}
